...
> "I hit `luna.graphics.draw: texture key is no longer valid` — what's a texture key? I'm a game designer. Just say 'you released this image before drawing it'. 🔴 Frustrating."

**Riley on `luna.graphics.SpriteBatch`:**
