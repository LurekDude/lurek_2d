...
Validate the entire CAG layer using `tools/cag_validate.py`.

## Steps

1. Run `python tools/cag_validate.py` for full validation
...
- [ ] `python tools/cag_validate.py` reports 0 errors
