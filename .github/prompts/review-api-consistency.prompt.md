---
description: "Review Lua API consistency: naming patterns, parameter conventions, return types across all luna.* modules."
---
...
Audit the `luna.*` API surface for naming and convention consistency.

## Steps

1. Read all `src/lua_api/*_api.rs` files
2. Check function naming: `luna.<module>.<verb>()` pattern
