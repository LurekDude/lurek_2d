---
description: "Rewrite an example as a clear scenario-driven example."
---

# Flesh Out Example

## Goal
- Rewrite content/examples/<module>.lua files as scenario-driven learning examples. Each example tells a coherent story about WHEN and WHY...
...
- **Coverage** every public API item is called at least once with real arguments
- **Clarity** a developer reading the file for the first time understands the use case
- run: python tools/audit/example_coverage.py --module <module> --stubs
- run: python tools/audit/example_coverage.py --module <module> --missing
- read docs/specs/<module>.md
