...
- `luna.graphics.rectangle()` — drawing the grid, command slots, and UI panels
- `luna.graphics.print()` — labelling commands, level names, and status messages
...
- `luna.timer.getTime()` — step execution timing and animation lerp
- `luna.graphics.setColor()` — colour-coded command blocks and robot direction indicator
