...
- `luna.graphics.rectangle()` — ground, obstacle, and player body rendering
- `luna.graphics.circle()` — coin pickups with radius-based collection detection
- `luna.graphics.setColor()` — parallax layer tinting and death-flash effect
- `luna.graphics.print()` — live score, high score, and game-over overlay text
- `luna.keyboard.isDown()` — held Space for jump, held Down for slide
- `luna.graphics.setBackgroundColor()` — night-sky dark blue atmosphere
