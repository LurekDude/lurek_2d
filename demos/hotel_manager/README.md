...
- `luna.graphics.rectangle()` — floor grid, room panels with type-colour fill, elevator shaft
- `luna.graphics.setColor()` — room-type palette lookup and occupancy tint overlay
- `luna.graphics.print()` — floor labels, room icons, money HUD, and daily revenue summary
- `luna.graphics.setBackgroundColor()` — sky gradient behind the tower
