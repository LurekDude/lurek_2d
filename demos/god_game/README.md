...
- `luna.graphics.rectangle()` — tile world rendering with terrain-color lookup table
...
- `luna.graphics.setColor()` — day/night ambient blending and entity coloring
- `luna.graphics.print()` — faith counter, day count, and population HUD
- `luna.graphics.setBackgroundColor()` — base sky color
