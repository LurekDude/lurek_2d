...
- `luna.graphics.rectangle()` — card frames, HP/block bars, and reward selection panel
- `luna.graphics.setColor()` — energy pips, vulnerability indicators, and hit-flash colouring
- `luna.graphics.print()` — card names, descriptions, combat log, and floor progress
...
- `luna.graphics.circle()` — particle burst effects on attack and block plays
