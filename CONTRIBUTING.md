...
For Lua-side integration coverage, run:
...
- Keep [README.md](README.md) and [vscode-extension/README.md](vscode-extension/README.md) in sync when changes affect onboarding or the official tooling workflow.
