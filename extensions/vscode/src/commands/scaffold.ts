...
const PROJECT_TEMPLATES: TemplateChoice[] = [
  ...
  },
  {
    ...
    files: {
      "main.lua": [
        ...
        "",
        "function lurek.update(dt)",
        '  if lurek.keyboard.isDown("left") then x = x - speed * dt end',
        '  if lurek.keyboard.isDown("right") then x = x + speed * dt end',
        '  if lurek.keyboard.isDown("up") then y = y - speed * dt end',
        '  if lurek.keyboard.isDown("down") then y = y + speed * dt end',
        "end",
        "",
        "function lurek.draw()",
  ...
  },
  {
    ...
    files: {
      "main.lua": [
        ...
        "function lurek.update(dt)",
        "  -- Horizontal movement",
        '  if lurek.keyboard.isDown("left") then player.x = player.x - moveSpeed * dt end',
        '  if lurek.keyboard.isDown("right") then player.x = player.x + moveSpeed * dt end',
        "",
        "  -- Gravity",
  ...
  },
  {
    ...
    files: {
      "main.lua": [
        ...
        "",
        "function lurek.update(dt)",
        '  if lurek.keyboard.isDown("w") then player.y = player.y - player.speed * dt end',
        '  if lurek.keyboard.isDown("s") then player.y = player.y + player.speed * dt end',
        '  if lurek.keyboard.isDown("a") then player.x = player.x - player.speed * dt end',
        '  if lurek.keyboard.isDown("d") then player.x = player.x + player.speed * dt end',
        "end",
        "",
        "function lurek.draw()",
  ...
  {
    label: "ECS",
    description: "Entity Component System with lurek.entity",
    files: {
      "main.lua": [
        "local universe",
        "",
        "function lurek.load()",
        "  universe = lurek.entity.newUniverse()",
        "",
        "  for i = 1, 10 do",
