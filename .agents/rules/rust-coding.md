---
description: "Load when writing or reviewing Rust engine code. Owns safe Rust conventions, error patterns, module structure, and idiomatic style. Skip for Lua scripts, CAG files, or docs."
alwaysApply: false
---
