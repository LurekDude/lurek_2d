---
description: "Load when writing Lua-Rust bindings, LuaUserData impls, type conversion, boundary errors, or SharedState borrow rules. Skip for API design, game scripts, or pure Rust domain logic."
alwaysApply: false
---
