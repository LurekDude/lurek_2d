---
description: "Load when designing or changing the lurek.* Lua API surface. Owns naming, params, callbacks, and consistency. Skip for Rust internals or pure Lua scripts."
alwaysApply: false
---
