---
description: "Load when writing, comparing, or governing high-level architecture across docs, artifacts, stakeholders, and validation rules. Skip for module-level boundary fixes, engine implementation, or framework-specific TOGAF analysis."
alwaysApply: false
---
