---
description: "Load when writing or reviewing Rust unit tests, Lua API tests, or test coverage rules. Skip for feature implementation or non-test game scripting."
alwaysApply: false
---
