...
use crate::graphic::renderer::{BlendMode, RenderCommand, DrawMode, TextAlign, TextureData};
use crate::graphic::shader::{Shader, ShaderFragmentInput, UniformValue};
use crate::log_msg;
...
enum StencilMode {
    Disabled,
    Write(crate::graphic::renderer::StencilAction),
    Test(crate::graphic::renderer::CompareMode),
}
...
impl GpuRenderer {
    ...
    fn prune_released_resources(
        ...
        fonts: &SlotMap<FontKey, crate::graphic::Font>,
            ...
            match cmd {
                ...
                RenderCommand::DrawNineSlice {
                    ...
                    if self.gpu_textures.get(*texture_key).is_some() {
                        let t = transform_stack.last().unwrap();
                        let ns = crate::graphic::NineSlice::new(
                            *texture_key,
                            *top,
                            *right,
                            *bottom,
...
fn compare_function(compare: crate::graphic::renderer::CompareMode) -> wgpu::CompareFunction {
    match compare {
        crate::graphic::renderer::CompareMode::Equal => wgpu::CompareFunction::Equal,
        crate::graphic::renderer::CompareMode::NotEqual => wgpu::CompareFunction::NotEqual,
        crate::graphic::renderer::CompareMode::Less => wgpu::CompareFunction::Less,
        crate::graphic::renderer::CompareMode::LessEqual => wgpu::CompareFunction::LessEqual,
        crate::graphic::renderer::CompareMode::Greater => wgpu::CompareFunction::Greater,
        crate::graphic::renderer::CompareMode::GreaterEqual => wgpu::CompareFunction::GreaterEqual,
        crate::graphic::renderer::CompareMode::Always => wgpu::CompareFunction::Always,
        crate::graphic::renderer::CompareMode::Never => wgpu::CompareFunction::Never,
    }
}

fn stencil_operation(action: crate::graphic::renderer::StencilAction) -> wgpu::StencilOperation {
    match action {
        crate::graphic::renderer::StencilAction::Replace => wgpu::StencilOperation::Replace,
        crate::graphic::renderer::StencilAction::Increment => {
            wgpu::StencilOperation::IncrementClamp
        }
        crate::graphic::renderer::StencilAction::Decrement => {
            wgpu::StencilOperation::DecrementClamp
        }
        crate::graphic::renderer::StencilAction::IncrementWrap => {
            wgpu::StencilOperation::IncrementWrap
        }
        crate::graphic::renderer::StencilAction::DecrementWrap => {
            wgpu::StencilOperation::DecrementWrap
        }
        crate::graphic::renderer::StencilAction::Keep => wgpu::StencilOperation::Keep,
        crate::graphic::renderer::StencilAction::Zero => wgpu::StencilOperation::Zero,
        crate::graphic::renderer::StencilAction::Invert => wgpu::StencilOperation::Invert,
    }
}
...
mod tests {
    ...
    use super::*;
    use crate::graphic::renderer::{CompareMode, StencilAction};
