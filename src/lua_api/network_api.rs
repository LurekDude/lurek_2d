...
impl LuaUserData for LuaNetworkRuntime {
    fn add_methods<'lua, M: LuaUserDataMethods<'lua, Self>>(methods: &mut M) {
            ...
            for (i, resp) in responses.iter().enumerate() {
                ...
                match resp {
                    crate::network::net_thread::NetworkResponse::HttpResponse {
                        ...
                        /// Performs the 'type' operation.
                        t.set("type", "http")?;
                        /// Performs the 'request_id' operation.
                        t.set("request_id", *id)?;
        ...
        /// Returns a string representation of the network runtime.
        /// @return | string | Debug string.
...
pub fn register(lua: &Lua, lurek: &LuaTable, _state: Rc<RefCell<SharedState>>) -> LuaResult<()> {
    ...
    tbl.set(
        ...
        lua.create_function(|lua, (snapshot, dt): (LuaTable, f32)| {
            ...
            t.set("y", out.y)?;
            /// Performs the 'vx' operation.
            t.set("vx", out.vx)?;
            /// Performs the 'vy' operation.
            t.set("vy", out.vy)?;
            Ok(t)
        })?,
    )?;
