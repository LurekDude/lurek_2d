...
use crate::combat::{
    Chassis, CollisionGroupSet, CombatWorld, MountSlot, Projectile, ProjectilePool,
    ProjectileType, Turret, Weapon,
};
...
/// Register the `luna.combat.*` vehicle combat table.
///
/// # Parameters
/// - `lua` — `&Lua`.
/// - `luna` — `&LuaTable`.
