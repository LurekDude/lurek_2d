//! World-level topology graph: regions connected by traversable edges.
//!
...
pub struct WorldRegion {
    ...
    pub y: f32,
    /// Arbitrary gameplay tags (e.g. `"forest"`, `"city"`).
    pub tags: Vec<String>,
}
...
pub struct WorldGraph {
    ...
    /// All directed (or bidirectional) edges.
...
pub fn generate_world_graph(width: f32, height: f32, region_count: u32, seed: u64) -> WorldGraph {
    ...
    // Connect each region to its 3 nearest neighbours
    let k = 3usize;
