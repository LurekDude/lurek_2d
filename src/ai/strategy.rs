//! Strategic goal selection driven by tags, priority, and pluggable scoring.
//! Owns `StrategicGoal` and `StrategyAI`.
//! Does not own the scoring function; callers provide it on update.
