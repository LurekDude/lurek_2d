...
### DebugBridge Integration

The crafting module exposes crafting state via `luna.debugbridge` for real-time inspection:
- Active craft jobs with progress bars
- Recipe registry contents and filters
- Skill levels and XP progress
- Station states and module configurations
