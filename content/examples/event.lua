...
-- =============================================================================
-- STUBS: 12 uncovered lurek.event API item(s)
...
-- ---- Stub: LSignal:register ----------------------------------------------
--@api-stub: LSignal:register
-- Registers a callback for the named event and returns its handle ID.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lSignal_stub:register("hero", function() end)  -- -> integer
-- (replace lSignal_stub with your real LSignal instance above)
...
-- Removes a subscription by handle ID.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lSignal_stub:remove(handle)  -- -> boolean
-- (replace lSignal_stub with your real LSignal instance above)
...
-- Removes all callbacks for the named event.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lSignal_stub:clear("hero")  -- -> integer
-- (replace lSignal_stub with your real LSignal instance above)

-- ---- Stub: LSignal:clearAll ----------------------------------------------
--@api-stub: LSignal:clearAll
-- Removes all callbacks across all events.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lSignal_stub:clearAll()  -- -> integer
-- (replace lSignal_stub with your real LSignal instance above)

-- ---- Stub: LSignal:getCount ----------------------------------------------
--@api-stub: LSignal:getCount
-- Returns the callback count for the named event.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lSignal_stub:getCount("hero")  -- -> integer
-- (replace lSignal_stub with your real LSignal instance above)

-- ---- Stub: LSignal:getTotalCount -----------------------------------------
--@api-stub: LSignal:getTotalCount
-- Returns the total callback count across all events.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lSignal_stub:getTotalCount()  -- -> integer
-- (replace lSignal_stub with your real LSignal instance above)
...
-- Returns true if the given type name matches this object's type or any parent type.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lSignal_stub:typeOf("hero")  -- -> boolean
-- (replace lSignal_stub with your real LSignal instance above)
