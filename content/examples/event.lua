...
-- if false then -- lurek.event.exit
--   local fatal = false
--   if fatal then
--     lurek.event.exit(1)
--   else
...
-- if false then -- lurek.event.poll
...
-- if false then -- lurek.event.clear
...
-- if false then -- lurek.event.newSignal
...
-- if false then -- lurek.event.pump
--   function lurek.process(dt)
--     lurek.event.pump()
...
-- if false then -- lurek.event.wait
...
-- if false then -- lurek.event.restart
...
-- if false then -- lurek.event.pushDeferred
--   for i = 1, 3 do
...
-- if false then -- lurek.event.pushDeferredPriority
...
-- if false then -- lurek.event.flushDeferred
...
-- if false then -- lurek.event.enableHistory
...
-- if false then -- lurek.event.getHistory
...
-- if false then -- lurek.event.clearHistory
...
-- if false then -- lurek.event.push
...
-- if false then -- lurek.event.pushPriority
...
-- if false then -- Signal:getTotalCount
--   local sig = lurek.event.newSignal()
--   sig:register("a", function() end)
--   sig:register("b", function() end)
