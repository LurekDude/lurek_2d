...
-- Pushes a deferred event with an explicit lane priority ("high" or "normal").
-- Use "high" for engine-critical deferred actions that should execute first on flush.
...
-- Adds an event item to a selected queue lane ("high" or "normal").
-- High-priority events always drain before normal events.
