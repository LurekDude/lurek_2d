...
-- if false then -- lurek.debugbridge.start
...
-- if false then -- lurek.debugbridge.stop
--   function lurek.quit()
...
-- if false then -- lurek.debugbridge.isRunning
--   if lurek.debugbridge.isRunning() then
...
-- if false then -- lurek.debugbridge.getPort
...
-- if false then -- lurek.debugbridge.getClientCount
...
-- if false then -- lurek.debugbridge.poll
--   function lurek.process(dt)
--     if lurek.debugbridge.isRunning() then
...
-- if false then -- lurek.debugbridge.capturePrint
--   local _print = print
--   print = function(...)
--     local parts = {}
...
-- if false then -- lurek.debugbridge.getPrintHistory
...
-- if false then -- lurek.debugbridge.clearPrintHistory
...
-- if false then -- lurek.debugbridge.setMaxPrintHistory
--   local in_dev = true
...
-- if false then -- lurek.debugbridge.getPerformance
--   local accum = 0
--   function lurek.process(dt)
--     accum = accum + dt
--     if accum >= 1.0 then
...
-- if false then -- lurek.debugbridge.requestScreenshot
--   function lurek.init()
...
-- if false then -- lurek.debugbridge.isScreenshotRequested
...
-- if false then -- lurek.debugbridge.broadcast
