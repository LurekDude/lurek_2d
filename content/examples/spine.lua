...
-- if false then -- lurek.spine.newSkeleton
...
-- if false then -- lurek.spine.newSkeletonAnimation
...
-- if false then -- Skeleton:findBone
...
-- if false then -- Skeleton:findSlot
--   local rig = lurek.spine.newSkeleton("npc")
...
-- if false then -- Skeleton:updateWorldTransforms
--   local rig = lurek.spine.newSkeleton("npc")
...
-- if false then -- Skeleton:getBoneWorld
--   local rig = lurek.spine.newSkeleton("npc")
...
-- if false then -- Skeleton:setPosition
--   local rig = lurek.spine.newSkeleton("npc")
--   rig:addBone("root")
...
-- if false then -- Skeleton:boneCount
--   local rig = lurek.spine.newSkeleton("npc")
...
-- if false then -- Skeleton:slotCount
--   local rig = lurek.spine.newSkeleton("npc")
--   local b = rig:addBone("torso")
...
-- if false then -- Skeleton:drawToImage
--   local rig = lurek.spine.newSkeleton("npc")
...
-- if false then -- Skeleton:stopAnimation
--   local rig = lurek.spine.newSkeleton("npc")
--   rig:addBone("root")
...
-- if false then -- Skeleton:updateAnimation
--   local rig = lurek.spine.newSkeleton("npc")
--   rig:addBone("root")
...
-- if false then -- Skeleton:getAnimationTime
--   local rig = lurek.spine.newSkeleton("npc")
--   rig:addBone("root")
...
-- if false then -- Skeleton:addAnimation
--   local rig = lurek.spine.newSkeleton("npc")
--   rig:addBone("root")
...
-- if false then -- Skeleton:addSkin
--   local rig = lurek.spine.newSkeleton("npc")
...
-- if false then -- Skeleton:setSkin
--   local rig = lurek.spine.newSkeleton("npc")
...
-- if false then -- Skeleton:getSkin
--   local rig = lurek.spine.newSkeleton("npc")
...
-- if false then -- SkeletonAnimation:getDuration
...
-- if false then -- SkeletonAnimation:getEvents
...
-- if false then -- SkeletonAnimation:getTimelineCount
...
-- if false then -- Skeleton:addBone
...
-- if false then -- Skeleton:addChildBone
--   local sk = lurek.spine.newSkeleton("hero")
...
-- if false then -- SkeletonAnimation:addEventKey
...
-- if false then -- Skeleton:addIKConstraint
--   local sk = lurek.spine.newSkeleton("hero")
--   local root = sk:addBone("root")
...
-- if false then -- SkeletonAnimation:addKeyframe
...
-- if false then -- Skeleton:addSlot
--   local sk = lurek.spine.newSkeleton("hero")
--   local root = sk:addBone("root")
...
-- if false then -- Skeleton:blendAnimation
--   local sk = lurek.spine.newSkeleton("hero")
--   sk:addBone("root")
...
-- if false then -- Skeleton:playAnimation
--   local sk = lurek.spine.newSkeleton("hero")
--   sk:addBone("root")
--   local idle = lurek.spine.newSkeletonAnimation("idle", 1.0)
...
-- if false then -- Skeleton:setIKTarget
--   local sk = lurek.spine.newSkeleton("hero")
--   local root = sk:addBone("root")
--   local lower = sk:addChildBone("lower_arm", root, { y = -30 })
--   sk:addIKConstraint("arm_ik", {root, lower}, true)
...
-- if false then -- Skeleton:setSkinMapping
--   local sk = lurek.spine.newSkeleton("hero")
--   local root = sk:addBone("root")
...
-- if false then -- LSkeleton:typeOf
--   local skeleton_obj = lurek.spine.newSkeleton("test")
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LSkeletonAnimation:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LSkeletonAnimation:typeOf
