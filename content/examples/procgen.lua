...
-- if false then -- lurek.procgen.cellularAutomata
--   local w, h = 64, 48
...
-- if false then -- lurek.procgen.floodFill
--   local w, h = 16, 16
--   local grid = {}
...
-- if false then -- lurek.procgen.perlinNoise
--   local px, py = 8.0, 8.0
...
-- if false then -- lurek.procgen.poissonDisk
...
-- if false then -- lurek.procgen.voronoi
...
-- if false then -- lurek.procgen.bspDungeon
...
-- if false then -- lurek.procgen.roomsDungeon
...
-- if false then -- lurek.procgen.heightmap
...
-- if false then -- lurek.procgen.wfcGenerate
...
-- if false then -- lurek.procgen.lsystem
...
-- if false then -- lurek.procgen.lsystemSegments
...
-- if false then -- lurek.procgen.generateName
...
-- if false then -- lurek.procgen.generateNames
...
-- if false then -- lurek.procgen.worldGraph
...
-- if false then -- lurek.procgen.noiseMap
...
-- if false then -- lurek.procgen.noiseMapParallel
...
-- if false then -- lurek.procgen.simplex2d
...
-- if false then -- lurek.procgen.simplex3d
--   local t = 0.0
