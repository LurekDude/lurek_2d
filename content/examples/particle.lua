...
-- if false then -- lurek.particle.newSystem
...
-- if false then -- lurek.particle.newTrail
...
-- if false then -- ParticleSystem:update
...
-- if false then -- ParticleSystem:emit
...
-- if false then -- ParticleSystem:start
...
-- if false then -- ParticleSystem:stop
...
-- if false then -- ParticleSystem:pause
...
-- if false then -- ParticleSystem:resume
...
-- if false then -- ParticleSystem:reset
...
-- if false then -- ParticleSystem:moveTo
...
-- if false then -- ParticleSystem:count
...
-- if false then -- ParticleSystem:isActive
...
-- if false then -- ParticleSystem:isPaused
...
-- if false then -- ParticleSystem:isStopped
...
-- if false then -- ParticleSystem:isEmpty
...
-- if false then -- ParticleSystem:isFull
...
-- if false then -- ParticleSystem:release
...
-- if false then -- ParticleSystem:getCount
...
-- if false then -- ParticleSystem:type
...
-- if false then -- ParticleSystem:typeOf
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- ParticleSystem:setPosition
...
-- if false then -- ParticleSystem:getPosition
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- ParticleSystem:setEmissionRate
...
-- if false then -- ParticleSystem:getEmissionRate
...
-- if false then -- ParticleSystem:setParticleLifetime
...
-- if false then -- ParticleSystem:getParticleLifetime
...
-- if false then -- ParticleSystem:setEmitterLifetime
...
-- if false then -- ParticleSystem:getEmitterLifetime
...
-- if false then -- ParticleSystem:setSpeed
...
-- if false then -- ParticleSystem:getSpeed
...
-- if false then -- ParticleSystem:setDirection
...
-- if false then -- ParticleSystem:getDirection
...
-- if false then -- ParticleSystem:setSpread
...
-- if false then -- ParticleSystem:getSpread
...
-- if false then -- ParticleSystem:getLinearAcceleration
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- ParticleSystem:getRadialAcceleration
...
-- if false then -- ParticleSystem:getTangentialAcceleration
...
-- if false then -- ParticleSystem:setLinearDamping
...
-- if false then -- ParticleSystem:getLinearDamping
...
-- if false then -- ParticleSystem:setSizes
...
-- if false then -- ParticleSystem:getSizes
--   local sys = lurek.particle.newSystem({})
--   sys:setSizes(4, 12, 6)
...
-- if false then -- ParticleSystem:setSizeVariation
...
-- if false then -- ParticleSystem:getSizeVariation
...
-- if false then -- ParticleSystem:setRotation
...
-- if false then -- ParticleSystem:getRotation
...
-- if false then -- ParticleSystem:setSpin
...
-- if false then -- ParticleSystem:getSpin
...
-- if false then -- ParticleSystem:setSpinVariation
...
-- if false then -- ParticleSystem:getSpinVariation
...
-- if false then -- ParticleSystem:setRelativeRotation
...
-- if false then -- ParticleSystem:hasRelativeRotation
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- ParticleSystem:setColors
...
-- if false then -- ParticleSystem:getColors
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- ParticleSystem:setOffset
...
-- if false then -- ParticleSystem:getOffset
...
-- if false then -- ParticleSystem:setInsertMode
...
-- if false then -- ParticleSystem:getInsertMode
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- ParticleSystem:setBufferSize
...
-- if false then -- ParticleSystem:getBufferSize
...
-- if false then -- ParticleSystem:setEmissionArea
...
-- if false then -- ParticleSystem:getEmissionArea
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- ParticleSystem:setShape
...
-- if false then -- ParticleSystem:getShape
--   local sys = lurek.particle.newSystem({})
--   sys:setShape("ring")
...
-- if false then -- ParticleSystem:getGravity
...
-- if false then -- ParticleSystem:setGravity
...
-- if false then -- ParticleSystem:render
...
-- if false then -- ParticleSystem:clone
...
-- if false then -- ParticleSystem:drawToImage
...
-- if false then -- ParticleSystem:toImage
...
-- if false then -- ParticleSystem:warmUp
...
-- if false then -- ParticleSystem:clearAttractors
...
-- if false then -- ParticleSystem:getAttractorCount
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- ParticleSystem:clearBounds
...
-- if false then -- ParticleSystem:getFlipbook
--   local sys = lurek.particle.newSystem({})
...
-- if false then -- Trail:setLifetime
...
-- if false then -- Trail:getLifetime
...
-- if false then -- Trail:setMinDistance
--   local trail = lurek.particle.newTrail(0.4, 8.0)
...
-- if false then -- Trail:getPointCount
...
-- if false then -- Trail:drawToImage
...
-- if false then -- ParticleSystem:addSubSystem
--   local fire = lurek.particle.newSystem({
...
-- if false then -- ParticleSystem:subSystemCount
...
-- if false then -- ParticleSystem:setCustomEmissionShape
...
-- if false then -- ParticleSystem:setOnDeathBatch
--   local ps = lurek.particle.newSystem({
...
-- if false then -- lurek.particle.fromTOML
...
-- if false then -- ParticleSystem:addAttractor
...
-- if false then -- ParticleSystem:addSubEmitter
...
-- if false then -- ParticleSystem:setBounds
...
-- if false then -- ParticleSystem:setFlipbook
...
-- if false then -- Trail:setHeadColor
...
-- if false then -- ParticleSystem:setLinearAcceleration
--   local ps = lurek.particle.newSystem({max_particles=500})
...
-- if false then -- ParticleSystem:setRadialAcceleration
...
-- if false then -- Trail:setTailColor
--   local trail = lurek.particle.newTrail(2.0, 8.0)
...
-- if false then -- ParticleSystem:setTangentialAcceleration
--   local ps = lurek.particle.newSystem({max_particles=400})
