...
-- if false then -- lurek.automation.load
--   local intro = {
...
-- if false then -- lurek.automation.unload
...
-- if false then -- lurek.automation.hasScript
...
-- if false then -- lurek.automation.getScripts
...
-- if false then -- lurek.automation.start
...
-- if false then -- lurek.automation.stop
--   function lurek.init()
...
-- if false then -- lurek.automation.pause
...
-- if false then -- lurek.automation.resume
...
-- if false then -- lurek.automation.update
...
-- if false then -- lurek.automation.isRunning
...
-- if false then -- lurek.automation.isPaused
--   if lurek.automation.isPaused() then
...
-- if false then -- lurek.automation.isComplete
--   function lurek.process(dt)
--     lurek.automation.update(dt)
...
-- if false then -- lurek.automation.getCurrentStep
--   function lurek.draw_ui()
...
-- if false then -- lurek.automation.getStepCount
--   local total = 0
--   function lurek.init()
...
-- if false then -- lurek.automation.getCurrentScript
--   function lurek.draw_ui()
...
-- if false then -- lurek.automation.getElapsedTime
--   function lurek.draw_ui()
...
-- if false then -- lurek.automation.loadFromToml
--   local toml = [=[
-- [meta]
...
-- if false then -- lurek.automation.getStepLimit
...
-- if false then -- lurek.automation.setStepLimit
...
-- if false then -- lurek.automation.saveMacro
...
-- if false then -- lurek.automation.playMacro
--   function lurek.init()
...
-- if false then -- lurek.automation.hasMacro
...
-- if false then -- lurek.automation.listMacros
...
-- if false then -- lurek.automation.setPlaybackSpeed
--   local fast_ci = true
...
-- if false then -- lurek.automation.getPlaybackSpeed
...
-- if false then -- lurek.automation.setHighlightMode
...
-- if false then -- lurek.automation.isHighlightMode
...
-- if false then -- lurek.automation.waitUntil
