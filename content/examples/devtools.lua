...
-- Logs a message at TRACE level — most verbose output; filtered in release builds.
...
-- Logs a message at ERROR level — signals a recoverable fault.
...
-- Logs a message at FATAL level — signals an unrecoverable engine fault.
...
-- ---- Stub: LReplConsole:type ---------------------------------------------
--@api-stub: LReplConsole:type
-- Returns the type name of this object.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lReplConsole_stub:type()  -- -> string
-- (replace lReplConsole_stub with your real LReplConsole instance above)

-- ---- Stub: LReplConsole:typeOf -------------------------------------------
--@api-stub: LReplConsole:typeOf
-- Returns true if this object is of the given type.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lReplConsole_stub:typeOf("hero")  -- -> boolean
-- (replace lReplConsole_stub with your real LReplConsole instance above)

-- =============================================================================
-- STUBS: 11 uncovered lurek.devtools API item(s)
-- Generated by tools/audit/example_add_missing.py
-- REQUIRED: replace every --@api-stub: block below with a real scenario.
-- Run .github/prompts/flesh-out-example.prompt.md for instructions.
-- The final committed file must contain ZERO --@api-stub: lines.
