...
-- if false then -- lurek.devtools.log
...
-- if false then -- lurek.devtools.setLogLevel
...
-- if false then -- lurek.devtools.getLogLevel
...
-- if false then -- lurek.devtools.setLogConsole
...
-- if false then -- lurek.devtools.getLogConsole
...
-- if false then -- lurek.devtools.setLogFile
...
-- if false then -- lurek.devtools.getLogFile
...
-- if false then -- lurek.devtools.getLogHistory
...
-- if false then -- lurek.devtools.clearLog
...
-- if false then -- lurek.devtools.setProfilingEnabled
...
-- if false then -- lurek.devtools.isProfilingEnabled
...
-- if false then -- lurek.devtools.profilePush
...
-- if false then -- lurek.devtools.profilePop
--   lurek.devtools.setProfilingEnabled(true)
...
-- if false then -- lurek.devtools.profileFrame
...
-- if false then -- lurek.devtools.getProfileFrameCount
...
-- if false then -- lurek.devtools.getProfileData
...
-- if false then -- lurek.devtools.resetProfile
...
-- if false then -- lurek.devtools.recordFrameTime
--   function lurek.process(dt)
...
-- if false then -- lurek.devtools.getFrameStats
...
-- if false then -- lurek.devtools.getFrameHistory
...
-- if false then -- lurek.devtools.setFrameHistorySize
...
-- if false then -- lurek.devtools.getFrameHistorySize
...
-- if false then -- lurek.devtools.watch
...
-- if false then -- lurek.devtools.unwatch
...
-- if false then -- lurek.devtools.getWatchedPaths
...
-- if false then -- lurek.devtools.scan
...
-- if false then -- lurek.devtools.clearWatches
...
-- if false then -- lurek.devtools.getWatchInterval
...
-- if false then -- lurek.devtools.setWatchInterval
...
-- if false then -- lurek.devtools.getCallStack
...
-- if false then -- lurek.devtools.eval
...
-- if false then -- lurek.devtools.openConsole
...
-- if false then -- lurek.devtools.isConsoleOpen
...
-- if false then -- lurek.devtools.exposeWatch
...
-- if false then -- lurek.devtools.removeWatch
--   local fps_value = 60
...
-- if false then -- lurek.devtools.getWatches
--   local score = 1500
...
-- if false then -- lurek.devtools.snapshot
--   lurek.devtools.recordFrameTime(0.016)
...
-- if false then -- lurek.devtools.profilerReport
...
-- if false then -- lurek.devtools.newFileWatcher
...
-- if false then -- lurek.devtools.newRepl
...
-- if false then -- FileWatcher:onChanged
...
-- if false then -- FileWatcher:check
--   local fw = lurek.devtools.newFileWatcher("content/examples/devtools.lua")
--   function lurek.process(dt)
...
-- if false then -- FileWatcher:getPath
...
-- if false then -- FileWatcher:cancel
--   local fw = lurek.devtools.newFileWatcher("conf.toml")
...
-- if false then -- ReplConsole:eval
...
-- if false then -- ReplConsole:history
...
-- if false then -- ReplConsole:clear
...
-- =============================================================================
-- STUBS: 7 uncovered lurek.devtools API item(s)
...
-- if false then -- lurek.devtools.fatal
...
-- ---- Stub: LFileWatcher:type ---------------------------------------------
--@api-stub: LFileWatcher:type
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LFileWatcher:type
...
-- if false then -- LFileWatcher:typeOf
--   local file_watcher_obj = lurek.devtools.newFileWatcher("save/")
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LReplConsole:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LReplConsole:typeOf
--   local repl_console_obj = lurek.devtools.newRepl(50)
...
-- if false then -- lurek.devtools.debug
...
-- if false then -- lurek.devtools.info
...
-- if false then -- lurek.devtools.warn
