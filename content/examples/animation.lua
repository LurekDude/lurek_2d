...
-- if false then -- lurek.animation.new
...
-- if false then -- lurek.animation.fromAseprite
...
-- if false then -- lurek.animation.newStateMachine
...
-- if false then -- lurek.animation.newCurve
...
-- if false then -- lurek.animation.newSyncGroup
...
-- if false then -- lurek.animation.newBlendLayerSet
...
-- if false then -- Animation:addFrame
--   local anim = lurek.animation.new()
...
-- if false then -- Animation:resume
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("walk", {0}, 8, true)
--   anim:play("walk")
...
-- if false then -- Animation:update
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("walk", {0}, 8, true)
--   anim:play("walk")
...
-- if false then -- Animation:getQuad
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
...
-- if false then -- Animation:pollEvents
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
...
-- if false then -- Animation:isPlaying
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
...
-- if false then -- Animation:isLooping
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
...
-- if false then -- Animation:getClip
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
...
-- if false then -- Animation:getSpeed
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("run", {0}, 12, true)
...
-- if false then -- Animation:setSpeed
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("run", {0}, 12, true)
--   anim:play("run")
...
-- if false then -- Animation:getFrameCount
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
...
-- if false then -- Animation:getClipCount
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("idle", {0}, 4, true)
...
-- if false then -- Animation:getCurrentFrame
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("walk", {0}, 8, true)
--   anim:play("walk")
...
-- if false then -- Animation:setFrame
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("walk", {0}, 8, true)
--   anim:play("walk")
...
-- if false then -- Animation:getBlendState
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("idle", {0}, 4, true)
--   anim:play("idle")
...
-- if false then -- Animation:drawToImage
--   pcall(function()
--     local anim = lurek.animation.new()
--     anim:addFrame(0, 0, 32, 32)
--     anim:addClip("idle", {0}, 4, true)
...
-- if false then -- AnimStateMachine:update
--   local anim = lurek.animation.new()
...
-- if false then -- AnimStateMachine:getState
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32); anim:addClip("idle", {0}, 4, true)
--   local fsm = lurek.animation.newStateMachine(anim, "idle")
--   fsm:addState("idle", "idle", true)
...
-- if false then -- AnimStateMachine:forceState
--   local anim = lurek.animation.new()
...
-- if false then -- AnimStateMachine:setParam
--   local anim = lurek.animation.new()
...
-- if false then -- AnimStateMachine:getQuad
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32); anim:addClip("idle", {0}, 4, true)
--   local fsm = lurek.animation.newStateMachine(anim, "idle")
--   fsm:addState("idle", "idle", true)
...
-- if false then -- BlendLayerSet:removeLayer
--   local bls = lurek.animation.newBlendLayerSet()
...
-- if false then -- BlendLayerSet:setWeight
--   local bls = lurek.animation.newBlendLayerSet()
--   bls:addLayer("base", "idle", 1.0)
...
-- if false then -- BlendLayerSet:getWeight
--   local bls = lurek.animation.newBlendLayerSet()
...
-- if false then -- BlendLayerSet:setMask
--   local bls = lurek.animation.newBlendLayerSet()
...
-- if false then -- BlendLayerSet:listLayers
--   local bls = lurek.animation.newBlendLayerSet()
--   bls:addLayer("base", "idle", 1.0)
...
-- if false then -- BlendLayerSet:len
--   local bls = lurek.animation.newBlendLayerSet()
--   bls:addLayer("base", "idle", 1.0)
...
-- if false then -- AnimCurve:addKeyframe
...
-- if false then -- AnimCurve:setEasing
...
-- if false then -- AnimCurve:keyframeCount
--   local curve = lurek.animation.newCurve()
...
-- if false then -- AnimSyncGroup:add
--   local squad = lurek.animation.newSyncGroup()
--   squad:add(1)
--   squad:add(2)
--   squad:add(3)
...
-- if false then -- AnimSyncGroup:remove
--   local squad = lurek.animation.newSyncGroup()
...
-- if false then -- AnimSyncGroup:clear
--   local squad = lurek.animation.newSyncGroup()
...
-- if false then -- AnimSyncGroup:memberCount
--   local squad = lurek.animation.newSyncGroup()
--   squad:add(1); squad:add(2)
...
-- if false then -- AnimCurve:setCustomEasing
...
-- if false then -- Animation:addClip
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addFrame(32, 0, 32, 32)
...
-- if false then -- Animation:addClipFromGrid
--   local anim = lurek.animation.new()
...
-- if false then -- Animation:addFramesFromGrid
--   local anim = lurek.animation.new()
...
-- if false then -- BlendLayerSet:addLayer
--   local anim = lurek.animation.new()
...
-- if false then -- AnimStateMachine:addState
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("idle", {0}, 1, true)
--   anim:addClip("run", {0}, 8, true)
...
-- if false then -- AnimStateMachine:addTransition
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("idle", {0}, 1, true)
--   anim:addClip("run", {0}, 8, true)
...
-- if false then -- Animation:crossfade
--   local anim = lurek.animation.new()
--   anim:addFrame(0, 0, 32, 32)
--   anim:addClip("idle", {0}, 4, true)
--   anim:addClip("run", {0}, 8, true)
...
-- if false then -- LAnimCurve:typeOf
--   local anim_curve_obj = lurek.animation.newCurve()
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LAnimStateMachine:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LAnimStateMachine:typeOf
--   local anim_state_machine_obj = lurek.animation.newStateMachine(lurek.animation.new(), "idle")
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LAnimSyncGroup:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LAnimSyncGroup:typeOf
--   local anim_sync_group_obj = lurek.animation.newSyncGroup()
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LAnimation:typeOf
--   local animation_obj = lurek.animation.new()
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LBlendLayerSet:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LBlendLayerSet:typeOf
--   local blend_layer_set_obj = lurek.animation.newBlendLayerSet()
