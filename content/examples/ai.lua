...
-- if false then -- lurek.ai.newWorld
...
-- if false then -- lurek.ai.newBlackboard
...
-- if false then -- lurek.ai.newStateMachine
...
-- if false then -- lurek.ai.newBehaviorTree
...
-- if false then -- lurek.ai.newSelector
...
-- if false then -- lurek.ai.newSequence
...
-- if false then -- lurek.ai.newParallel
...
-- if false then -- lurek.ai.newInverter
...
-- if false then -- lurek.ai.newRepeater
...
-- if false then -- lurek.ai.newSucceeder
...
-- if false then -- lurek.ai.newAction
...
-- if false then -- lurek.ai.newCondition
...
-- if false then -- lurek.ai.newSteeringManager
...
-- if false then -- lurek.ai.newQLearner
...
-- if false then -- lurek.ai.newUtilityAI
...
-- if false then -- lurek.ai.newGOAPPlanner
...
-- if false then -- lurek.ai.newInfluenceMap
...
-- if false then -- lurek.ai.newSquad
...
-- if false then -- lurek.ai.newCommandQueue
...
-- if false then -- lurek.ai.newTraitProfile
...
-- if false then -- lurek.ai.newStimulusWorld
...
-- if false then -- lurek.ai.newContextSteering
...
-- if false then -- lurek.ai.newNeedSystem
...
-- if false then -- lurek.ai.newAIDirector
...
-- if false then -- lurek.ai.newHTNDomain
...
-- if false then -- lurek.ai.newMCTSEngine
...
-- if false then -- lurek.ai.newEmotionModel
...
-- if false then -- lurek.ai.newORCASolver
...
-- if false then -- lurek.ai.newNeuralNet
...
-- if false then -- lurek.ai.newGeneticAlgorithm
...
-- if false then -- lurek.ai.newBandit
...
-- if false then -- lurek.ai.newNeuroevolution
...
-- if false then -- lurek.ai.newStrategyAI
...
-- if false then -- lurek.ai.newAILod
...
-- if false then -- AIWorld:getAgent
--   local world = lurek.ai.newWorld()
--   world:addAgent("guard_01")
...
-- if false then -- AIWorld:removeAgent
--   local world = lurek.ai.newWorld()
...
-- if false then -- AIWorld:getAgentCount
--   local world = lurek.ai.newWorld()
...
-- if false then -- AIWorld:getGlobalBlackboard
--   local world = lurek.ai.newWorld()
...
-- if false then -- Agent:setPosition
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:getPosition
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:setVelocity
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:getVelocity
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:setMaxSpeed
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:getMaxSpeed
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:setMaxForce
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:getMaxForce
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:setPriority
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:getPriority
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
--   agent:setPriority(5)
...
-- if false then -- Agent:setDecisionModel
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:getDecisionModel
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Agent:getBlackboard
--   local world = lurek.ai.newWorld()
--   local agent = world:addAgent("scout_01")
...
-- if false then -- Blackboard:setNumber
--   local bb = lurek.ai.newBlackboard()
--   bb:setNumber("hp", 100)
...
-- if false then -- Blackboard:setBool
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- Blackboard:setString
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- Blackboard:remove
--   local bb = lurek.ai.newBlackboard()
--   bb:setNumber("temp", 1)
--   bb:remove("temp")
-- end
...
-- if false then -- Blackboard:clear
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- Blackboard:getKeys
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- Blackboard:getSize
--   local bb = lurek.ai.newBlackboard()
--   bb:setNumber("hp", 100)
...
-- if false then -- Blackboard:typeOf
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- StateMachine:addState
--   local fsm = lurek.ai.newStateMachine()
...
-- if false then -- StateMachine:setInitialState
--   local fsm = lurek.ai.newStateMachine()
--   fsm:addState("idle", {})
...
-- if false then -- StateMachine:getCurrentState
--   local fsm = lurek.ai.newStateMachine()
...
-- if false then -- StateMachine:forceState
--   local fsm = lurek.ai.newStateMachine()
...
-- if false then -- StateMachine:getTimeInState
--   local fsm = lurek.ai.newStateMachine()
...
-- if false then -- StateMachine:type
--   local fsm = lurek.ai.newStateMachine()
...
-- if false then -- StateMachine:typeOf
--   local fsm = lurek.ai.newStateMachine()
...
-- if false then -- BehaviorTree:setRoot
--   local bt = lurek.ai.newBehaviorTree()
...
-- if false then -- BehaviorTree:getLastStatus
--   local bt = lurek.ai.newBehaviorTree()
--   local root = lurek.ai.newSequence()
--   root:addChild(lurek.ai.newAction(function() return "success" end))
--   bt:setRoot(root)
...
-- if false then -- BehaviorTree:getDebugState
--   local bt = lurek.ai.newBehaviorTree()
--   local root = lurek.ai.newSequence()
--   root:addChild(lurek.ai.newAction(function() return "success" end))
--   bt:setRoot(root)
...
-- if false then -- BehaviorTree:type
--   local bt = lurek.ai.newBehaviorTree()
...
-- if false then -- BehaviorTree:typeOf
--   local bt = lurek.ai.newBehaviorTree()
...
-- if false then -- BTNode:getChildCount
--   local seq = lurek.ai.newSequence()
--   seq:addChild(lurek.ai.newAction(function() return "success" end))
...
-- if false then -- BTNode:setSuccessPolicy
...
-- if false then -- BTNode:setFailurePolicy
--   local par = lurek.ai.newParallel("require_one", "require_one")
...
-- if false then -- BTNode:getNodeType
--   local seq = lurek.ai.newSequence()
...
-- if false then -- SteeringManager:getBehaviorCount
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
--   sm:addWander(20, 40, 5, 0.3)
...
-- if false then -- SteeringManager:setCombineMode
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
...
-- if false then -- SteeringManager:getCombineMode
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
...
-- if false then -- SteeringManager:getLastSteering
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
...
-- if false then -- SteeringManager:type
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
...
-- if false then -- SteeringManager:typeOf
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
...
-- if false then -- SteeringManager:setSpatialHashCellSize
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
...
-- if false then -- SteeringManager:enableSpatialHash
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
--   sm:enableSpatialHash(true)
-- end
...
-- if false then -- QLearner:chooseAction
...
-- if false then -- QLearner:bestAction
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:getQValue
--   local ql = lurek.ai.newQLearner(8, 4)
--   ql:learn(1, 2, 1.0, 3)
...
-- if false then -- QLearner:endEpisode
--   local ql = lurek.ai.newQLearner(8, 4)
--   ql:learn(1, 1, 0.5, 2)
--   ql:endEpisode()
-- end
...
-- if false then -- QLearner:getEpisodeCount
--   local ql = lurek.ai.newQLearner(8, 4)
--   ql:endEpisode()
...
-- if false then -- QLearner:getStateCount
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:getActionCount
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:setLearningRate
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:getLearningRate
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:setDiscountFactor
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:getDiscountFactor
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:setExplorationRate
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:getExplorationRate
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:setExplorationDecay
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:getExplorationDecay
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- QLearner:serialize
--   local ql = lurek.ai.newQLearner(8, 4)
--   ql:learn(1, 1, 1.0, 2)
...
-- if false then -- QLearner:deserialize
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- UtilityAI:evaluate
--   local uai = lurek.ai.newUtilityAI()
...
-- if false then -- UtilityAI:getActionCount
--   local uai = lurek.ai.newUtilityAI()
--   uai:addAction("flee", function() return 0.8 end)
--   uai:addAction("attack", function() return 0.4 end)
...
-- if false then -- UtilityAI:getLastAction
--   local uai = lurek.ai.newUtilityAI()
--   uai:addAction("flee", function() return 0.8 end)
--   uai:addAction("attack", function() return 0.4 end)
--   uai:evaluate()
...
-- if false then -- UtilityAI:typeOf
--   local uai = lurek.ai.newUtilityAI()
--   uai:addAction("flee", function() return 0.8 end)
--   uai:addAction("attack", function() return 0.4 end)
...
-- if false then -- GOAPPlanner:getActionCount
...
-- if false then -- GOAPPlanner:getGoalCount
--   local p = lurek.ai.newGOAPPlanner()
--   p:addAction("eat", 1.0, function() end)
--   p:addGoal("not_hungry", 1.0)
...
-- if false then -- GOAPPlanner:getMaxIterations
--   local p = lurek.ai.newGOAPPlanner()
--   p:addAction("eat", 1.0, function() end)
--   p:addGoal("not_hungry", 1.0)
...
-- if false then -- GOAPPlanner:setMaxIterations
--   local p = lurek.ai.newGOAPPlanner()
--   p:addAction("eat", 1.0, function() end)
--   p:addGoal("not_hungry", 1.0)
...
-- if false then -- GOAPPlanner:type
--   local p = lurek.ai.newGOAPPlanner()
--   p:addAction("eat", 1.0, function() end)
--   p:addGoal("not_hungry", 1.0)
...
-- if false then -- GOAPPlanner:typeOf
--   local p = lurek.ai.newGOAPPlanner()
--   p:addAction("eat", 1.0, function() end)
--   p:addGoal("not_hungry", 1.0)
...
-- if false then -- InfluenceMap:hasLayer
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- InfluenceMap:decay
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- InfluenceMap:clearLayer
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
--   im:stampInfluence("threat", 100, 100, 64, 1.0, 1.0)
...
-- if false then -- InfluenceMap:clearAll
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
--   im:clearAll()
-- end
...
-- if false then -- InfluenceMap:getMaxPosition
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- InfluenceMap:getMinPosition
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
--   im:stampInfluence("threat", 200, 100, 32, 1.0, 1.0)
...
-- if false then -- InfluenceMap:getWidth
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- InfluenceMap:getHeight
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- InfluenceMap:getCellSize
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- InfluenceMap:type
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- InfluenceMap:typeOf
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- Squad:removeMember
--   local sq = lurek.ai.newSquad("alpha")
--   sq:addMember("guard_01")
--   sq:addMember("doomed")
...
-- if false then -- Squad:getMemberCount
--   local sq = lurek.ai.newSquad("alpha")
--   sq:addMember("guard_01")
...
-- if false then -- Squad:getMembers
--   local sq = lurek.ai.newSquad("alpha")
--   sq:addMember("guard_01")
--   sq:addMember("guard_02")
...
-- if false then -- Squad:getFormation
--   local sq = lurek.ai.newSquad("alpha")
--   sq:addMember("guard_01")
...
-- if false then -- Squad:getFormationSpacing
--   local sq = lurek.ai.newSquad("alpha")
--   sq:addMember("guard_01")
...
-- if false then -- Squad:getBlackboard
--   local sq = lurek.ai.newSquad("alpha")
--   sq:addMember("guard_01")
...
-- if false then -- CommandQueue:cancelCurrent
...
-- if false then -- CommandQueue:clear
--   local cq = lurek.ai.newCommandQueue()
--   cq:enqueue("move", function() end, { targetX = 200, targetY = 100 })
...
-- if false then -- CommandQueue:getCount
--   local cq = lurek.ai.newCommandQueue()
--   cq:enqueue("move", function() end, { targetX = 200, targetY = 100 })
...
-- if false then -- CommandQueue:isEmpty
--   local cq = lurek.ai.newCommandQueue()
--   cq:enqueue("move", function() end, { targetX = 200, targetY = 100 })
--   cq:clear()
...
-- if false then -- CommandQueue:getCurrentType
--   local cq = lurek.ai.newCommandQueue()
--   cq:enqueue("move", function() end, { targetX = 200, targetY = 100 })
...
-- if false then -- CommandQueue:getCurrentTarget
--   local cq = lurek.ai.newCommandQueue()
--   cq:enqueue("move", function() end, { targetX = 200, targetY = 100 })
...
-- if false then -- CommandQueue:type
--   local cq = lurek.ai.newCommandQueue()
--   cq:enqueue("move", function() end, { targetX = 200, targetY = 100 })
...
-- if false then -- CommandQueue:typeOf
--   local cq = lurek.ai.newCommandQueue()
--   cq:enqueue("move", function() end, { targetX = 200, targetY = 100 })
...
-- if false then -- TraitProfile:set
...
-- if false then -- TraitProfile:get
--   local tp = lurek.ai.newTraitProfile()
--   tp:set("aggression", 0.7)
...
-- if false then -- TraitProfile:getBase
--   local tp = lurek.ai.newTraitProfile()
--   tp:set("aggression", 0.7)
...
-- if false then -- TraitProfile:removeModifiers
--   local tp = lurek.ai.newTraitProfile()
--   tp:set("aggression", 0.7)
...
-- if false then -- TraitProfile:update
--   local tp = lurek.ai.newTraitProfile()
--   tp:set("aggression", 0.7)
...
-- if false then -- TraitProfile:has
--   local tp = lurek.ai.newTraitProfile()
--   tp:set("aggression", 0.7)
...
-- if false then -- TraitProfile:traitCount
--   local tp = lurek.ai.newTraitProfile()
--   tp:set("aggression", 0.7)
...
-- if false then -- TraitProfile:archetype
--   local tp = lurek.ai.newTraitProfile()
--   tp:set("aggression", 0.7)
...
-- if false then -- StimulusWorld:remove
--   local sw = lurek.ai.newStimulusWorld()
...
-- if false then -- StimulusWorld:update
--   local sw = lurek.ai.newStimulusWorld()
--   local id = sw:addAuditory(100, 200, 1.0, 150, 0.5, "footstep")
--   function lurek.process(dt) sw:update(dt) end
-- end
...
-- if false then -- StimulusWorld:clear
--   local sw = lurek.ai.newStimulusWorld()
--   local id = sw:addAuditory(100, 200, 1.0, 150, 0.5, "footstep")
--   sw:clear()
-- end
...
-- if false then -- ContextSteering:addWander
--   local cs = lurek.ai.newContextSteering(16)
--   cs:addSeekTarget(500, 300, 1.0)
...
-- if false then -- ContextSteering:addAvoidBounds
--   local cs = lurek.ai.newContextSteering(16)
--   cs:addSeekTarget(500, 300, 1.0)
...
-- if false then -- ContextSteering:clearBehaviors
--   local cs = lurek.ai.newContextSteering(16)
--   cs:addSeekTarget(500, 300, 1.0)
--   cs:clearBehaviors()
-- end
...
-- if false then -- ContextSteering:chosenMagnitude
--   local cs = lurek.ai.newContextSteering(16)
--   cs:addSeekTarget(500, 300, 1.0)
--   cs:evaluate(0, 0, 0, 0)
...
-- if false then -- ContextSteering:slotCount
--   local cs = lurek.ai.newContextSteering(16)
--   cs:addSeekTarget(500, 300, 1.0)
...
-- if false then -- NeedSystem:addNeed
...
-- if false then -- NeedSystem:update
--   local ns = lurek.ai.newNeedSystem()
--   ns:addNeed("hunger", 0.05, 0.6, 1.5)
...
-- if false then -- NeedSystem:mostUrgent
--   local ns = lurek.ai.newNeedSystem()
--   ns:addNeed("hunger", 0.05, 0.6, 1.5)
...
-- if false then -- NeedSystem:satisfy
--   local ns = lurek.ai.newNeedSystem()
--   ns:addNeed("hunger", 0.05, 0.6, 1.5)
...
-- if false then -- NeedSystem:valueOf
--   local ns = lurek.ai.newNeedSystem()
--   ns:addNeed("hunger", 0.05, 0.6, 1.5)
...
-- if false then -- AIDirector:pushEvent
--   local dir = lurek.ai.newAIDirector()
--   dir:pushEvent(0.7)
-- end
...
-- if false then -- AIDirector:update
--   local dir = lurek.ai.newAIDirector()
--   function lurek.process(dt) dir:update(dt) end
-- end
...
-- if false then -- AIDirector:tension
--   local dir = lurek.ai.newAIDirector()
--   dir:pushEvent(0.5)
...
-- if false then -- AIDirector:phase
--   local dir = lurek.ai.newAIDirector()
...
-- if false then -- AIDirector:spawnRateFactor
--   local dir = lurek.ai.newAIDirector()
...
-- if false then -- AIDirector:lootFactor
--   local dir = lurek.ai.newAIDirector()
...
-- if false then -- AIDirector:ambientIntensity
--   local dir = lurek.ai.newAIDirector()
...
-- if false then -- AIDirector:setTension
--   local dir = lurek.ai.newAIDirector()
--   dir:setTension(0.9)
-- end
...
-- if false then -- AIDirector:reset
--   local dir = lurek.ai.newAIDirector()
--   dir:reset()
-- end
...
-- if false then -- HTNDomain:addPrimitive
--   local d = lurek.ai.newHTNDomain()
...
-- if false then -- HTNDomain:taskCount
--   local d = lurek.ai.newHTNDomain()
...
-- if false then -- EmotionModel:trigger
--   local em = lurek.ai.newEmotionModel()
--   em:add("fear", 0.0, 0.1, 0.2)
--   em:trigger("fear", 0.5)
-- end
...
-- if false then -- EmotionModel:get
--   local em = lurek.ai.newEmotionModel()
--   em:add("fear", 0.0, 0.1, 0.2)
--   em:trigger("fear", 0.4)
...
-- if false then -- EmotionModel:dominant
--   local em = lurek.ai.newEmotionModel()
--   em:add("fear", 0.0, 0.1, 0.2)
--   em:trigger("fear", 0.6)
--   local d = em:dominant()
...
-- if false then -- EmotionModel:isActive
--   local em = lurek.ai.newEmotionModel()
--   em:add("fear", 0.0, 0.1, 0.2)
--   em:trigger("fear", 0.5)
...
-- if false then -- EmotionModel:update
--   local em = lurek.ai.newEmotionModel()
--   em:add("fear", 0.0, 0.1, 0.2)
...
-- if false then -- EmotionModel:reset
--   local em = lurek.ai.newEmotionModel()
--   em:add("fear", 0.0, 0.1, 0.2)
--   em:reset()
-- end
...
-- if false then -- ORCASolver:setPosition
--   local orca = lurek.ai.newORCASolver(2.0)
--   local idx = orca:addAgent(100, 100, 16, 80)
...
-- if false then -- ORCASolver:compute
--   local orca = lurek.ai.newORCASolver(2.0)
--   local idx = orca:addAgent(100, 100, 16, 80)
...
-- if false then -- ORCASolver:getSafeVelocity
--   local orca = lurek.ai.newORCASolver(2.0)
--   local idx = orca:addAgent(100, 100, 16, 80)
--   orca:compute(0.016)
...
-- if false then -- ORCASolver:agentCount
--   local orca = lurek.ai.newORCASolver(2.0)
--   local idx = orca:addAgent(100, 100, 16, 80)
...
-- if false then -- NeuralNet:forward
--   local nn = lurek.ai.newNeuralNet()
--   nn:addLayer(4, 8, "relu")
--   nn:addLayer(8, 2, "softmax")
...
-- if false then -- NeuralNet:setWeights
--   local nn = lurek.ai.newNeuralNet()
--   nn:addLayer(4, 8, "relu")
--   nn:addLayer(8, 2, "softmax")
...
-- if false then -- NeuralNet:getWeights
--   local nn = lurek.ai.newNeuralNet()
--   nn:addLayer(4, 8, "relu")
--   nn:addLayer(8, 2, "softmax")
...
-- if false then -- NeuralNet:paramCount
--   local nn = lurek.ai.newNeuralNet()
--   nn:addLayer(4, 8, "relu")
--   nn:addLayer(8, 2, "softmax")
...
-- if false then -- NeuralNet:layerCount
--   local nn = lurek.ai.newNeuralNet()
--   nn:addLayer(4, 8, "relu")
--   nn:addLayer(8, 2, "softmax")
...
-- if false then -- GeneticAlgorithm:evolve
...
-- if false then -- GeneticAlgorithm:generation
--   local ga = lurek.ai.newGeneticAlgorithm(20, 8, 42)
...
-- if false then -- GeneticAlgorithm:popSize
--   local ga = lurek.ai.newGeneticAlgorithm(20, 8, 42)
...
-- if false then -- GeneticAlgorithm:setFitness
--   local ga = lurek.ai.newGeneticAlgorithm(20, 8, 42)
...
-- if false then -- GeneticAlgorithm:getGenes
--   local ga = lurek.ai.newGeneticAlgorithm(20, 8, 42)
...
-- if false then -- GeneticAlgorithm:bestGenes
--   local ga = lurek.ai.newGeneticAlgorithm(20, 8, 42)
--   ga:setFitness(0, 1.0)
...
-- if false then -- Bandit:totalPulls
--   local b = lurek.ai.newBandit(4, "ucb1", 0.1, 99)
--   b:select(); b:select()
...
-- if false then -- Neuroevolution:evolve
...
-- if false then -- Neuroevolution:setFitness
--   local layers = { { inputs = 2, outputs = 4, activation = "relu" }, { inputs = 4, outputs = 1, activation = "tanh" } }
--   local ne = lurek.ai.newNeuroevolution(layers, 10, 1)
...
-- if false then -- Neuroevolution:chromosomeToNet
--   local layers = { { inputs = 2, outputs = 4, activation = "relu" }, { inputs = 4, outputs = 1, activation = "tanh" } }
--   local ne = lurek.ai.newNeuroevolution(layers, 10, 1)
...
-- if false then -- Neuroevolution:bestNetwork
--   local layers = { { inputs = 2, outputs = 4, activation = "relu" }, { inputs = 4, outputs = 1, activation = "tanh" } }
--   local ne = lurek.ai.newNeuroevolution(layers, 10, 1)
--   ne:setFitness(0, 1.0)
...
-- if false then -- Neuroevolution:bestFitness
--   local layers = { { inputs = 2, outputs = 4, activation = "relu" }, { inputs = 4, outputs = 1, activation = "tanh" } }
--   local ne = lurek.ai.newNeuroevolution(layers, 10, 1)
--   ne:setFitness(0, 0.7)
...
-- if false then -- Neuroevolution:popSize
--   local layers = { { inputs = 2, outputs = 4, activation = "relu" }, { inputs = 4, outputs = 1, activation = "tanh" } }
--   local ne = lurek.ai.newNeuroevolution(layers, 10, 1)
...
-- if false then -- Neuroevolution:generation
--   local layers = { { inputs = 2, outputs = 4, activation = "relu" }, { inputs = 4, outputs = 1, activation = "tanh" } }
--   local ne = lurek.ai.newNeuroevolution(layers, 10, 1)
...
-- if false then -- StrategyAI:addGoal
--   local s = lurek.ai.newStrategyAI(2.0)
--   s:addGoal("expand")
--   s:addGoal("defend")
-- end
...
-- if false then -- StrategyAI:addTag
--   local s = lurek.ai.newStrategyAI(2.0)
--   s:addTag("early_game")
-- end
...
-- if false then -- StrategyAI:removeTag
--   local s = lurek.ai.newStrategyAI(2.0)
...
-- if false then -- StrategyAI:update
--   local s = lurek.ai.newStrategyAI(2.0)
--   s:addGoal("expand")
...
-- if false then -- StrategyAI:forceEvaluate
--   local s = lurek.ai.newStrategyAI(2.0)
--   s:addGoal("retreat")
...
-- if false then -- StrategyAI:activeGoal
--   local s = lurek.ai.newStrategyAI(2.0)
...
-- if false then -- StrategyAI:timeUntilNext
--   local s = lurek.ai.newStrategyAI(2.0)
...
-- if false then -- AILod:shouldUpdate
--   local lod = lurek.ai.newAILod()
...
-- if false then -- Agent:setCustomModel
--   local world = lurek.ai.newWorld()
...
-- if false then -- lurek.ai.newGuard
...
-- if false then -- UtilityAI:addConsideration (custom curve)
...
-- if false then -- SteeringManager:addCustomBehavior
--   local sm = lurek.ai.newSteeringManager()
...
-- if false then -- SteeringManager:applyCustomSteering
--   local world = lurek.ai.newWorld()
...
-- if false then -- EmotionModel:add
--   local em = lurek.ai.newEmotionModel()
...
-- if false then -- GOAPPlanner:addAction
--   local planner = lurek.ai.newGOAPPlanner()
...
-- if false then -- UtilityAI:addAction
--   local uai = lurek.ai.newUtilityAI()
...
-- if false then -- AIWorld:addAgent
--   local world = lurek.ai.newWorld()
--   world:addAgent("guard_01")
...
-- if false then -- SteeringManager:addArrive
--   local sm = lurek.ai.newSteeringManager()
...
-- if false then -- StimulusWorld:addAuditory
--   local sw = lurek.ai.newStimulusWorld()
...
-- if false then -- ContextSteering:addAvoidPoint
--   local cs = lurek.ai.newContextSteering(16)
...
-- if false then -- HTNDomain:addCompound
--   local d = lurek.ai.newHTNDomain()
--   d:addPrimitive("attack", {"has_weapon"}, {"enemy_dead"}, {})
...
-- if false then -- SteeringManager:addEvade
--   local sm = lurek.ai.newSteeringManager()
...
-- if false then -- SteeringManager:addFlee
--   local sm = lurek.ai.newSteeringManager()
...
-- if false then -- SteeringManager:addFlock
--   local sm = lurek.ai.newSteeringManager()
...
-- if false then -- GOAPPlanner:addGoal
--   local planner = lurek.ai.newGOAPPlanner()
...
-- if false then -- InfluenceMap:addLayer
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- TraitProfile:addModifier
--   local traits = lurek.ai.newTraitProfile()
...
-- if false then -- SteeringManager:addPursue
--   local sm = lurek.ai.newSteeringManager()
...
-- if false then -- SteeringManager:addSeek
--   local sm = lurek.ai.newSteeringManager()
...
-- if false then -- ContextSteering:addSeekTarget
--   local cs = lurek.ai.newContextSteering(16)
--   cs:addSeekTarget(500, 300, 1.0)
...
-- if false then -- StateMachine:addTransition
--   local fsm = lurek.ai.newStateMachine()
--   fsm:addState("patrol", {})
--   fsm:addState("alert", {})
...
-- if false then -- StimulusWorld:addVisual
--   local sw = lurek.ai.newStimulusWorld()
...
-- if false then -- SteeringManager:addWander
--   local sm = lurek.ai.newSteeringManager()
...
-- if false then -- InfluenceMap:blend
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
--   im:addLayer("resource")
...
-- if false then -- SteeringManager:calculate
--   local sm = lurek.ai.newSteeringManager()
--   sm:addSeek(400, 300, 1.0)
...
-- if false then -- StimulusWorld:count
--   local sw = lurek.ai.newStimulusWorld()
...
-- if false then -- CommandQueue:enqueue
--   local q = lurek.ai.newCommandQueue()
...
-- if false then -- ContextSteering:evaluate
--   local cs = lurek.ai.newContextSteering(16)
--   cs:addSeekTarget(500, 300, 1.0)
...
-- if false then -- Blackboard:getBool
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- Squad:getFormationPosition
--   local squad = lurek.ai.newSquad("alpha")
--   squad:addMember("guard_01")
--   squad:setFormation("wedge", 32)
...
-- if false then -- InfluenceMap:getInfluence
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- Blackboard:getNumber
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- Blackboard:getString
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- GOAPPlanner:plan
--   local planner = lurek.ai.newGOAPPlanner()
...
-- if false then -- InfluenceMap:propagate
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- CommandQueue:pushFront
--   local q = lurek.ai.newCommandQueue()
...
-- if false then -- InfluenceMap:queryRect
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("resource")
...
-- if false then -- CommandQueue:replace
--   local q = lurek.ai.newCommandQueue()
...
-- if false then -- MCTSEngine:search
...
-- if false then -- GOAPPlanner:setEffect
--   local planner = lurek.ai.newGOAPPlanner()
...
-- if false then -- Squad:setFormation
...
-- if false then -- GOAPPlanner:setGoalState
--   local planner = lurek.ai.newGOAPPlanner()
...
-- if false then -- InfluenceMap:setInfluence
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("hazard")
...
-- if false then -- GOAPPlanner:setPrecondition
--   local planner = lurek.ai.newGOAPPlanner()
...
-- if false then -- ORCASolver:setPreferredVelocity
--   local orca = lurek.ai.newORCASolver(2.0)
...
-- if false then -- QLearner:setQValue
--   local ql = lurek.ai.newQLearner(8, 4)
...
-- if false then -- InfluenceMap:stampInfluence
--   local im = lurek.ai.newInfluenceMap(32, 32, 16)
--   im:addLayer("threat")
...
-- if false then -- ORCASolver:addAgent
...
-- if false then -- NeuralNet:addLayer
...
-- if false then -- LAIBlackboard:setNumber
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:getNumber
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:setBool
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:getBool
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:setString
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:getString
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:has
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:remove
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:clear
--   local bb = lurek.ai.newBlackboard()
--   bb:setNumber("hp", 80)
...
-- if false then -- LAIBlackboard:getKeys
--   local bb = lurek.ai.newBlackboard()
...
-- if false then -- LAIBlackboard:getSize
--   local bb = lurek.ai.newBlackboard()
--   bb:setNumber("x", 10)
--   bb:setNumber("y", 20)
...
-- if false then -- LAIBlackboard:type
...
-- if false then -- LAIBlackboard:typeOf
--   local a_i_blackboard_obj = lurek.ai.newBlackboard()
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LAIDirector:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LAIDirector:typeOf
--   local a_i_director_obj = lurek.ai.newAIDirector()
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LContextSteering:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LContextSteering:typeOf
--   local context_steering_obj = lurek.ai.newContextSteering(8)
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LEmotionModel:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LEmotionModel:typeOf
--   local emotion_model_obj = lurek.ai.newEmotionModel()
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LGeneticAlgorithm:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LGeneticAlgorithm:typeOf
--   local genetic_algorithm_obj = lurek.ai.newGeneticAlgorithm(20, 8, 42)
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LHTNDomain:typeOf
--   local h_t_n_domain_obj = lurek.ai.newHTNDomain()
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LMCTSEngine:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LMCTSEngine:typeOf
--   local m_c_t_s_engine_obj = lurek.ai.newMCTSEngine(100, 1.41, 5, 42)
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LNeedSystem:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LNeedSystem:typeOf
--   local need_system_obj = lurek.ai.newNeedSystem()
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LNeuralNet:typeOf
--   local neural_net_obj = lurek.ai.newNeuralNet()
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LNeuroevolution:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LNeuroevolution:typeOf
--   local ne_layers = { {inputs=4, outputs=8, activation="relu"}, {inputs=8, outputs=4, activation="softmax"} }
--   local ok_ne, neuroevolution_obj = pcall(lurek.ai.newNeuroevolution, ne_layers, 20, 42)
--   if not ok_ne then neuroevolution_obj = nil end
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LORCASolver:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LORCASolver:typeOf
--   local o_r_c_a_solver_obj = lurek.ai.newORCASolver(0.5)
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LStimulusWorld:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LStimulusWorld:typeOf
--   local stimulus_world_obj = lurek.ai.newStimulusWorld()
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LStrategyAI:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LStrategyAI:typeOf
--   local strategy_a_i_obj = lurek.ai.newStrategyAI(0.25)
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LTraitProfile:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LTraitProfile:typeOf
--   local trait_profile_obj = lurek.ai.newTraitProfile()
