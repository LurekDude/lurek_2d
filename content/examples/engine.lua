...
-- if false then -- lurek.engine.getVersion
...
-- if false then -- lurek.engine.getFrameBudget
...
-- if false then -- lurek.engine.memoryUsage
--   local accum = 0
--   function lurek.process(dt)
--     accum = accum + dt
--     if accum >= 1.0 then
...
-- if false then -- lurek.engine.platform
...
-- if false then -- lurek.engine.uptime
...
-- if false then -- lurek.engine.fps
--   local font
...
-- if false then -- lurek.engine.frameCount
...
-- if false then -- lurek.engine.isDebug
...
-- if false then -- lurek.engine.setResourceBudget
--   local mb = 256
...
-- if false then -- lurek.engine.getResourceStats
--   function lurek.process(_)
