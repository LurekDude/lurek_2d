...
-- if false then -- lurek.light.newLight
...
-- if false then -- lurek.light.newOccluder
...
-- if false then -- lurek.light.setAmbient
...
-- if false then -- lurek.light.getAmbient
...
-- if false then -- lurek.light.setEnabled
...
-- if false then -- lurek.light.isEnabled
...
-- if false then -- lurek.light.getLightCount
...
-- if false then -- lurek.light.getOccluderCount
...
-- if false then -- lurek.light.getMaxLights
...
-- if false then -- lurek.light.setMaxLights
--   local quality = "high"
...
-- if false then -- lurek.light.clear
--   lurek.light.clear()
...
-- if false then -- lurek.light.setGroupEnabled
...
-- if false then -- lurek.light.setGroupIntensity
--   local STREETLAMPS = 2
...
-- if false then -- lurek.light.setGroupColor
...
-- if false then -- lurek.light.getGroupCount
--   local TORCHES_GROUP = 1
...
-- if false then -- lurek.light.advanceFlickers
...
-- if false then -- lurek.light.syncAmbient
...
-- if false then -- lurek.light.getGodRayHints
...
-- if false then -- lurek.light.getNormalMapHints
...
-- if false then -- Light:setPosition
...
-- if false then -- Light:getPosition
...
-- if false then -- Light:setIntensity
...
-- if false then -- Light:getIntensity
...
-- if false then -- Light:setBlendMode
...
-- if false then -- Light:getBlendMode
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setFalloff
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getFalloff
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setShadowEnabled
...
-- if false then -- Light:isShadowEnabled
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getShadowColor
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setShadowFilter
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getShadowFilter
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setShadowSmooth
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getShadowSmooth
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setShadowSoftness
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getShadowSoftness
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setLightMask
...
-- if false then -- Light:getLightMask
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setShadowMask
...
-- if false then -- Light:getShadowMask
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setEnabled
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setLightType
--   local sun = lurek.light.newLight(0, 0, 500)
...
-- if false then -- Light:getLightType
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setDirection
...
-- if false then -- Light:getDirection
--   local sun = lurek.light.newLight(0, 0, 500)
...
-- if false then -- Light:setInnerAngle
...
-- if false then -- Light:getInnerAngle
--   local spot = lurek.light.newLight(0, 0, 200)
...
-- if false then -- Light:setOuterAngle
--   local spot = lurek.light.newLight(0, 0, 200)
--   spot:setLightType("spot")
...
-- if false then -- Light:getOuterAngle
--   local spot = lurek.light.newLight(0, 0, 200)
...
-- if false then -- Light:setAttenuation
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getAttenuation
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setFlicker
--   local torch = lurek.light.newLight(0, 0, 120)
...
-- if false then -- Light:getFlicker
--   local torch = lurek.light.newLight(0, 0, 120)
...
-- if false then -- Light:setFlickerEnabled
--   local torch = lurek.light.newLight(0, 0, 120)
...
-- if false then -- Light:isFlickerEnabled
--   local torch = lurek.light.newLight(0, 0, 120)
...
-- if false then -- Light:setGroupId
--   local TORCHES = 1
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getGroupId
--   local lamp = lurek.light.newLight(0, 0, 100)
--   lamp:setGroupId(7)
...
-- if false then -- Light:setVolumetric
...
-- if false then -- Light:isVolumetric
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:addFlicker
--   local torch = lurek.light.newLight(0, 0, 120)
...
-- if false then -- Light:updateTransition
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:stopTransition
--   local lamp = lurek.light.newLight(0, 0, 100)
--   lamp:stopTransition()
-- end
...
-- if false then -- Light:transitionProgress
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:clearCookie
--   local lamp = lurek.light.newLight(0, 0, 100)
--   lamp:setCookie("textures/leaves.png")
--   lamp:clearCookie()
-- end
...
-- if false then -- Light:setNormalMap
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getNormalMap
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:clearNormalMap
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:setNormalStrength
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Light:getNormalStrength
--   local lamp = lurek.light.newLight(0, 0, 100)
...
-- if false then -- Occluder:setVertices
...
-- if false then -- Occluder:getVertices
...
-- if false then -- Occluder:setPosition
...
-- if false then -- Occluder:getPosition
--   local crate = lurek.light.newOccluder({ 0, 0, 64, 0, 64, 64, 0, 64 })
...
-- if false then -- Occluder:setOpacity
...
-- if false then -- Occluder:getOpacity
--   local wall = lurek.light.newOccluder({ 0, 0, 100, 0, 100, 20, 0, 20 })
...
-- if false then -- Occluder:setLightMask
...
-- if false then -- Occluder:getLightMask
--   local wall = lurek.light.newOccluder({ 0, 0, 100, 0, 100, 20, 0, 20 })
...
-- if false then -- Occluder:setEnabled
...
-- if false then -- Occluder:isEnabled
--   local wall = lurek.light.newOccluder({ 0, 0, 100, 0, 100, 20, 0, 20 })
...
-- if false then -- Occluder:isValid
--   local wall = lurek.light.newOccluder({ 0, 0, 100, 0, 100, 20, 0, 20 })
--   wall:remove()
...
-- if false then -- Light:setShadowColor
...
-- if false then -- Light:transitionTo
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LOccluder:typeOf
--   local occluder_obj = lurek.light.newOccluder({0,0,100,0,100,50,0,50})
...
-- if false then -- LLight:setPosition
...
-- if false then -- LLight:getPosition
...
-- if false then -- LLight:setRadius
...
-- if false then -- LLight:getRadius
...
-- if false then -- LLight:setIntensity
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setIntensity(2.5)
...
-- if false then -- LLight:getIntensity
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setIntensity(0.8)
--   lurek.log.info("intensity=" .. lt:getIntensity(), "light")
-- end
...
-- if false then -- LLight:setEnergy
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setEnergy(1.5)
...
-- if false then -- LLight:getEnergy
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setEnergy(0.7)
--   lurek.log.info("energy=" .. lt:getEnergy(), "light")
-- end
...
-- if false then -- LLight:setBlendMode
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setBlendMode("add")
...
-- if false then -- LLight:getBlendMode
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setBlendMode("mix")
--   lurek.log.info("blend_mode=" .. lt:getBlendMode(), "light")
-- end
...
-- if false then -- LLight:setFalloff
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:getFalloff
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setShadowEnabled
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setShadowEnabled(true)
...
-- if false then -- LLight:isShadowEnabled
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setShadowColor
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setShadowEnabled(true)
...
-- if false then -- LLight:getShadowColor
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setShadowFilter
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setShadowEnabled(true)
...
-- if false then -- LLight:getShadowFilter
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setShadowSmooth
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:getShadowSmooth
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setLightMask
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:getLightMask
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setShadowMask
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setShadowEnabled(true)
...
-- if false then -- LLight:getShadowMask
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setEnabled
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setEnabled(false)
...
-- if false then -- LLight:isEnabled
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setLightType
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:getLightType
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setDirection
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setLightType("spot")
...
-- if false then -- LLight:getDirection
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setLightType("spot")
...
-- if false then -- LLight:setInnerAngle
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setLightType("spot")
--   lt:setInnerAngle(math.pi / 8)
...
-- if false then -- LLight:getInnerAngle
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setLightType("spot")
...
-- if false then -- LLight:setOuterAngle
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setLightType("spot")
--   lt:setInnerAngle(math.pi / 8)
--   lt:setOuterAngle(math.pi / 4)
...
-- if false then -- LLight:getOuterAngle
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setLightType("spot")
...
-- if false then -- LLight:setAttenuation
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:getAttenuation
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setFlicker
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:getFlicker
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setFlickerEnabled
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:isFlickerEnabled
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setGroupId
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setGroupId(1)
...
-- if false then -- LLight:getGroupId
--   local lt = lurek.light.newLight(400, 300, 200)
--   lt:setGroupId(2)
--   lurek.log.info("group_id=" .. lt:getGroupId(), "light")
-- end
...
-- if false then -- LLight:setVolumetric
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:isVolumetric
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:addFlicker
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:transitionTo
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:updateTransition
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:stopTransition
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:transitionProgress
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:setCookie
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:getCookie
--   local lt = lurek.light.newLight(400, 300, 200)
...
-- if false then -- LLight:clearCookie
--   local lt = lurek.light.newLight(400, 300, 200)
