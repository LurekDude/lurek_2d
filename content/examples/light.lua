...
-- Returns true if this object is of the given type.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lLight_stub:typeOf("hero")  -- -> boolean
-- (replace lLight_stub with your real LLight instance above)
...
-- Returns the type name of this object.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lOccluder_stub:type()  -- -> string
-- (replace lOccluder_stub with your real LOccluder instance above)

-- ---- Stub: LOccluder:typeOf ----------------------------------------------
--@api-stub: LOccluder:typeOf
-- Returns true if this object is of the given type.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lOccluder_stub:typeOf("hero")  -- -> boolean
-- (replace lOccluder_stub with your real LOccluder instance above)

-- =============================================================================
-- STUBS: 68 uncovered lurek.light API item(s)
-- Generated by tools/audit/example_add_missing.py
-- REQUIRED: replace every --@api-stub: block below with a real scenario.
-- Run .github/prompts/flesh-out-example.prompt.md for instructions.
-- The final committed file must contain ZERO --@api-stub: lines.
