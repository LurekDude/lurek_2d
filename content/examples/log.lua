...
-- if false then -- lurek.log.setLevel
...
-- if false then -- lurek.log.getLevel
...
-- if false then -- lurek.log.addSink
...
-- if false then -- lurek.log.removeSink
...
-- if false then -- lurek.log.clearSinks
...
-- if false then -- lurek.log.listSinks
...
-- if false then -- lurek.log.readMemory
...
-- if false then -- lurek.log.flushFile
...
-- if false then -- lurek.log.struct
...
-- if false then -- lurek.log.debug_fields
--   local dt = 0.01666
...
-- if false then -- lurek.log.info_fields
...
-- if false then -- lurek.log.warn_fields
...
-- if false then -- lurek.log.error_fields
