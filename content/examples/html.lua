...
--   <div id="lives" class="hud-item">â™Ąâ™Ąâ™Ą</div>
-- </body>
-- ]], {
--     css = [[
...
-- =============================================================================
-- COVERAGE: 11 uncovered lurek.html API item(s)
...
-- ---- Example: lurek.html.preventDefault -------------------------------------
...
-- if false then -- lurek.html.preventDefault
...
-- ---- Example: lurek.html.stopPropagation ------------------------------------
...
-- if false then -- lurek.html.stopPropagation
--   hud:on("click", function()
...
-- ---- Example: lurek.html.isDefaultPrevented ---------------------------------
...
-- if false then -- lurek.html.isDefaultPrevented
--   hud:on("click", function()
--     if lurek.html.preventDefault then lurek.html.preventDefault() end
...
-- ---- Example: lurek.html.loadDocument ---------------------------------------
--@api-stub: lurek.html.loadDocument
...
-- if false then -- lurek.html.loadDocument
...
-- =============================================================================
-- COVERAGE: 8 uncovered lurek.html API item(s)
-- Generated by tools/audit/example_add_missing.py
-- REQUIRED: replace every --@api-stub: block below with a real scenario.
-- Run .github/prompts/flesh-out-example.prompt.md for instructions.
-- The final committed file must contain ZERO --@api-stub: lines.
...
-- if false then -- LHtmlDocument:type
...
-- if false then -- LHtmlDocument:typeOf
--   local html_document_obj = lurek.html.newDocument("assets/sound.ogg", nil)
...
-- if false then -- LHtmlElement:type
...
-- if false then -- LHtmlElement:typeOf
--   local doc = lurek.html.newDocument()
