...
-- if false then -- lurek.dataframe.newDataFrame
...
-- if false then -- lurek.dataframe.newDatabase
...
-- if false then -- lurek.dataframe.fromTable
--   local rows = {
...
-- if false then -- lurek.dataframe.fromRows
...
-- if false then -- lurek.dataframe.fromCSV
...
-- if false then -- lurek.dataframe.fromJSON
...
-- if false then -- lurek.dataframe.fromBinary
...
-- if false then -- lurek.dataframe.random
...
-- if false then -- DataFrame:columns
...
-- if false then -- DataFrame:removeColumn
...
-- if false then -- DataFrame:rename
...
-- if false then -- DataFrame:getColumn
...
-- if false then -- DataFrame:addRow
...
-- if false then -- DataFrame:removeRow
...
-- if false then -- DataFrame:getRow
...
-- if false then -- DataFrame:getValue
--   local df = lurek.dataframe.fromTable({{name = "Alice", hp = 80}})
...
-- if false then -- DataFrame:select
...
-- if false then -- DataFrame:unique
...
-- if false then -- DataFrame:groupBy
...
-- if false then -- DataFrame:countBy
...
-- if false then -- DataFrame:dropNil
...
-- if false then -- DataFrame:sample
...
-- if false then -- DataFrame:describe
...
-- if false then -- DataFrame:median
...
-- if false then -- DataFrame:stddev
...
-- if false then -- DataFrame:variance
...
-- if false then -- DataFrame:fillNil
...
-- if false then -- DataFrame:toJSON
...
-- if false then -- DataFrame:toBinary
...
-- if false then -- DataFrame:toTable
--   local df = lurek.dataframe.fromTable({{name = "Alice", hp = 80}})
...
-- if false then -- DataFrame:toString
...
-- if false then -- DataFrame:correlationMatrix
...
-- if false then -- DataFrame:modeVal
...
-- if false then -- DataFrame:entropy
...
-- if false then -- DataFrame:addRowBatch
...
-- if false then -- DataFrame:getColumnAsF64
...
-- if false then -- DataFrame:setColumnFromF64
...
-- if false then -- DataFrame:typeOf
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:withEval
...
-- if false then -- Database:getTable
--   local db = lurek.dataframe.newDatabase()
...
-- if false then -- Database:removeTable
--   local db = lurek.dataframe.newDatabase()
...
-- if false then -- Database:hasTable
--   local db = lurek.dataframe.newDatabase()
...
-- if false then -- Database:listTables
--   local db = lurek.dataframe.newDatabase()
...
-- if false then -- Database:tableCount
--   local db = lurek.dataframe.newDatabase()
--   db:addTable("scores", lurek.dataframe.newDataFrame())
...
-- if false then -- GroupedFrame:aggregate
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:groupByObj
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- lurek.dataframe.toVec
...
-- if false then -- lurek.dataframe.fromVec
--   local df = lurek.dataframe.fromCSV("hp,mp\n100,50\n200,80\n")
--   local vf = lurek.dataframe.toVec(df)
...
-- if false then -- VecFrame:colClamp
...
-- if false then -- VecFrame:colSqrt
...
-- op: "<" | "<=" | ">" | ">=" | "==" | "!="
-- if false then -- VecFrame:filterMask
--   local vf = lurek.dataframe.toVec(lurek.dataframe.fromCSV("hp\n10\n50\n90\n"))
...
-- if false then -- VecFrame:applyMask
--   local vf = lurek.dataframe.toVec(lurek.dataframe.fromCSV("hp\n10\n50\n90\n"))
...
-- if false then -- VecFrame:colType
--   local vf = lurek.dataframe.toVec(lurek.dataframe.fromCSV("hp\n10\n20\n"))
...
-- if false then -- VecFrame:parReduce
...
-- if false then -- VecFrame:toDataFrame
...
-- if false then -- VecFrame:colFloor
...
-- if false then -- VecFrame:colCeil
...
-- if false then -- VecFrame:colCast
...
-- if false then -- VecFrame:columns
...
-- if false then -- DataFrame:addColumn
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- Database:addTable
--   local db = lurek.dataframe.newDatabase()
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:filter
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:groupAgg
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:normalizeCol
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:outliers
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- VecFrame:parScalarOp
...
-- if false then -- DataFrame:pivotTable
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:rollingMean
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:rollingSum
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:setValue
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:withCumsum
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:withPctChange
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:withRank
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:withRollingMax
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:withRollingMean
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:withRollingMin
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:withRollingSum
--   local df = lurek.dataframe.newDataFrame()
...
-- if false then -- DataFrame:zscoreCol
--   local df = lurek.dataframe.newDataFrame()
