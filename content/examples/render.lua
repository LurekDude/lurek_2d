...
do  -- SpriteBatch:add
  local img = lurek.render.newImage("sprites/hero.png")
  local batch = lurek.render.newSpriteBatch(img, 256)
  batch:add(100, 200, 0, 1, 1, 16, 16)
  lurek.log.info("batch count: " .. batch:getCount(), "render")
end
