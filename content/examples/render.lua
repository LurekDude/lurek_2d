...
-- if false then -- lurek.render.setColor
...
-- if false then -- lurek.render.getColor
--   function lurek.draw()
...
-- if false then -- lurek.render.setBackgroundColor
...
-- if false then -- lurek.render.getBackgroundColor
...
-- if false then -- lurek.render.rectangle
--   function lurek.draw()
...
-- if false then -- lurek.render.circle
--   function lurek.draw()
...
-- if false then -- lurek.render.ellipse
--   function lurek.draw()
...
-- if false then -- lurek.render.triangle
--   function lurek.draw()
...
-- if false then -- lurek.render.line
--   function lurek.draw()
...
-- if false then -- lurek.render.polygon
--   function lurek.draw()
...
-- if false then -- lurek.render.arc
--   function lurek.draw()
...
-- if false then -- lurek.render.points
--   function lurek.draw()
...
-- if false then -- lurek.render.draw
--   local img
...
-- if false then -- lurek.render.drawq
--   local sheet, frame
--   function lurek.init()
...
-- if false then -- lurek.render.print
...
-- if false then -- lurek.render.printf
--   function lurek.draw()
...
-- if false then -- lurek.render.printRich
--   function lurek.draw()
...
-- if false then -- lurek.render.clear
...
-- if false then -- lurek.render.setLineWidth
--   function lurek.draw()
...
-- if false then -- lurek.render.getLineWidth
...
-- if false then -- lurek.render.setPointSize
--   function lurek.draw()
...
-- if false then -- lurek.render.getPointSize
...
-- if false then -- lurek.render.setBlendMode
--   function lurek.draw()
...
-- if false then -- lurek.render.getBlendMode
...
-- if false then -- lurek.render.newFont
--   local hud_font
...
-- if false then -- lurek.render.setFont
--   local title_font
...
-- if false then -- lurek.render.getFont
...
-- if false then -- lurek.render.getFontSizes
...
-- if false then -- lurek.render.getDefaultFont
--   pcall(function()
...
-- if false then -- lurek.render.getFontCellWidth
--   pcall(function()
...
-- if false then -- lurek.render.getFontWidth
--   pcall(function()
...
-- if false then -- lurek.render.getFontHeight
--   pcall(function()
...
-- if false then -- lurek.render.getFontLineHeight
--   pcall(function()
...
-- Sets the line height of the given font (stub Ä‚â€žĂ˘â‚¬ĹˇÄ‚â€ąĂ‚ÂĂ„â€šĂ‹ÂÄ‚ËĂ˘â€šÂ¬ÄąË‡Ä‚â€šĂ‚Â¬Ă„â€šĂ‹ÂÄ‚ËĂ˘â‚¬ĹˇĂ‚Â¬Ă„Ä…Ă„â€ž returns nil; fonts are immutable in headless mode).
-- Pass 1.25 for paragraph text; 1.0 for tight HUD readouts.
-- if false then -- lurek.render.setFontLineHeight
--   pcall(function()
...
-- if false then -- lurek.render.getFontAscent
--   pcall(function()
...
-- if false then -- lurek.render.getFontDescent
--   pcall(function()
...
-- if false then -- lurek.render.getFontWrap
--   pcall(function()
...
-- if false then -- lurek.render.newImage
--   local hero
...
-- if false then -- lurek.render.newCanvas
--   local rt
...
-- if false then -- lurek.render.setCanvas
--   local rt
--   function lurek.init() rt = lurek.render.newCanvas(320, 240) end
--   function lurek.draw()
...
-- if false then -- lurek.render.getCanvas
...
-- if false then -- lurek.render.getCanvasSize
--   pcall(function()
...
-- if false then -- lurek.render.newSpriteBatch
--   local batch
...
-- if false then -- lurek.render.newMesh
--   local mesh
--   function lurek.init()
...
-- if false then -- lurek.render.newShader
--   local sh
--   function lurek.init()
...
-- if false then -- lurek.render.setShader
--   local sh
...
-- if false then -- lurek.render.getShader
...
-- if false then -- lurek.render.newQuad
--   local sheet, q
--   function lurek.init()
--     sheet = lurek.render.newImage('img/sheet.png')
...
-- if false then -- lurek.render.push
--   function lurek.draw()
...
-- if false then -- lurek.render.pop
...
-- if false then -- lurek.render.translate
...
-- if false then -- lurek.render.rotate
--   function lurek.draw()
...
-- if false then -- lurek.render.scale
...
-- if false then -- lurek.render.shear
...
-- if false then -- lurek.render.origin
...
-- if false then -- lurek.render.applyTransform
...
-- if false then -- lurek.render.setScissor
--   function lurek.draw()
...
-- if false then -- lurek.render.getScissor
...
-- if false then -- lurek.render.intersectScissor
--   function lurek.draw()
...
-- if false then -- lurek.render.setColorMask
--   function lurek.draw()
...
-- if false then -- lurek.render.getColorMask
...
-- if false then -- lurek.render.setWireframe
...
-- if false then -- lurek.render.isWireframe
...
-- if false then -- lurek.render.stencil
--   function lurek.draw()
...
-- if false then -- lurek.render.setStencilTest
...
-- if false then -- lurek.render.setStencilMode
...
-- if false then -- lurek.render.getStencilMode
...
-- if false then -- lurek.render.clearStencil
...
-- if false then -- lurek.render.setDepthMode
...
-- if false then -- lurek.render.getDepthMode
...
-- if false then -- lurek.render.getWidth
...
-- if false then -- lurek.render.getHeight
...
-- if false then -- lurek.render.getDimensions
...
-- if false then -- lurek.render.setDefaultFilter
...
-- if false then -- lurek.render.getDefaultFilter
...
-- if false then -- lurek.render.getStats
...
-- if false then -- lurek.render.saveScreenshot
...
-- if false then -- lurek.render.captureScreenshot
--   function lurek.init()
...
-- if false then -- lurek.render.newNineSlice
--   local panel
--   function lurek.init()
...
-- if false then -- lurek.render.drawNineSlice
--   local panel
--   function lurek.init()
--     local ok_img, img = pcall(lurek.render.newImage, "img/panel.png")
--     if ok_img then panel = lurek.render.newNineSlice(img, 8, 8, 8, 8) end
...
-- if false then -- lurek.render.newShape
--   local s
--   function lurek.init()
...
-- if false then -- lurek.render.newDrawLayer
--   local layer
...
-- if false then -- lurek.render.drawQuadBezier
--   function lurek.draw()
...
-- if false then -- lurek.render.drawCubicBezier
--   function lurek.draw()
...
-- if false then -- lurek.render.drawPath
--   function lurek.draw()
...
-- if false then -- lurek.render.drawGradientRect
--   function lurek.draw()
...
-- if false then -- lurek.render.drawColoredPolygon
--   function lurek.draw()
...
-- if false then -- lurek.render.drawIsoCubeTile
--   function lurek.draw()
...
-- if false then -- lurek.render.drawHexTile
--   function lurek.draw()
...
-- if false then -- lurek.render.beginSortGroup
--   function lurek.draw()
...
-- if false then -- lurek.render.pushSortKey
--   function lurek.draw()
--     lurek.render.beginSortGroup(1)
...
-- if false then -- lurek.render.flushSortGroup
--   function lurek.draw()
--     lurek.render.beginSortGroup(1)
...
-- if false then -- lurek.render.drawBevelRect
--   function lurek.draw()
...
-- if false then -- lurek.render.pushLayer
--   function lurek.draw()
...
-- if false then -- lurek.render.popLayer
...
-- if false then -- lurek.render.newLayer
...
-- if false then -- lurek.render.setLayer
...
-- if false then -- lurek.render.currentLayer
...
-- if false then -- lurek.render.setLayerVisible
...
-- if false then -- lurek.render.isLayerVisible
...
-- if false then -- lurek.render.getLayerZOrder
...
-- if false then -- lurek.render.setLayerZOrder
...
-- if false then -- ImageData:getWidth
...
-- if false then -- ImageData:getHeight
...
-- if false then -- ImageData:resize
--   local data = screenshot()
...
-- if false then -- ImageData:mapPixels
--   local data = screenshot()
...
-- if false then -- ImageData:typeOf
--   local data = screenshot()
...
-- if false then -- NineSlice:getInsets
--   local panel
--   function lurek.init()
--     local ok_img, img = pcall(lurek.render.newImage, "img/panel.png")
--     if ok_img then panel = lurek.render.newNineSlice(img, 8, 8, 8, 8) end
...
-- if false then -- NineSlice:getTextureSize
--   local panel
--   function lurek.init()
--     local ok_img, img = pcall(lurek.render.newImage, "img/panel.png")
--     if ok_img then panel = lurek.render.newNineSlice(img, 8, 8, 8, 8) end
...
-- Boolean class check.
-- if false then -- NineSlice:typeOf
--   local panel
--   function lurek.init()
--     local ok_img, img = pcall(lurek.render.newImage, "img/panel.png")
--     if ok_img then panel = lurek.render.newNineSlice(img, 8, 8, 8, 8) end
...
-- if false then -- Image:getDimensions
--   local img
...
-- if false then -- Font:getLineHeight
--   local f
...
-- if false then -- Font:setLineHeight
--   local f
...
-- if false then -- Canvas:getHeight
--   local c
...
-- if false then -- Canvas:getDimensions
--   local c
...
-- if false then -- SpriteBatch:clear
--   local batch
--   function lurek.init() batch = lurek.render.newSpriteBatch(lurek.render.newImage('img/tiles.png'), 1024) end
...
-- if false then -- SpriteBatch:getCount
--   local batch
...
-- if false then -- SpriteBatch:getBufferSize
--   local batch
...
-- if false then -- SpriteBatch:release
--   local batch
--   function lurek.init() batch = lurek.render.newSpriteBatch(lurek.render.newImage('img/tiles.png'), 256) end
...
-- Returns the type name of this object.
-- Boolean class check.
-- if false then -- SpriteBatch:typeOf
--   local batch
...
-- Returns the type name of this object.
-- Returns 'SpriteBatch'.
-- if false then -- SpriteBatch:type
--   local batch
...
-- if false then -- Mesh:getVertexCount
--   local m
...
-- if false then -- Shader:hasUniform
--   local sh
...
-- if false then -- Quad:getViewport
--   local q
...
-- if false then -- Quad:getTextureDimensions
--   local q
...
-- if false then -- Shape:getCommandCount
--   local s
...
-- if false then -- Shape:setLineWidth
--   local s
...
-- if false then -- DrawLayer:getCount
--   local dl
...
-- Boolean class check.
-- if false then -- DrawLayer:typeOf
--   local dl
...
-- if false then -- ImageData:getRegion
...
-- if false then -- Shape:roundedRectangle
--   local s = lurek.render.newShape()
...
-- if false then -- Quad:setViewport
...
-- =============================================================================
-- STUBS: 2 uncovered lurek.render API item(s)
...
-- =============================================================================
-- STUBS: 80 uncovered lurek.render API item(s)
-- Generated by tools/audit/example_add_missing.py
-- REQUIRED: replace every --@api-stub: block below with a real scenario.
-- Run .github/prompts/flesh-out-example.prompt.md for instructions.
-- The final committed file must contain ZERO --@api-stub: lines.
...
-- =============================================================================
-- STUBS: 11 uncovered lurek.render API item(s)
-- Generated by tools/audit/example_add_missing.py
-- REQUIRED: replace every --@api-stub: block below with a real scenario.
-- Run .github/prompts/flesh-out-example.prompt.md for instructions.
-- The final committed file must contain ZERO --@api-stub: lines.
...
-- ---- Stub: lurek.render.printRotated -------------------------------------
...
-- ---- Stub: LLObjModel:getVertexCount -------------------------------------
--@api-stub: LLObjModel:getVertexCount
-- (no description)
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lLObjModel_stub:getVertexCount()  -- -> integer
-- (replace lLObjModel_stub with your real LLObjModel instance above)

-- ---- Stub: LLObjModel:getFaceCount ---------------------------------------
--@api-stub: LLObjModel:getFaceCount
-- (no description)
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lLObjModel_stub:getFaceCount()  -- -> integer
-- (replace lLObjModel_stub with your real LLObjModel instance above)

-- ---- Stub: LLObjModel:getUvCount -----------------------------------------
--@api-stub: LLObjModel:getUvCount
-- (no description)
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lLObjModel_stub:getUvCount()  -- -> integer
-- (replace lLObjModel_stub with your real LLObjModel instance above)

-- ---- Stub: LLObjModel:getNormalCount -------------------------------------
--@api-stub: LLObjModel:getNormalCount
-- (no description)
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lLObjModel_stub:getNormalCount()  -- -> integer
-- (replace lLObjModel_stub with your real LLObjModel instance above)

-- ---- Stub: LLObjModel:renderToImage --------------------------------------
--@api-stub: LLObjModel:renderToImage
-- Rasterizes the model into a cached sprite image using material colors from the MTL.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lLObjModel_stub:renderToImage(256, 256, [rotation])  -- -> LImage
-- (replace lLObjModel_stub with your real LLObjModel instance above)

-- ---- Stub: LLObjModel:projectToMesh --------------------------------------
--@api-stub: LLObjModel:projectToMesh
-- Projects the 3-D model to a flat 2-D vertex table.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lLObjModel_stub:projectToMesh(cam_tbl, screen_w, screen_h)  -- -> table
-- (replace lLObjModel_stub with your real LLObjModel instance above)
