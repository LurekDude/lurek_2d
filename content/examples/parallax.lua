...
-- if false then -- lurek.parallax.newLayer
--   function lurek.init()
...
-- if false then -- lurek.parallax.newSet
--   function lurek.init()
...
-- if false then -- ParallaxLayer:type
--   function lurek.init()
...
-- if false then -- ParallaxLayer:update
--   local clouds
--   function lurek.init()
...
-- if false then -- ParallaxLayer:render
--   local hills
--   function lurek.init()
...
-- if false then -- ParallaxLayer:renderAuto
--   local mountains
--   function lurek.init()
...
-- if false then -- ParallaxLayer:resetAutoscroll
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setScrollFactor
--   function lurek.init()
...
-- if false then -- ParallaxLayer:getScrollFactor
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setOffset
--   function lurek.init()
...
-- if false then -- ParallaxLayer:getOffset
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setAutoscroll
--   function lurek.init()
...
-- if false then -- ParallaxLayer:getAutoscroll
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setRepeat
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setScale
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setZ
--   function lurek.init()
...
-- if false then -- ParallaxLayer:getZ
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setOpacity
--   function lurek.init()
...
-- if false then -- ParallaxLayer:getOpacity
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setTint
--   function lurek.init()
--     local sky = lurek.parallax.newLayer({ texture = lurek.render.newImage("assets/parallax/sky.png") })
...
-- if false then -- ParallaxLayer:getTint
--   function lurek.init()
--     local sky = lurek.parallax.newLayer({ texture = lurek.render.newImage("assets/parallax/sky.png") })
...
-- if false then -- ParallaxLayer:setBlendMode
--   function lurek.init()
...
-- if false then -- ParallaxLayer:getBlendMode
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setVisible
--   function lurek.init()
...
-- if false then -- ParallaxLayer:isVisible
--   local rain
--   function lurek.init()
...
-- if false then -- ParallaxLayer:clearClamp
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setTiling
--   function lurek.init()
...
-- if false then -- ParallaxLayer:getTiling
--   function lurek.init()
--     local stars = lurek.parallax.newLayer({ texture = lurek.render.newImage("assets/parallax/stars.png") })
--     stars:setTiling(true)
...
-- if false then -- ParallaxLayer:setTileSize
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setDepth
--   function lurek.init()
...
-- if false then -- ParallaxLayer:getDepth
--   function lurek.init()
--     local mist = lurek.parallax.newLayer({ texture = lurek.render.newImage("assets/parallax/mist.png") })
--     mist:setDepth(10.5)
...
-- if false then -- ParallaxSet:type
--   function lurek.init()
...
-- if false then -- ParallaxSet:addLayer
--   function lurek.init()
...
-- if false then -- ParallaxSet:removeLayerAt
--   function lurek.init()
...
-- if false then -- ParallaxSet:layerCount
--   function lurek.init()
...
-- if false then -- ParallaxSet:sortByZ
--   function lurek.init()
...
-- if false then -- ParallaxSet:setVisible
--   function lurek.init()
...
-- if false then -- ParallaxSet:isVisible
--   local backdrop
--   function lurek.init()
...
-- if false then -- ParallaxSet:update
--   local backdrop
--   function lurek.init()
...
-- if false then -- ParallaxSet:render
--   local backdrop
--   function lurek.init()
...
-- if false then -- ParallaxSet:renderAuto
--   local backdrop
--   function lurek.init()
...
-- if false then -- ParallaxSet:getName
--   function lurek.init()
...
-- if false then -- ParallaxSet:setName
--   function lurek.init()
...
-- if false then -- ParallaxLayer:setClamp
