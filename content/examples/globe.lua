...
-- if false then -- lurek.globe.loadFromTOML
--   local toml_src = [=[
--   [[provinces]]
--   id = 1
--   centroid = [10.0, 20.0]
...
-- if false then -- lurek.globe.greatCircleDistance
...
-- if false then -- lurek.globe.greatCirclePath
...
-- if false then -- lurek.globe.latLonToUnit
...
-- if false then -- Globe:addProvince
...
-- if false then -- Globe:removeProvince
...
-- if false then -- Globe:provinceCount
...
-- if false then -- Globe:getNeighbors
...
-- if false then -- Globe:getProvinceAttr
...
-- if false then -- Globe:pickLatLon
...
-- if false then -- Globe:setActiveViewer
...
-- if false then -- Globe:revealProvince
...
-- if false then -- Globe:hideProvince
...
-- if false then -- Globe:removeMarker
...
-- if false then -- Globe:moveMarker
...
-- if false then -- Globe:setMarkerVisible
...
-- if false then -- Globe:getMarkerAttr
...
-- if false then -- Globe:setLabelText
...
-- if false then -- Globe:setLabelVisible
...
-- if false then -- Globe:removeLabel
...
-- if false then -- Globe:removeLayer
...
-- if false then -- Globe:setLayerVisible
...
-- if false then -- Globe:setLayerAlpha
...
-- if false then -- Globe:setTimeOfDay
...
-- if false then -- Globe:getTimeOfDay
...
-- if false then -- Globe:setRotation
...
-- if false then -- Globe:setBorders
...
-- if false then -- GlobeRegistry:get
...
-- if false then -- GlobeRegistry:remove
...
-- if false then -- GlobeRegistry:names
...
-- if false then -- Globe:setLayerColor
...
-- if false then -- Globe:setMarkerAttr
...
-- if false then -- Globe:setProvinceAttr
...
-- Returns the type name of this object.
-- Useful for runtime type inspection.
-- if false then -- LGlobeRegistry:type
...
-- Returns true if this object is of the given type.
-- Use for runtime type checks.
-- if false then -- LGlobeRegistry:typeOf
--   local obj = lurek.globe.new("alt_world", {})
--     local g = lurek.globe.get("alt_world")
