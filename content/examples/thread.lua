...
-- if false then -- lurek.thread.newThread
...
-- if false then -- lurek.thread.newChannel
...
-- if false then -- lurek.thread.getChannel
...
-- if false then -- lurek.thread.newPool
...
-- if false then -- lurek.thread.async
...
-- if false then -- ThreadHandle:type
...
-- if false then -- ThreadHandle:typeOf
--   local t = lurek.thread.newThread("-- noop")
...
-- if false then -- ThreadHandle:start
...
-- if false then -- ThreadHandle:wait
...
-- if false then -- ThreadHandle:isRunning
...
-- if false then -- ThreadHandle:getError
...
-- if false then -- ThreadPool:typeOf
--   local pool = lurek.thread.newPool(2, "-- noop")
...
-- if false then -- ThreadPool:submit
--   local pool = lurek.thread.newPool(4, [[
--     local inp = lurek.thread.getChannel("__pool_input")
--     local out = lurek.thread.getChannel("__pool_output")
...
-- if false then -- ThreadPool:collect
...
-- if false then -- ThreadPool:getInputChannel
...
-- if false then -- ThreadPool:getOutputChannel
--   local pool = lurek.thread.newPool(4, "-- worker")
...
-- if false then -- Promise:getError
...
-- if false then -- Channel:getCount
--   local jobs = lurek.thread.getChannel("work_queue")
...
-- if false then -- Channel:pushTable
...
-- if false then -- Channel:popTable
--   local ch = lurek.thread.getChannel("packets")
...
-- if false then -- Channel:pushBytes
...
-- if false then -- Channel:popBytes
...
-- if false then -- LThread:isRunning
--   local t = lurek.thread.newThread([[
    -- minimal worker
--   ]])
...
-- if false then -- LThread:getError
--   local t = lurek.thread.newThread([[
