...
-- if false then -- lurek.patterns.newEventBus
...
-- if false then -- lurek.patterns.newObjectPool
...
-- if false then -- lurek.patterns.newCommandStack
...
-- if false then -- lurek.patterns.newServiceLocator
...
-- if false then -- lurek.patterns.newFactory
...
-- if false then -- lurek.patterns.newSimpleState
...
-- if false then -- lurek.patterns.newBlackboard
...
-- if false then -- lurek.patterns.newObserver
...
-- if false then -- lurek.patterns.newThrottle
...
-- if false then -- lurek.patterns.newDebounce
...
-- if false then -- lurek.patterns.newPriorityQueue
...
-- if false then -- lurek.patterns.newRing
...
-- if false then -- lurek.patterns.newFunnel
...
-- if false then -- lurek.patterns.newRelationshipManager
...
-- if false then -- lurek.patterns.newMediator
...
-- if false then -- lurek.patterns.newStrategy
...
-- if false then -- lurek.patterns.newStack
...
-- if false then -- lurek.patterns.newQueue
...
-- if false then -- lurek.patterns.newList
...
-- if false then -- lurek.patterns.newSet
...
-- if false then -- EventBus:clearAll
--   local bus = lurek.patterns.newEventBus()
...
-- if false then -- EventBus:getListenerCount
--   local bus = lurek.patterns.newEventBus()
...
-- if false then -- EventBus:getEvents
--   local bus = lurek.patterns.newEventBus()
...
-- if false then -- ObjectPool:acquire
--   local pool = lurek.patterns.newObjectPool()
--   pool:add({ x = 0, y = 0, vx = 0, vy = 0 })
...
-- if false then -- ObjectPool:release
--   local pool = lurek.patterns.newObjectPool()
...
-- if false then -- ObjectPool:getActiveCount
--   local pool = lurek.patterns.newObjectPool()
--   pool:add({}); pool:add({})
...
-- if false then -- ObjectPool:getAvailableCount
--   local pool = lurek.patterns.newObjectPool()
...
-- if false then -- ObjectPool:getTotalCount
--   local pool = lurek.patterns.newObjectPool()
...
-- if false then -- ObjectPool:clearAll
--   local pool = lurek.patterns.newObjectPool()
--   pool:add({}); pool:add({})
--   pool:clearAll()
...
-- if false then -- CommandStack:execute
...
-- if false then -- CommandStack:undo
--   local stack = lurek.patterns.newCommandStack(0)
--   local x = 5
...
-- if false then -- CommandStack:redo
--   local stack = lurek.patterns.newCommandStack(0)
--   local n = 0
...
-- if false then -- CommandStack:canUndo
--   local stack = lurek.patterns.newCommandStack(0)
...
-- if false then -- CommandStack:canRedo
--   local stack = lurek.patterns.newCommandStack(0)
--   stack:execute("noop", function() end, function() end)
--   stack:undo()
...
-- if false then -- CommandStack:getHistorySize
--   local stack = lurek.patterns.newCommandStack(0)
...
-- if false then -- CommandStack:getCurrentName
--   local stack = lurek.patterns.newCommandStack(0)
...
-- if false then -- CommandStack:clearAll
--   local stack = lurek.patterns.newCommandStack(0)
...
-- if false then -- ServiceLocator:provide
...
-- if false then -- ServiceLocator:locate
--   local sl = lurek.patterns.newServiceLocator()
...
-- if false then -- ServiceLocator:has
--   local sl = lurek.patterns.newServiceLocator()
...
-- if false then -- ServiceLocator:remove
--   local sl = lurek.patterns.newServiceLocator()
...
-- if false then -- ServiceLocator:getServices
--   local sl = lurek.patterns.newServiceLocator()
...
-- if false then -- ServiceLocator:clearAll
--   local sl = lurek.patterns.newServiceLocator()
...
-- if false then -- Factory:register
...
-- if false then -- Factory:getTypes
--   local f = lurek.patterns.newFactory()
...
-- if false then -- Factory:clearAll
--   local f = lurek.patterns.newFactory()
...
-- if false then -- SimpleState:addState
--   local sm = lurek.patterns.newSimpleState()
...
-- if false then -- SimpleState:transitionTo
--   local sm = lurek.patterns.newSimpleState()
--   sm:addState("menu", {})
...
-- if false then -- SimpleState:update
--   local sm = lurek.patterns.newSimpleState()
...
-- if false then -- SimpleState:getCurrent
--   local sm = lurek.patterns.newSimpleState()
--   sm:addState("paused", {})
...
-- if false then -- SimpleState:hasState
--   local sm = lurek.patterns.newSimpleState()
--   sm:addState("boss", {})
...
-- if false then -- SimpleState:getStates
--   local sm = lurek.patterns.newSimpleState()
...
-- if false then -- SimpleState:clearAll
--   local sm = lurek.patterns.newSimpleState()
--   sm:addState("x", {})
--   sm:clearAll()
...
-- if false then -- Blackboard:watch
--   local bb = lurek.patterns.newBlackboard()
...
-- if false then -- Blackboard:unwatch
--   local bb = lurek.patterns.newBlackboard()
...
-- if false then -- Blackboard:getRevision
--   local bb = lurek.patterns.newBlackboard()
...
-- if false then -- Blackboard:snapshot
--   local bb = lurek.patterns.newBlackboard()
...
-- if false then -- Blackboard:clearAll
--   local bb = lurek.patterns.newBlackboard()
--   bb:set("hp", 100)
--   bb:clearAll()
...
-- if false then -- Observer:subscribe
--   local o = lurek.patterns.newObserver()
...
-- if false then -- Observer:unsubscribe
--   local o = lurek.patterns.newObserver()
...
-- if false then -- Observer:getCount
--   local o = lurek.patterns.newObserver()
...
-- if false then -- Throttle:getProgress
...
-- if false then -- Throttle:getFireCount
...
-- if false then -- Throttle:setEnabled
--   local t = lurek.patterns.newThrottle(0.5)
...
-- if false then -- Debounce:trigger
...
-- if false then -- Debounce:isPending
...
-- if false then -- Debounce:getFireCount
...
-- if false then -- PriorityQueue:push
...
-- if false then -- PriorityQueue:pop
...
-- if false then -- PriorityQueue:peek
--   local pq = lurek.patterns.newPriorityQueue()
...
-- if false then -- PriorityQueue:len
--   local pq = lurek.patterns.newPriorityQueue()
...
-- if false then -- PriorityQueue:isEmpty
--   local pq = lurek.patterns.newPriorityQueue()
--   pq:push(1, "task")
...
-- if false then -- PriorityQueue:clearAll
--   local pq = lurek.patterns.newPriorityQueue()
...
-- if false then -- Funnel:pendingCount
...
-- if false then -- Funnel:getFlushCount
...
-- if false then -- RelationshipManager:defineType
...
-- if false then -- RelationshipManager:removeType
--   local rm = lurek.patterns.newRelationshipManager()
...
-- if false then -- RelationshipManager:typeNames
--   local rm = lurek.patterns.newRelationshipManager()
...
-- if false then -- RelationshipManager:setValue
--   local rm = lurek.patterns.newRelationshipManager()
...
-- if false then -- RelationshipManager:getValue
--   local rm = lurek.patterns.newRelationshipManager()
--   rm:setValue(1, 2, 50)
...
-- if false then -- RelationshipManager:adjustValue
--   local rm = lurek.patterns.newRelationshipManager()
--   rm:setValue(1, 2, 0)
...
-- if false then -- RelationshipManager:setLevel
--   local rm = lurek.patterns.newRelationshipManager()
--   rm:defineType("faction", { "hostile", "neutral", "ally" }, "neutral")
...
-- if false then -- RelationshipManager:getLevel
--   local rm = lurek.patterns.newRelationshipManager()
...
-- if false then -- RelationshipManager:removePair
--   local rm = lurek.patterns.newRelationshipManager()
--   rm:setValue(1, 2, 50)
--   rm:removePair(1, 2)
--   print("pairs=" .. rm:pairCount())
...
-- if false then -- RelationshipManager:pairCount
--   local rm = lurek.patterns.newRelationshipManager()
...
-- if false then -- Mediator:broadcast
--   local m = lurek.patterns.newMediator()
...
-- if false then -- Mediator:handlerCount
--   local m = lurek.patterns.newMediator()
...
-- if false then -- Mediator:channels
--   local m = lurek.patterns.newMediator()
...
-- if false then -- Mediator:removeChannel
--   local m = lurek.patterns.newMediator()
...
-- if false then -- Strategy:register
...
-- if false then -- Strategy:execute
--   local s = lurek.patterns.newStrategy()
...
-- if false then -- Strategy:getCurrent
--   local s = lurek.patterns.newStrategy()
...
-- if false then -- Set:intersection
