...
-- if false then -- lurek.scene.push
...
-- if false then -- lurek.scene.switchTo
...
-- if false then -- lurek.scene.clear
--   function lurek.quit()
--     lurek.scene.clear()
...
-- if false then -- lurek.scene.popTo
...
-- if false then -- lurek.scene.update
--   local sim_dt = 1 / 60
--   for _ = 1, 30 do
...
-- if false then -- lurek.scene.process
...
-- if false then -- lurek.scene.processPhysics
...
-- if false then -- lurek.scene.processLate
--   function lurek.process(dt)
...
-- if false then -- lurek.scene.draw
--   function lurek.draw()
--     lurek.scene.draw()
--   end
-- end
...
-- if false then -- lurek.scene.render
--   function lurek.draw()
--     lurek.scene.render()
--   end
-- end
...
-- if false then -- lurek.scene.renderUi
...
-- if false then -- lurek.scene.getStackSize
...
-- if false then -- lurek.scene.depth
...
-- if false then -- lurek.scene.isEmpty
...
-- if false then -- lurek.scene.getCurrent
...
-- if false then -- lurek.scene.isTransitioning
--   function lurek.process(_)
...
-- if false then -- lurek.scene.getTransitionProgress
--   function lurek.process(_)
...
-- if false then -- lurek.scene.registerScene
...
-- if false then -- lurek.scene.getRegistered
...
-- if false then -- lurek.scene.hasRegistered
...
-- if false then -- lurek.scene.unregisterScene
...
-- if false then -- lurek.scene.getRegisteredNames
...
-- if false then -- lurek.scene.setData
...
-- if false then -- lurek.scene.getData
...
-- if false then -- lurek.scene.hasData
...
-- if false then -- lurek.scene.removeData
...
-- if false then -- lurek.scene.newDepthSorter
...
-- if false then -- lurek.scene.newScene
...
-- if false then -- lurek.scene.define
...
-- if false then -- lurek.scene.getTransitionProgressEased
...
-- if false then -- lurek.scene.pushOverlay
...
-- if false then -- lurek.scene.isOverlay
...
-- if false then -- lurek.scene.getActiveScenes
...
-- if false then -- lurek.scene.preload
...
-- if false then -- lurek.scene.isPreloaded
...
-- if false then -- lurek.scene.pushPreloaded
...
-- if false then -- lurek.scene.getTransitionTypes
...
-- if false then -- lurek.scene.serializeScene
...
-- if false then -- lurek.scene.deserializeScene
...
-- if false then -- lurek.scene.fade
...
-- if false then -- lurek.scene.slide
...
-- if false then -- lurek.scene.wipe
...
-- if false then -- lurek.scene.iris
...
-- if false then -- DepthSorter:addObject
--   local sorter = lurek.scene.newDepthSorter()
...
-- if false then -- DepthSorter:sort
--   local sorter = lurek.scene.newDepthSorter()
...
-- if false then -- DepthSorter:flush
--   local sorter = lurek.scene.newDepthSorter()
--   function lurek.draw()
...
-- if false then -- DepthSorter:setStable
--   local sorter = lurek.scene.newDepthSorter()
--   sorter:setStable(true)
...
-- if false then -- DepthSorter:isStable
--   local sorter = lurek.scene.newDepthSorter()
...
-- if false then -- DepthSorter:clear
--   local sorter = lurek.scene.newDepthSorter()
...
-- if false then -- DepthSorter:getCount
--   local sorter = lurek.scene.newDepthSorter()
--   sorter:add(function() end, 0)
...
-- ---- Stub: LDepthSorter:type ---------------------------------------------
--@api-stub: LDepthSorter:type
-- Returns the type name of this object.
-- lDepthSorter_stub:type()  -- -> string
...
-- lDepthSorter_stub:typeOf("hero")  -- -> boolean
