...
-- â”€â”€ lurek.effect.* functions â”€â”€
...
-- if false then -- lurek.effect.newEffect
...
-- if false then -- lurek.effect.newCustomEffect
...
-- if false then -- lurek.effect.newStack
...
-- Presets are 'retro_tv', 'horror', 'dream', 'neon', 'sepia_age' â€” saves wiring up effects by hand.
-- if false then -- lurek.effect.newPresetStack
...
-- if false then -- lurek.effect.newPass
...
-- if false then -- lurek.effect.getEffectTypes
...
-- if false then -- lurek.effect.newImageEffect
...
-- if false then -- lurek.effect.newOverlay
...
-- if false then -- lurek.effect.newTransition
...
-- if false then -- lurek.effect.setShaderErrorDisplay
--   local in_dev = true
...
-- if false then -- lurek.effect.getShaderErrorDisplay
...
-- if false then -- PostFxEffect:getTypeName
...
-- Branch on the result before serialising â€” custom shader effects can't be persisted by name alone.
-- if false then -- PostFxEffect:isBuiltIn
...
-- if false then -- PostFxEffect:isEnabled
--   local bloom = lurek.effect.newEffect("bloom")
...
-- if false then -- PostFxEffect:setEnabled
...
-- if false then -- PostFxEffect:setParameter
--   local bloom = lurek.effect.newEffect("bloom")
...
-- if false then -- PostFxEffect:hasParameter
--   local eff = lurek.effect.newEffect("crt")
...
-- if false then -- PostFxEffect:getParameterNames
...
-- if false then -- PostFxEffect:getEffectType
...
-- if false then -- PostFxEffect:getType
...
-- if false then -- PostFxEffect:type
...
-- if false then -- PostFxEffect:typeOf
...
-- if false then -- PostFxEffect:setThreshold
--   local bloom = lurek.effect.newEffect("bloom")
...
-- if false then -- PostFxEffect:setIntensity
...
-- if false then -- PostFxEffect:setRadius
...
-- if false then -- PostFxEffect:setStrength
...
-- if false then -- PostFxEffect:setScanlineStrength
--   local crt = lurek.effect.newEffect("crt")
...
-- For chromatic aberration this shifts R/B channels in pixels; small values (1â€“4) are most pleasing.
-- if false then -- PostFxEffect:setOffset
...
-- if false then -- PostFxEffect:setBrightness
...
-- if false then -- PostFxEffect:setContrast
--   local grade = lurek.effect.newEffect("colourgrade")
...
-- if false then -- PostFxEffect:setSaturation
--   local grade = lurek.effect.newEffect("colourgrade")
...
-- if false then -- PostFxStack:remove
--   local stack = lurek.effect.newStack()
--   local crt = lurek.effect.newEffect("crt")
--   stack:add(crt)
...
-- if false then -- PostFxStack:isEnabled
--   local stack = lurek.effect.newStack()
--   stack:add(lurek.effect.newEffect("bloom"))
...
-- if false then -- PostFxStack:getEffectCount
--   local stack = lurek.effect.newStack()
--   stack:add(lurek.effect.newEffect("bloom"))
...
-- if false then -- PostFxStack:getEffect
--   local stack = lurek.effect.newStack()
--   stack:add(lurek.effect.newEffect("vignette"))
...
-- if false then -- PostFxStack:getEnabledEffects
--   local stack = lurek.effect.newStack()
--   stack:add(lurek.effect.newEffect("bloom"))
...
-- if false then -- PostFxStack:getWidth
...
-- if false then -- PostFxStack:getHeight
...
-- if false then -- PostFxStack:getDimensions
--   local stack = lurek.effect.newStack()
...
-- if false then -- PostFxStack:resize
...
-- if false then -- PostFxStack:isEmpty
--   local stack = lurek.effect.newStack()
...
-- if false then -- PostFxStack:clear
--   local stack = lurek.effect.newStack()
--   stack:add(lurek.effect.newEffect("crt"))
--   stack:clear()
...
-- if false then -- PostFxStack:dedup
--   local stack = lurek.effect.newStack()
--   local bloom = lurek.effect.newEffect("bloom")
...
-- if false then -- PostFxStack:isCapturing
--   local stack = lurek.effect.newStack()
--   function lurek.draw()
--     stack:beginCapture()
...
-- if false then -- PostFxStack:beginCapture
--   local stack = lurek.effect.newStack()
--   stack:add(lurek.effect.newEffect("bloom"))
--   function lurek.draw()
--     stack:beginCapture()
...
-- if false then -- PostFxStack:endCapture
--   local stack = lurek.effect.newStack()
--   function lurek.draw()
--     stack:beginCapture()
--     stack:endCapture()
...
-- if false then -- PostFxStack:apply
--   local stack = lurek.effect.newStack()
--   stack:add(lurek.effect.newEffect("bloom"))
--   function lurek.draw()
...
-- if false then -- PostFxStack:type
--   local stack = lurek.effect.newStack()
...
-- if false then -- PostFxStack:typeOf
--   local stack = lurek.effect.newStack()
...
-- if false then -- PostFxStack:setFeedback
--   local stack = lurek.effect.newStack()
...
-- if false then -- PostFxStack:getFeedback
--   local stack = lurek.effect.newStack()
...
-- if false then -- PostFxStack:clearFeedback
--   local stack = lurek.effect.newStack()
...
-- if false then -- ImageEffect:addEffect
--   local chain = lurek.effect.newImageEffect()
...
-- if false then -- ImageEffect:getEffect
...
-- if false then -- ImageEffect:removeEffect
...
-- if false then -- ImageEffect:clearEffects
...
-- if false then -- ImageEffect:clear
...
-- if false then -- ImageEffect:effectCount
--   local chain = lurek.effect.newImageEffect({{ type = "blur" }, { type = "vignette" }})
...
-- if false then -- ImageEffect:getEffectCount
...
-- Useful when one chain serves as a template â€” clone, then tweak the copy without affecting the original.
-- if false then -- ImageEffect:clone
...
-- if false then -- ImageEffect:save
--   local chain = lurek.effect.newImageEffect({{ type = "bloom" }})
--   if chain:save() then
...
-- if false then -- ImageEffect:type
--   local chain = lurek.effect.newImageEffect()
...
-- if false then -- ImageEffect:typeOf
--   local chain = lurek.effect.newImageEffect()
...
-- if false then -- ImageEffect:removeByIndex
...
-- if false then -- ImageEffect:removeByName
...
-- if false then -- Overlay:triggerLightning
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getShakeOffset
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isActive
--   local overlay = lurek.effect.newOverlay()
...
-- Resets shake/flash/fade/lightning to inactive â€” use when teleporting the player to a calm scene.
-- if false then -- Overlay:clear
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getWidth
...
-- if false then -- Overlay:getHeight
--   local overlay = lurek.effect.newOverlay(1024, 768)
...
-- if false then -- Overlay:getDimensions
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getFlashAlpha
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getLightningAlpha
--   local overlay = lurek.effect.newOverlay()
--   overlay:triggerLightning()
--   function lurek.process(dt)
--     overlay:update(dt)
...
-- if false then -- Overlay:setAmbientEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- Branch on it before reading getAmbientColor â€” the value is meaningless when ambient is off.
-- if false then -- Overlay:isAmbientEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getAmbientColor
--   local overlay = lurek.effect.newOverlay()
--   overlay:setAmbientEnabled(true)
...
-- Sets the simulated time-of-day (0Ă˘â‚¬â€ś24) which drives ambient colour.
-- Pass an hour 0..24 â€” 0 and 24 are midnight, 12 is noon; the overlay drives ambient colour from this.
-- if false then -- Overlay:setTimeOfDay
--   local overlay = lurek.effect.newOverlay()
--   overlay:setAmbientEnabled(true)
...
-- Returns the current simulated time-of-day (0Ă˘â‚¬â€ś24).
-- Read to drive game logic that depends on the in-world clock, e.g. NPC schedules.
-- if false then -- Overlay:getTimeOfDay
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setFogEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isFogEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setFogDensity
--   local overlay = lurek.effect.newOverlay()
--   overlay:setFogEnabled(true)
--   local target = 0.6
...
-- if false then -- Overlay:getFogDensity
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getFogColor
--   local overlay = lurek.effect.newOverlay()
--   overlay:setFogEnabled(true)
...
-- if false then -- Overlay:setHeatHazeEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isHeatHazeEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- Sets the heat-haze distortion intensity (0.0Ă˘â‚¬â€ś1.0).
-- Range is 0.0..1.0; tie to ambient temperature so the visual matches the simulation.
-- if false then -- Overlay:setHeatHazeIntensity
--   local overlay = lurek.effect.newOverlay()
--   overlay:setHeatHazeEnabled(true)
--   local temp_c = 42
...
-- if false then -- Overlay:getHeatHazeIntensity
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setVignetteEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isVignetteEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- Sets the vignette darkening strength (0.0Ă˘â‚¬â€ś1.0).
-- 0.0 is no darkening, 1.0 fully blacks out the corners; 0.3..0.6 reads as 'cinematic'.
-- if false then -- Overlay:setVignetteStrength
--   local overlay = lurek.effect.newOverlay()
--   overlay:setVignetteEnabled(true)
...
-- if false then -- Overlay:getVignetteStrength
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setFilmGrainEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isFilmGrainEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- Sets the film-grain noise intensity (0.0Ă˘â‚¬â€ś1.0).
-- Keep below 0.4 to avoid making text hard to read.
-- if false then -- Overlay:setFilmGrainIntensity
--   local overlay = lurek.effect.newOverlay()
--   overlay:setFilmGrainEnabled(true)
...
-- if false then -- Overlay:getFilmGrainIntensity
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setCloudShadows
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isCloudShadowsEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setCloudCount
--   local overlay = lurek.effect.newOverlay()
--   overlay:setCloudShadows(true)
...
-- if false then -- Overlay:getCloudCount
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setCloudSpeed
--   local overlay = lurek.effect.newOverlay()
--   overlay:setCloudShadows(true)
...
-- if false then -- Overlay:getCloudSpeed
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setCloudScale
--   local overlay = lurek.effect.newOverlay()
--   overlay:setCloudShadows(true)
...
-- if false then -- Overlay:getCloudScale
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setCloudOpacity
--   local overlay = lurek.effect.newOverlay()
--   overlay:setCloudShadows(true)
...
-- if false then -- Overlay:getCloudOpacity
--   local overlay = lurek.effect.newOverlay()
--   overlay:setCloudOpacity(0.4)
...
-- if false then -- Overlay:setWeatherEnabled
--   local overlay = lurek.effect.newOverlay()
--   overlay:setWeather("rain")
--   overlay:setWeatherEnabled(true)
-- end
...
-- if false then -- Overlay:isWeatherEnabled
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setWeather
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getWeather
--   local overlay = lurek.effect.newOverlay()
--   overlay:setWeather("rain")
...
-- Sets the particle spawn rate multiplier (0.0Ă˘â‚¬â€ś1.0).
-- Spawn-rate multiplier 0..1; 0 stops new particles, 1 is a downpour.
-- if false then -- Overlay:setWeatherIntensity
--   local overlay = lurek.effect.newOverlay()
--   overlay:setWeather("rain")
...
-- if false then -- Overlay:getWeatherIntensity
--   local overlay = lurek.effect.newOverlay()
...
-- Sets the wind direction in radians (0 = right, ÄŽâ‚¬/2 = down).
-- Radians: 0 right, Ď€/2 down, Ď€ left, 3Ď€/2 up; affects how weather particles travel.
-- if false then -- Overlay:setWindDirection
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getWindDirection
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setWindSpeed
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getWindSpeed
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getLightningColor
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isFlashing
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isShaking
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:isFading
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:drawToImage
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:setCustomShader
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- Overlay:getWater
--   local overlay = lurek.effect.newOverlay()
...
-- if false then -- PostFxEffect:enableAutoUniforms
...
-- if false then -- PostFxEffect:isAutoUniforms
--   local fx = lurek.effect.newCustomEffect(0)
--   fx:enableAutoUniforms()
...
-- if false then -- PostFxEffect:disableAutoUniforms
--   local fx = lurek.effect.newCustomEffect(0)
--   fx:enableAutoUniforms()
...
-- if false then -- PostFxEffect:getParameter
--   local stack = lurek.effect.newStack(800, 600)
--   stack:add(lurek.effect.newEffect("bloom"))
...
-- if false then -- PostFxStack:insert
--   local stack = lurek.effect.newStack(800, 600)
--   stack:add(lurek.effect.newEffect("crt"))
...
-- if false then -- Overlay:setAmbientColor
--   local overlay = lurek.effect.newOverlay(800, 600)
--   overlay:setAmbientEnabled(true)
...
-- if false then -- PostFxStack:setEnabled
--   local stack = lurek.effect.newStack(800, 600)
--   stack:add(lurek.effect.newEffect("bloom"))
...
-- if false then -- Overlay:setFogColor
--   local overlay = lurek.effect.newOverlay(800, 600)
--   overlay:setFogEnabled(true)
...
-- if false then -- Overlay:setLightningColor
--   local overlay = lurek.effect.newOverlay(800, 600)
...
-- if false then -- Overlay:setWater
--   local overlay = lurek.effect.newOverlay(800, 600)
...
-- if false then -- Overlay:setWaterTint
--   local overlay = lurek.effect.newOverlay(800, 600)
--   overlay:setWater(0.02, 12.0, 1.5)
...
-- if false then -- Overlay:triggerFade
--   local overlay = lurek.effect.newOverlay(800, 600)
...
-- if false then -- Overlay:triggerFlash
--   local overlay = lurek.effect.newOverlay(800, 600)
...
-- if false then -- Overlay:triggerShake
--   local overlay = lurek.effect.newOverlay(800, 600)
...
-- =============================================================================
-- STUBS: 147 uncovered lurek.effect API item(s)
...
-- if false then -- LScreenTransition:play
...
-- if false then -- LScreenTransition:reverse
--   local tr = lurek.effect.newTransition("fade", 0.5, {0, 0, 0, 1})
--   tr:reverse()
...
-- if false then -- LScreenTransition:update
--   local tr = lurek.effect.newTransition("fade", 0.5, {0, 0, 0, 1})
--   tr:play()
...
-- if false then -- LScreenTransition:progress
...
-- if false then -- LScreenTransition:isActive
...
-- if false then -- LScreenTransition:isDone
...
-- if false then -- LScreenTransition:kind
...
-- if false then -- LScreenTransition:color
...
-- if false then -- LScreenTransition:setColor
--   local tr = lurek.effect.newTransition("fade", 0.5, {0, 0, 0, 1})
...
-- if false then -- LScreenTransition:type
...
-- if false then -- LScreenTransition:typeOf
--   local screen_transition_obj = lurek.effect.newTransition(nil, nil, nil)
