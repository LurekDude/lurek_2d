...
-- â”€â”€ lurek.window.* functions â”€â”€
...
-- if false then -- lurek.window.setTitle
--   function lurek.init()
...
-- if false then -- lurek.window.getTitle
...
-- if false then -- lurek.window.getWidth
...
-- if false then -- lurek.window.getHeight
...
-- Prefer over two separate calls when you need both numbers â€” one borrow, two returns.
-- if false then -- lurek.window.getDimensions
...
-- if false then -- lurek.window.setFullscreen
--   function lurek.init()
...
-- if false then -- lurek.window.getFullscreen
...
-- if false then -- lurek.window.isOpen
...
-- if false then -- lurek.window.setVSync
...
-- if false then -- lurek.window.getVSync
...
-- if false then -- lurek.window.hasFocus
...
-- if false then -- lurek.window.hasMouseFocus
--   function lurek.process(dt)
...
-- if false then -- lurek.window.isMinimized
--   function lurek.draw()
...
-- if false then -- lurek.window.isMaximized
...
-- if false then -- lurek.window.isVisible
--   function lurek.draw()
...
-- if false then -- lurek.window.minimize
--   function lurek.process(dt)
...
-- Use as a "fit to screen" alternative to fullscreen â€” keeps the window chrome visible.
-- if false then -- lurek.window.maximize
--   function lurek.init()
...
-- if false then -- lurek.window.restore
--   function lurek.init()
...
-- if false then -- lurek.window.getPosition
--   function lurek.quit()
...
-- if false then -- lurek.window.setPosition
--   function lurek.init()
...
-- if false then -- lurek.window.getDisplayCount
...
-- if false then -- lurek.window.getDesktopDimensions
...
-- if false then -- lurek.window.getDPIScale
...
-- if false then -- lurek.window.toPixels
...
-- if false then -- lurek.window.fromPixels
...
-- if false then -- lurek.window.setIcon
--   function lurek.init()
...
-- if false then -- lurek.window.setMode
--   function lurek.init()
...
-- if false then -- lurek.window.getMode
...
-- if false then -- lurek.window.close
--   function lurek.process(dt)
...
-- if false then -- lurek.window.requestAttention
...
-- if false then -- lurek.window.getFullscreenModes
...
-- if false then -- lurek.window.getDisplayName
...
-- if false then -- lurek.window.getPixelDimensions
...
-- Blocks the main loop â€” use only for fatal errors at boot or destructive confirms ("Delete save?").
...
-- if false then -- lurek.window.focus
--   function lurek.init()
--     lurek.window.focus()
--   end
-- end
...
-- if false then -- lurek.window.getNativeDPIScale
...
-- if false then -- lurek.window.getDisplayOrientation
...
-- if false then -- lurek.window.getSafeArea
...
-- if false then -- lurek.window.getSystemTheme
...
-- if false then -- lurek.window.isHighDPIAllowed
...
-- if false then -- lurek.window.getScaleInfo
...
-- if false then -- lurek.window.getScaleMode
...
-- if false then -- lurek.window.setScaleMode
--   function lurek.init()
...
-- Use as the canonical render width â€” independent of the OS window size, stable across resizes.
-- if false then -- lurek.window.getGameWidth
...
-- if false then -- lurek.window.getGameHeight
...
-- if false then -- lurek.window.isFullscreen
...
-- if false then -- lurek.window.isResizable
...
-- if false then -- lurek.window.onDpiChange
--   function lurek.init()
...
-- if false then -- lurek.window.pollDpiChange
--   function lurek.process(dt)
...
-- if false then -- lurek.window.openFileDialog
...
-- Use to populate monitor selector UI with names and resolutions.
-- if false then -- lurek.window.getDisplays
...
-- Returns the current window display index.
-- Store with settings to restore monitor preference on next launch.
-- if false then -- lurek.window.getCurrentDisplay
--   local idx = lurek.window.getCurrentDisplay()
--   lurek.log.info("current monitor index: " .. idx, "video")
-- end

--@api-stub: lurek.window.setDisplay
-- Moves the window to another display by index.
-- Apply from options menu monitor selector.
-- if false then -- lurek.window.setDisplay
--   function lurek.init()
...
-- Use for turn-based notifications when the game is unfocused.
-- if false then -- lurek.window.flash
--   if not lurek.window.hasFocus() then
--     lurek.window.flash()
--   end
-- end
...
-- if false then -- lurek.window.display
...
-- if false then -- lurek.window.mode
...
-- if false then -- lurek.window.cursor
