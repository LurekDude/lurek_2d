...
-- if false then -- lurek.graph.newGraph
...
-- if false then -- GraphItem:getType
...
-- if false then -- GraphItem:setType
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- GraphItem:getDecayTime
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- GraphItem:setDecayTime
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- GraphItem:getRemainingLife
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- GraphItem:isAlive
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- GraphItem:getPriority
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- GraphItem:setPriority
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- GraphItem:getPosition
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- GraphItem:typeOf
--   local g = lurek.graph.newGraph()
--   local store = g:addNode("store", 16)
--   local ore = g:createItem("ore", 30.0)
--   g:addItem(ore, store)
...
-- if false then -- Edge:getCapacity
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:setCapacity
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:getThroughput
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:setThroughput
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:getTravelTime
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:setTravelTime
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:getSpeedModifier
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:setSpeedModifier
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:getCooldown
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:setCooldown
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:isOnCooldown
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:isBidirectional
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:setBidirectional
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:getItemsInTransit
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:addAllowedType
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:removeAllowedType
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:clearAllowedTypes
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Edge:isItemTypeAllowed
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("source")
--   local b = g:addNode("sink")
--   local belt = g:addEdge(a, b, "conveyor")
...
-- if false then -- Node:getCapacity
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setCapacity
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:getItemCount
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:getOverflowPolicy
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setOverflowPolicy
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:getFlowMode
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setFlowMode
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:getPushRate
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setPushRate
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:getPullRate
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setPullRate
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:getPushFilter
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setPushFilter
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:getPullFilter
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setPullFilter
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
--   depot:setPullFilter("coal")
-- end
...
-- if false then -- Node:getProcessTime
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setProcessTime
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:isQueueEnabled
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:setQueueEnabled
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
--   depot:setQueueEnabled(true)
-- end
...
-- if false then -- Node:getQueueCapacity
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
--   depot:setQueueEnabled(true)
...
-- if false then -- Node:setQueueCapacity
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
--   depot:setQueueEnabled(true)
...
-- if false then -- Node:getQueueSize
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
--   depot:setQueueEnabled(true)
...
-- if false then -- Node:clearConversion
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:clearAllConversions
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
--   depot:setConversion("ore", "iron_ingot", 2, 1)
...
-- if false then -- Node:removeSupply
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:clearSupplies
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
--   depot:addSupply("ore", 100)
...
-- if false then -- Node:removeDemand
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Node:clearDemands
--   local g = lurek.graph.newGraph()
--   local depot = g:addNode("depot", 16)
...
-- if false then -- Graph:removeNode
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:getNodeCount
--   local g = lurek.graph.newGraph()
--   g:addNode("start")
--   g:addNode("end")
...
-- if false then -- Graph:removeEdge
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:getEdgeCount
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:removeItem
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:getItemCount
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:tickParallel
--   local g = lurek.graph.newGraph()
--   function lurek.process(dt)
--     g:tickParallel(dt)
--   end
...
-- if false then -- Graph:getNeighbors
--   local g = lurek.graph.newGraph()
--   local a = g:addNode("a")
...
-- if false then -- Graph:getComponents
--   local g = lurek.graph.newGraph()
--   g:addNode("island_a")
--   g:addNode("island_b")
...
-- if false then -- Graph:topologicalSort
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:colorGraph
--   local g = lurek.graph.newGraph()
--   local a, b = g:addNode("a"), g:addNode("b")
--   g:addEdge(a, b)
...
-- if false then -- Graph:isBipartite
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:processDemand
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:createItem
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:findPathForItem
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:getDistance
--   local g = lurek.graph.newGraph()
...
-- if false then -- Graph:getEdgeBetween
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("A") ; local nb = g:addNode("B")
--   g:addEdge(na, nb)
...
-- if false then -- Graph:getReachable
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("A") ; local nb = g:addNode("B") ; local nc = g:addNode("C")
--   g:addEdge(na, nb) ; g:addEdge(nb, nc)
...
-- if false then -- Node:setConversion
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphEdge:getType
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphEdge:setType
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
...
-- if false then -- LGraphEdge:getFrom
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphEdge:getTo
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("source", 8); local nb = g:addNode("sink", 8)
--   local edge = g:addEdge(na, nb, "pipe")
--   local to = edge:getTo()
...
-- if false then -- LGraphEdge:getCapacity
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
--   edge:setCapacity(50)
...
-- if false then -- LGraphEdge:setCapacity
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
...
-- if false then -- LGraphEdge:getThroughput
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
...
-- if false then -- LGraphEdge:setThroughput
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
...
-- if false then -- LGraphEdge:getTravelTime
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
...
-- if false then -- LGraphEdge:setTravelTime
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "road")
...
-- if false then -- LGraphEdge:getWeight
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "road")
--   edge:setWeight(1.5)
...
-- if false then -- LGraphEdge:setWeight
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "road")
--   edge:setWeight(5.0)
...
-- if false then -- LGraphEdge:getSpeedModifier
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
...
-- if false then -- LGraphEdge:setSpeedModifier
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
...
-- if false then -- LGraphEdge:getCooldown
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
...
-- if false then -- LGraphEdge:setCooldown
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
...
-- if false then -- LGraphEdge:isOnCooldown
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
...
-- if false then -- LGraphEdge:isBidirectional
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "road")
...
-- if false then -- LGraphEdge:setBidirectional
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "road")
...
-- if false then -- LGraphEdge:isActive
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
...
-- if false then -- LGraphEdge:setActive
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
...
-- if false then -- LGraphEdge:getItemsInTransit
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
...
-- if false then -- LGraphEdge:addAllowedType
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "pipe")
...
-- if false then -- LGraphEdge:removeAllowedType
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "pipe")
...
-- if false then -- LGraphEdge:clearAllowedTypes
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
...
-- if false then -- LGraphEdge:isItemTypeAllowed
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "pipe")
...
-- if false then -- LGraphEdge:typeOf
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
--   local edge = g:addEdge(na, nb, "belt")
...
-- if false then -- LGraphNode:getType
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setType
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("furnace", 16)
...
-- if false then -- LGraphNode:getCapacity
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setCapacity
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:getItemCount
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:isFull
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:isActive
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setActive
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("reactor", 8)
--   n:setActive(false)
--   lurek.log.info("active=" .. tostring(n:isActive()), "graph")
...
-- if false then -- LGraphNode:getOverflowPolicy
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setOverflowPolicy
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("silo", 50)
...
-- if false then -- LGraphNode:getFlowMode
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setFlowMode
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:getPushRate
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setPushRate
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("mine", 32)
--   n:setPushRate(5.0)
--   lurek.log.info("push_rate=" .. n:getPushRate(), "graph")
...
-- if false then -- LGraphNode:getPullRate
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("furnace", 16)
--   n:setPullRate(3.0)
...
-- if false then -- LGraphNode:setPullRate
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:getPushFilter
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setPushFilter
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("sorter", 8)
...
-- if false then -- LGraphNode:getPullFilter
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("furnace", 16)
...
-- if false then -- LGraphNode:setPullFilter
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("furnace", 16)
...
-- if false then -- LGraphNode:getProcessTime
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setProcessTime
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("assembler", 8)
...
-- if false then -- LGraphNode:isQueueEnabled
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:setQueueEnabled
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:getQueueCapacity
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("buffer", 32)
...
-- if false then -- LGraphNode:setQueueCapacity
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("buffer", 32)
...
-- if false then -- LGraphNode:getQueueSize
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("depot", 32)
--   n:setQueueEnabled(true)
...
-- if false then -- LGraphNode:getItems
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("depot", 32)
...
-- if false then -- LGraphNode:getEdges
--   local g = lurek.graph.newGraph()
--   local na = g:addNode("a", 8); local nb = g:addNode("b", 8)
...
-- if false then -- LGraphNode:setConversion
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("furnace", 16)
...
-- if false then -- LGraphNode:clearConversion
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("furnace", 16)
--   n:setConversion("iron_ore", "iron_ingot", 1)
...
-- if false then -- LGraphNode:clearAllConversions
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:addTag
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("warehouse", 100)
...
-- if false then -- LGraphNode:removeTag
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("depot", 32)
...
-- if false then -- LGraphNode:hasTag
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:clearTags
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("depot", 32)
...
-- if false then -- LGraphNode:getTags
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("depot", 32)
...
-- if false then -- LGraphNode:addSupply
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:removeSupply
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("mine", 100)
--   n:addSupply("iron_ore", 500)
...
-- if false then -- LGraphNode:clearSupplies
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("mine", 100)
...
-- if false then -- LGraphNode:addDemand
--   local g = lurek.graph.newGraph()
...
-- if false then -- LGraphNode:removeDemand
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("factory", 32)
...
-- if false then -- LGraphNode:clearDemands
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("factory", 32)
...
-- if false then -- LGraphNode:enqueue
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("buffer", 32)
--   n:setQueueEnabled(true)
...
-- if false then -- LGraphNode:dequeue
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("buffer", 32)
--   n:setQueueEnabled(true)
...
-- Returns true when the given name matches "GraphNode" or a parent type.
-- Use to check instance types in polymorphic collections.
-- if false then -- LGraphNode:typeOf
--   local g = lurek.graph.newGraph()
--   local n = g:addNode("depot", 8)
