...
-- Mounts a directory at a virtual path inside the game filesystem.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
lurek.filesystem.mount(src, mp)  -- -> boolean
...
-- Returns lightweight file statistics for the given path.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
lurek.filesystem.stat("assets/hero.png")  -- -> table
...
-- Returns true if this object is of the given type.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lFileData_stub:typeOf("hero")  -- -> boolean
-- (replace lFileData_stub with your real LFileData instance above)
...
-- Returns true if this object is of the given type.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lFileHandle_stub:typeOf("hero")  -- -> boolean
-- (replace lFileHandle_stub with your real LFileHandle instance above)
...
-- Returns the type name of this object.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lZipMount_stub:type()  -- -> string
-- (replace lZipMount_stub with your real LZipMount instance above)

-- ---- Stub: LZipMount:typeOf ----------------------------------------------
--@api-stub: LZipMount:typeOf
-- Returns true if this object is of the given type.
-- TODO: replace this stub with a real scenario. See flesh-out-example.prompt.md
-- lZipMount_stub:typeOf("hero")  -- -> boolean
-- (replace lZipMount_stub with your real LZipMount instance above)

-- =============================================================================
-- STUBS: 17 uncovered lurek.filesystem API item(s)
-- Generated by tools/audit/example_add_missing.py
-- REQUIRED: replace every --@api-stub: block below with a real scenario.
-- Run .github/prompts/flesh-out-example.prompt.md for instructions.
-- The final committed file must contain ZERO --@api-stub: lines.
