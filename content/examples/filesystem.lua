...
-- pcall() is used throughout to construct file handles; when load fails
...
-- Writes validated JSON text to a file in save/.
-- Useful for small script state files where you want schema-less structured data.
...
-- Reads JSON text and validates that it is valid JSON before returning.
-- Pair with your own decoder or pass through to other systems.
...
-- Reads JSON from path, or writes a default JSON payload when the file does not exist.
-- Handy for bootstrapping script-local config files.
...
-- =============================================================================
-- COVERAGE: 9 uncovered lurek.filesystem API item(s)
...
-- ---- Example: lurek.filesystem.mount ----------------------------------------
--@api-stub: lurek.filesystem.mount
-- Mounts a directory at a virtual path inside the game filesystem.
do -- lurek.filesystem.mount
...
-- ---- Example: lurek.filesystem.listRecursive --------------------------------
--@api-stub: lurek.filesystem.listRecursive
-- Returns a sorted list of all files under `path`, recursively.
do -- lurek.filesystem.listRecursive
...
-- =============================================================================
-- COVERAGE: 2 uncovered lurek.filesystem API item(s)
-- Generated by tools/audit/example_add_missing.py
-- REQUIRED: replace every --@api-stub: block below with a real scenario.
-- Run .github/prompts/flesh-out-example.prompt.md for instructions.
-- The final committed file must contain ZERO --@api-stub: lines.
...
-- ---- Example: lurek.filesystem.readBytes ------------------------------------
...
-- ---- Example: lurek.filesystem.writeBytes -----------------------------------
