...
-- if false then -- lurek.terminal.newTerminal
...
-- if false then -- lurek.terminal.newLabel
...
-- if false then -- lurek.terminal.newButton
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.newTextBox
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.newList
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.newBorder
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.newPanel
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.pushScrollback
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.getScrollback
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.scrollbackLen
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.setScrollbackCap
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.pushCmdHistory
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.prevCmd
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.nextCmd
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.cmdHistoryLen
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.clearCmdHistory
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.applyTheme
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.printHighlighted
--   local term = lurek.terminal.newTerminal(80, 25)
--   local rules = {
...
-- if false then -- lurek.terminal.stripAnsi
...
-- if false then -- lurek.terminal.parseAnsi
...
-- if false then -- lurek.terminal.printAnsi
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- lurek.terminal.addCompletion
...
-- if false then -- lurek.terminal.removeCompletion
...
-- if false then -- lurek.terminal.clearCompletions
...
-- if false then -- lurek.terminal.getCompletions
...
-- if false then -- lurek.terminal.nextCompletion
...
-- if false then -- lurek.terminal.resetCompletion
...
-- if false then -- lurek.terminal.getMaxCols
...
-- if false then -- lurek.terminal.getMaxRows
...
-- if false then -- Terminal:getDimensions
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:addWidget
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:removeWidget
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:clearWidgets
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:getWidgetCount
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:setFocus
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:getFocused
--   local term = lurek.terminal.newTerminal(80, 25)
--   local input = lurek.terminal.newTextBox(2, 24, 60)
--   term:addWidget(input)
--   term:setFocus(input)
...
-- if false then -- Terminal:keypressed
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:textinput
--   local term = lurek.terminal.newTerminal(80, 25)
--   local input = lurek.terminal.newTextBox(2, 24, 60)
--   term:addWidget(input)
--   term:setFocus(input)
...
-- if false then -- Terminal:setFont
--   local term = lurek.terminal.newTerminal(80, 25)
--   term:setFont(24)
-- end
...
-- if false then -- Terminal:setCellSize
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:resetCellSize
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:getCellSize
--   local term = lurek.terminal.newTerminal(80, 25)
...
-- if false then -- Terminal:autoResize
--   local term = lurek.terminal.newTerminal(80, 25)
--   term:setFont(20)
--   term:autoResize()
-- end
...
-- if false then -- Widget:setPosition
...
-- if false then -- Widget:getPosition
...
-- if false then -- Widget:setVisible
...
-- if false then -- Widget:isVisible
--   local hint = lurek.terminal.newLabel(2, 2, "[E] interact")
--   hint:setVisible(false)
...
-- if false then -- Widget:setEnabled
...
-- if false then -- Widget:isEnabled
...
-- if false then -- Widget:setOnClick
...
-- if false then -- Widget:setMaxLength
...
-- if false then -- Widget:getMaxLength
--   local name_box = lurek.terminal.newTextBox(2, 5, 24)
--   name_box:setMaxLength(16)
...
-- if false then -- Widget:setOnChange
...
-- if false then -- Widget:removeItem
--   local inv = lurek.terminal.newList(2, 3, 30, 8)
...
-- if false then -- Widget:clearItems
--   local inv = lurek.terminal.newList(2, 3, 30, 8)
--   inv:addItem("stale")
--   inv:clearItems()
--   inv:addItem("fresh")
...
-- if false then -- Widget:getItemCount
--   local inv = lurek.terminal.newList(2, 3, 30, 8)
...
-- if false then -- Widget:setSelected
...
-- if false then -- Widget:getSelected
--   local saves = lurek.terminal.newList(2, 3, 30, 8)
--   saves:addItem("Slot 1")
--   saves:setSelected(1)
...
-- if false then -- Widget:setOnSelect
--   local saves = lurek.terminal.newList(2, 3, 30, 8)
--   saves:addItem("Slot 1")
...
-- if false then -- Widget:removeChild
--   local panel = lurek.terminal.newPanel(2, 2, 30, 10)
...
-- if false then -- Widget:clearChildren
--   local panel = lurek.terminal.newPanel(2, 2, 30, 10)
...
-- if false then -- Widget:getChildCount
--   local panel = lurek.terminal.newPanel(2, 2, 30, 10)
...
-- if false then -- Terminal:mousepressed
...
-- =============================================================================
-- STUBS: 4 uncovered lurek.terminal API item(s)
...
-- if false then -- LTerminal:typeOf
