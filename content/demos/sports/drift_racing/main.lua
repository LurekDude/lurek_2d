...
-- Run with: cargo run -- content/demos/sports/drift_racing
...
function lurek.process(dt)
    ...
    if lurek.keyboard.isDown("w") or lurek.keyboard.isDown("up") then accel = 1 end
    if lurek.keyboard.isDown("s") or lurek.keyboard.isDown("down") then brake = 1 end
    if lurek.keyboard.isDown("a") or lurek.keyboard.isDown("left") then steer = -1 end
    if lurek.keyboard.isDown("d") or lurek.keyboard.isDown("right") then steer = 1 end
