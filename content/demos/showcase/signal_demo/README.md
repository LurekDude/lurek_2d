...
Demonstrates the pub-sub `luna.signal.newSignal()` system for decoupled event-driven communication between game systems.

## What It Demonstrates

- `luna.signal.newSignal()` — create a typed signal bus
