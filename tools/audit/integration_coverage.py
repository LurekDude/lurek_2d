...
MODULE_PATTERNS = {
    "math": r"lurek\.math\.",
    "physics": r"lurek\.physics\.",
    "render": r"lurek\.render\.",
    "audio": r"lurek\.audio\.",
    "input": r"lurek\.input\.",
    "keyboard": r"lurek\.keyboard\.",
    "mouse": r"lurek\.mouse\.",
    "timer": r"lurek\.time\.",
    "filesystem": r"lurek\.fs\.",
    "window": r"lurek\.window\.",
    "system": r"lurek\.system\.",
    "event": r"lurek\.signal\.",
    "data": r"lurek\.data\.",
    "particle": r"lurek\.particles\.",
    "tilemap": r"lurek\.tilemap\.",
    "compute": r"lurek\.compute\.",
    "dataframe": r"lurek\.dataframe\.",
    "ai": r"lurek\.ai\.",
    "graph": r"lurek\.graph\.",
    "audio_src": r"lurek\.sound\.",
    "image": r"lurek\.img\.",
}
