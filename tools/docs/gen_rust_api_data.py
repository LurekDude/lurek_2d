#!/usr/bin/env python3
"""
gen_rust_api_data.py — Generate Luna2D master API data file.
...
Usage:
    python tools/gen_rust_api_data.py                  # -> docs/API/rust_api_data.json
...
OUTPUT_FILE = WORKSPACE_ROOT / "docs" / "API" / "rust_api_data.json"
...
def main() -> int:
    ...
    parser.add_argument(
        "--output", default=str(OUTPUT_FILE), help="Output JSON path (default: docs/API/rust_api_data.json)"
    )
