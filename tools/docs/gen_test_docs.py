...
Usage:
    python tools/gen_test_docs.py                          # docs/API/test_docs.md (all)
    python tools/gen_test_docs.py --mode rust              # docs/API/test_docs_rust.md
    python tools/gen_test_docs.py --mode lua               # docs/API/test_docs_lua.md
...
DEFAULT_OUTPUT_RUST = WORKSPACE_ROOT / "docs" / "API" / "test_docs_rust.md"
DEFAULT_OUTPUT_LUA = WORKSPACE_ROOT / "docs" / "API" / "test_docs_lua.md"
...
def _generate_lua_section(data: dict) -> list[str]:
    ...
    lines.append("2. Ensure every `luna.*` function has at least one test")
...
def generate_markdown(data: dict, fn_docs: dict[str, dict[str, str]], mode: str = "all") -> str:
    ...
    if mode == "rust":
        lines.append("# Luna2D Rust Test Documentation")
        lines.append("")
        ...
        lines.append("# Luna2D Lua API Test Documentation")
        lines.append("")
