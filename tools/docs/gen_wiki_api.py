#!/usr/bin/env python3
"""
gen_wiki_api.py — Generate wiki/API-Reference.md from docs/API/lua_api_data.json.
...
def generate_wiki(data: dict) -> str:
    ...
    out.append(">")
    out.append(f"> Auto-generated by `tools/gen_wiki_api.py` from `docs/API/lua_api_data.json`.")
    ...
    out.append("")
    out.append(
        f"*Auto-generated from `docs/API/lua_api_data.json` by `tools/gen_wiki_api.py`. "
