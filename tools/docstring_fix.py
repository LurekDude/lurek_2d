...
Reads docs/API/docstring_audit.json (produced by docstring_audit.py) and patches
...
Usage:
    python tools/docstring_fix.py                  # use docs/API/docstring_audit.json
...
AUDIT_JSON = WORKSPACE_ROOT / "docs" / "API" / "docstring_audit.json"
