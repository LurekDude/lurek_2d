...
- [ ] **R-02** — Dependency direction: json: Foundations imports runtime(Core Runtime)
...
|-------|---------|---------|
| **S-01** lib.rs registration | ✅ PASS | Registered in lib.rs + lua_api (serial_api) |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **B-01** Dedicated API file | ✅ PASS | lua_api/serial_api.rs present |
...
| **R-02** Dependency direction | ❌ ERROR | json: Foundations imports runtime(Core Runtime) |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **T-01** Rust test file | ✅ PASS | Found: tests\rust\unit\serial_tests.rs |
| **T-02** Lua test file | ✅ PASS | tests/lua/unit/test_serial.lua registered in harness |
| **T-03** Test naming | ⚠️ WARNING | test_ prefix found — use <subject>_<scenario>_<expected>: test_lua_serial_fromjson_basic, test_lua_serial_tojson_basic, test_lua_serial_fromtoml_basic, test_lua_serial_totoml_basic, test_lua_serial_fromjson_error |
| **T-04** Float comparisons | ✅ PASS | No float assert_eq! found |
| **T-05** Test adequacy | ✅ PASS | No pub methods counted — skip |
| **T-06** Golden tests | 🔵 MANUAL | Check if module qualifies for golden/snapshot tests |
| **T-07** Tests pass | 🔵 MANUAL | Run: cargo test --test serial_tests -- --nocapture |
...
| **W-05** Wiki page | ✅ PASS | docs\wiki\Serial-API.md |
...
```powershell
python tools/audit/audit_module.py serial --docs-quality
```
