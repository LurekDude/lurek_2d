...
- [ ] **B-04** — No business logic in closures: '<closure@1053>' (28 LOC, line 1053) — extract body to src/audio/ | '<closure@1091>' (17 LOC, line 1091) — extract body to src/audio/ | '<closure@1497>' (16 LOC, line 1497) — extract body to src/audio/ | '<closure@2196>' (20 LOC, line 2196) — extract body to src/audio/ | '<closure@1381>' has if/match/for — extract to src/audio/ | '<closure@1401>' has if/match/for — extract to src/audio/
...
| **B-04** No business logic in closures | ⚠️ WARNING | '<closure@1053>' (28 LOC, line 1053) — extract body to src/audio/ \| '<closure@1091>' (17 LOC, line 1091) — extract body to src/audio/ \| '<closure@1497>' (16 LOC, line 1497) — extract body to src/audio/ \| '<closure@2196>' (20 LOC, line 2196) — extract body to src/audio/ \| '<closure@1381>' has if/match/for — extract to src/audio/ \| '<closure@1401>' has if/match/for — extract to src/audio/ |
...
```powershell
python tools/audit/audit_module.py audio --docs-quality
```
