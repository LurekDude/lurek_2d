...
- [ ] **B-02** — Registration-only: extra pub fn (move to src/automation/): vec_from_lua_table

### 🟡 Warnings — Should Fix

- [ ] **B-04** — No business logic in closures: '<closure@29>' has if/match/for — extract to src/automation/
...
| **B-02** Registration-only | ❌ ERROR | extra pub fn (move to src/automation/): vec_from_lua_table |
| **B-03** impl LuaUserData placement | ✅ PASS | All impl LuaUserData blocks are in lua_api (correct) |
| **B-04** No business logic in closures | ⚠️ WARNING | '<closure@29>' has if/match/for — extract to src/automation/ |
...
| **T-05** Test adequacy | ✅ PASS | 55 tests / 25 pub methods (220%) |
...
| **W-04** Example–spec sync | ✅ PASS | All 17 functions consistent across spec and example |
