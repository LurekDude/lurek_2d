# Module Quality Report: `i18n`

> **Status**: 🔴 FAIL  |  **Date**: 2026-04-12  |  **Score**: 32 ✅ / 5 ⚠️ / 4 ❌ / 19 🔵
...
- [ ] **T-01** — Rust test file: No test file found for module 'i18n'
- [ ] **T-02** — Lua test file: Module has Lua API but no tests/lua/unit/test_i18n.lua
- [ ] **W-01** — Example file exists: content/examples/i18n.lua not found — create it
...
- [ ] **B-04** — No business logic in closures: '<closure@104>' (16 LOC, line 104) — extract body to src/i18n/ | '<closure@179>' (29 LOC, line 179) — extract body to src/i18n/ | '<closure@404>' (35 LOC, line 404) — extract body to src/i18n/ | '<closure@124>' has if/match/for — extract to src/i18n/ | '<closure@136>' has if/match/for — extract to src/i18n/
- [ ] **T-05** — Test adequacy: 21 pub methods, 0 Rust tests — create test file
- [ ] **W-05** — Wiki page: No wiki page found (expected docs/wiki/I18N-API.md)
...
|-------|---------|---------|
| **S-01** lib.rs registration | ✅ PASS | Registered in lib.rs + lua_api (i18n_api) |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **SP-01** Spec file exists | ✅ PASS | docs/specs/i18n.md exists |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **B-01** Dedicated API file | ✅ PASS | lua_api/i18n_api.rs present |
...
| **B-04** No business logic in closures | ⚠️ WARNING | '<closure@104>' (16 LOC, line 104) — extract body to src/i18n/ \| '<closure@179>' (29 LOC, line 179) — extract body to src/i18n/ \| '<closure@404>' (35 LOC, line 404) — extract body to src/i18n/ \| '<closure@124>' has if/match/for — extract to src/i18n/ \| '<closure@136>' has if/match/for — extract to src/i18n/ |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **T-01** Rust test file | ❌ ERROR | No test file found for module 'i18n' |
| **T-02** Lua test file | ❌ ERROR | Module has Lua API but no tests/lua/unit/test_i18n.lua |
| **T-03** Test naming | ✅ PASS | No Rust test file — skip |
| **T-04** Float comparisons | ✅ PASS | No Rust test file — skip |
| **T-05** Test adequacy | ⚠️ WARNING | 21 pub methods, 0 Rust tests — create test file |
| **T-06** Golden tests | 🔵 MANUAL | Check if module qualifies for golden/snapshot tests |
| **T-07** Tests pass | 🔵 MANUAL | Run: cargo test --test i18n_tests -- --nocapture |

### Phase 8 — Documentation & Wiki

| Check | Verdict | Details |
|-------|---------|---------|
| **W-01** Example file exists | ❌ ERROR | content/examples/i18n.lua not found — create it |
| **W-02** API surface coverage | ❌ ERROR | Skipped — no example file |
| **W-03** Example comments | 🔵 MANUAL | Verify content/examples/i18n.lua has realistic one-line comments per call |
| **W-04** Example–spec sync | ✅ PASS | Missing spec or example — other checks cover this |
| **W-05** Wiki page | ⚠️ WARNING | No wiki page found (expected docs/wiki/I18N-API.md) |
...
```powershell
python tools/audit/audit_module.py i18n --docs-quality
```
