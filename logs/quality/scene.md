...
- [ ] **B-04** — No business logic in closures: '<closure@221>' (24 LOC, line 221) — extract body to src/scene/ | '<closure@323>' (21 LOC, line 323) — extract body to src/scene/ | '<closure@302>' has if/match/for — extract to src/scene/ | '<closure@354>' has if/match/for — extract to src/scene/
...
| **B-04** No business logic in closures | ⚠️ WARNING | '<closure@221>' (24 LOC, line 221) — extract body to src/scene/ \| '<closure@323>' (21 LOC, line 323) — extract body to src/scene/ \| '<closure@302>' has if/match/for — extract to src/scene/ \| '<closure@354>' has if/match/for — extract to src/scene/ |
...
| **T-05** Test adequacy | ✅ PASS | 36 tests / 38 pub methods (95%) |
...
| **W-04** Example–spec sync | ✅ PASS | All 29 functions consistent across spec and example |
