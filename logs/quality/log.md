...
> **Status**: 🔴 FAIL  |  **Date**: 2026-04-12  |  **Score**: 39 ✅ / 1 ⚠️ / 1 ❌ / 19 🔵
...
- [ ] **R-02** — Dependency direction: mod: Foundations imports runtime(Core Runtime)

### 🟡 Warnings — Should Fix

- [ ] **B-04** — No business logic in closures: '<closure@128>' (19 LOC, line 128) — extract body to src/log/ | '<closure@190>' (20 LOC, line 190) — extract body to src/log/ | '<closure@89>' has if/match/for — extract to src/log/ | '<closure@170>' has if/match/for — extract to src/log/
...
| **B-04** No business logic in closures | ⚠️ WARNING | '<closure@128>' (19 LOC, line 128) — extract body to src/log/ \| '<closure@190>' (20 LOC, line 190) — extract body to src/log/ \| '<closure@89>' has if/match/for — extract to src/log/ \| '<closure@170>' has if/match/for — extract to src/log/ |
...
| **R-02** Dependency direction | ❌ ERROR | mod: Foundations imports runtime(Core Runtime) |
