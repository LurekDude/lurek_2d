...
- [ ] **T-05** — Test adequacy: 10 tests / 56 pub methods (18%) — low coverage
- [ ] **Q-04** — Error handling: .unwrap() calls: dda:979, doors:203, render:245, segment:101, visibility:39 (+1 more)
...
|-------|---------|---------|
| **S-01** lib.rs registration | ✅ PASS | Registered in lib.rs + lua_api (raycaster_api) |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **T-01** Rust test file | ✅ PASS | Found: tests\rust\unit\raycaster_tests.rs |
...
| **T-05** Test adequacy | ⚠️ WARNING | 10 tests / 56 pub methods (18%) — low coverage |
...
| **W-05** Wiki page | ✅ PASS | docs\wiki\Raycaster-API.md |
...
| **Q-04** Error handling | ⚠️ WARNING | .unwrap() calls: dda:979, doors:203, render:245, segment:101, visibility:39 (+1 more) |
...
```powershell
python tools/audit/audit_module.py raycaster --docs-quality
```
