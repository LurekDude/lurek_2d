...
| Check | Verdict | Details |
|-------|---------|---------|
| **T-01** Rust test file | ❌ ERROR | No test file found for module 'parallax' |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **W-01** Example file exists | ❌ ERROR | content/examples/parallax.lua not found — create it |
| **W-02** API surface coverage | ❌ ERROR | Skipped — no example file |
| **W-03** Example comments | 🔵 MANUAL | Verify content/examples/parallax.lua has realistic one-line comments per call |
| **W-04** Example–spec sync | ✅ PASS | Missing spec or example — other checks cover this |
| **W-05** Wiki page | ⚠️ WARNING | No wiki page found (expected docs/wiki/Parallax-API.md) |
...
| **Q-04** Error handling | ⚠️ WARNING | .unwrap() calls: layer:361, layer:371, layer:380, layer:401 |
...
```powershell
python tools/audit/audit_module.py parallax --docs-quality
```
