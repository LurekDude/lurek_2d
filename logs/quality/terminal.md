...
> **Status**: 🟢 PASS  |  **Date**: 2026-04-12  |  **Score**: 41 ✅ / 0 ⚠️ / 0 ❌ / 19 🔵
...
|-------|---------|---------|
| **S-01** lib.rs registration | ✅ PASS | Registered in lib.rs + lua_api (terminal_api) |
...
| **T-05** Test adequacy | ✅ PASS | 44 tests / 63 pub methods (70%) |
...
```powershell
python tools/audit/audit_module.py terminal --docs-quality
```
