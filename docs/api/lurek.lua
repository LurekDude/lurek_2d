...
---@param default boolean|nil Fallback value when the key is missing.
...
---@param key string Blackboard entry name.
---@param default number|nil Fallback value when the key is missing.
...
---@return number Number of entries stored in this blackboard.
function LAIBlackboard:getSize() end

--- Returns the string for the given key, or default.
---@param key string Blackboard entry name.
---@param default string|nil Fallback value when the key is missing.
...
---@return number Number of LOD tiers.
...
---@return number Number of agents currently registered in the world.
...
---@return number Scheduling priority for this agent.
...
---@return number Number of direct child nodes.
function LBTNode:getChildCount() end

--- Returns the repeat count, or 0 if not a Repeater.
---@return number Repeat count, or 0 if this node is not a repeater.
...
---@return number Number of bandit arms.
function LBandit:armCount() end

--- Returns the best arm index.
---@return number Best arm index.
...
---@return number Selected arm index.
function LBandit:select() end

--- Returns the total number of pulls.
---@return number Total number of pulls.
...
---@param opts table|nil Optional command options table.
---@return nil No value is returned.
function LCommandQueue:enqueue(kind, callback, opts) end

--- Returns the number of queued commands.
---@return number Number of queued commands.
...
---@return number Number of steering slots.
...
---@param cost number|nil Optional action cost.
---@param callback function|nil Optional Lua callback for the action.
---@return nil No value is returned.
...
---@param maxDepth integer|nil Optional maximum search depth.
...
---@return number Number of registered tasks.
...
---@return number Influence map height in cells.
...
---@return number Influence map width in cells.
...
---@param momentum number|nil Optional momentum factor.
---@return nil No value is returned.
...
---@param falloff number|nil Optional radial falloff factor.
---@return nil No value is returned.
...
---@return number Selected action, or nil if no action is found.
...
---@return number Number of network layers.
function LNeuralNet:layerCount() end

--- Returns the number of network parameters.
---@return number Number of network parameters.
...
---@return number Number of discrete actions.
...
---@return number Number of completed episodes.
...
---@return number Number of discrete states.
...
---@return number Number of squad members.
...
---@param spacing number|nil Optional formation spacing.
---@return nil No value is returned.
...
---@param guard function|nil Optional guard callback for the transition.
---@param priority integer|nil Optional transition priority.
---@return nil No value is returned.
...
---@param tx number Target x coordinate.
---@param ty number Target y coordinate.
---@param slowingRadius number|nil Optional slowing radius.
---@param weight number|nil Optional behavior weight.
---@return nil No value is returned.
...
---@param threatName string|nil Optional threat agent name.
---@param weight number|nil Optional behavior weight.
---@return nil No value is returned.
...
---@param panicDist number|nil Optional panic distance.
---@param weight number|nil Optional behavior weight.
---@return nil No value is returned.
function LSteeringManager:addFlee(tx, ty, panicDist, weight) end

--- Adds a Flock behavior for group movement.
---@param neighborRadius number|nil Optional neighbor search radius.
---@param sepWeight number|nil Optional separation weight.
---@param alignWeight number|nil Optional alignment weight.
---@param cohWeight number|nil Optional cohesion weight.
---@param weight number|nil Optional overall behavior weight.
---@return nil No value is returned.
...
---@param targetName string|nil Optional target agent name.
---@param weight number|nil Optional behavior weight.
---@return nil No value is returned.
...
---@param radius number|nil Optional wander circle radius.
---@param dist number|nil Optional wander circle distance.
---@param jitter number|nil Optional wander jitter amount.
---@param weight number|nil Optional behavior weight.
---@return nil No value is returned.
...
---@return number Number of active steering behaviors.
...
---@param decay_rate number Per-update decay rate.
---@param tag string|nil Optional stimulus tag.
---@return number Identifier of the created stimulus.
...
---@return number Number of active stimuli.
...
---@param duration number|nil Optional modifier duration in seconds.
...
---@param weight number|nil Optional momentum bonus.
---@return nil No value is returned.
...
---@param p1 number|nil Optional first curve parameter.
---@param p2 number|nil Optional second curve parameter.
---@param p3 number|nil Optional third curve parameter.
---@param weight number|nil Optional consideration weight.
---@return nil No value is returned.
...
---@param successPolicy string|nil Optional success policy name.
---@param failurePolicy string|nil Optional failure policy name.
...
---@param count integer|nil Optional repeat count.
...
---@return number Returns the number of keyframes.
...
---@return number Returns the number of member animations.
...
---@return number Returns the added frame index.
...
---@return number Returns the total number of frames added.
...
---@param bones table|nil Optional list of bone names for the mask.
...
---@return number Returns the number of layers.
...
---@return number Number of MIDI channels.
...
---@return number General MIDI instrument number.
...
---@return number Output channel count.
...
---@return number Total note count in the sequence.
...
---@return number Output sample rate in Hz.
...
---@return number Ticks per beat from the MIDI header.
function LMidiPlayer:getTicksPerBeat() end

--- Returns the number of tracks in the MIDI sequence.
---@return number Number of tracks in the sequence.
...
---@param bus_val LBus|nil Bus to route through, or nil to clear routing.
---@return nil No value is returned.
...
---@param params table|nil Optional effect parameter table.
---@return number Created effect id.
...
---@param source any LSource userdata or numeric source id.
---@return nil No value is returned.
...
---@param parent_name string|nil Optional parent bus name.
---@return nil No value is returned.
...
---@return number Number of active sources.
...
---@return number Number of free buffer slots.
...
---@return number Maximum simultaneous source count.
...
---@return number Number of registered sources.
...
---@param buffersize integer|nil Optional decoder buffer size.
...
---@param path string|nil Optional MIDI file path to load immediately.
...
---@param buffer_count integer|nil Optional number of queued buffers.
---@return number Packed queueable source id.
...
---@param source any LSource userdata or numeric source id.
---@param options table|nil Optional settings table.
---@return number Packed source id.
...
---@param z number|nil Optional listener Z position.
---@return nil No value is returned.
...
---@param z number|nil Optional source Z position.
---@return nil No value is returned.
...
---@param z number|nil Optional source velocity on the Z axis.
---@return nil No value is returned.
...
---@return number Zero-based step index.
...
---@return number Step limit value.
...
---@return number One-based flat index of the maximum element.
function LArray:argmax() end

--- Returns the 1-based flat index of the minimum element.
---@return number One-based flat index of the minimum element.
...
---@return number Nonzero element count.
...
---@param order integer|nil Optional difference order.
...
---@param max_iter integer|nil (default 1000).
---@param tol number|nil (default 1e-10).
...
---@param lo number|nil Optional lower bound.
---@param hi number|nil Optional upper bound.
...
---@param axis integer|nil Optional one-based axis.
...
---@param shape table|nil Shape table.
---@param dtype string|nil Element data type.
...
---@return number Byte value at the requested offset.
function LByteData:getByte(offset) end

--- Returns the total byte length of this buffer.
---@return number Total byte length of the buffer.
...
---@return number Bits packed LSB-first into a 32-bit integer.
...
---@return number Size of this view in bytes.
...
---@return number Total buffer length in bytes.
...
---@return number Current write cursor position.
...
---@return number Maximum capacity of the buffer.
...
---@return number Number of elements currently stored.
...
---@param level integer|nil Optional compression level.
...
---@return number CRC-32 value in the range `[0, 2^32)`.
...
---@param ... any
---@return number Total packed size in bytes.
...
---@param size integer|nil Optional view size in bytes.
...
---@param format string Binary pack format string.
---@return number Size of the format in bytes.
...
---@param row_tbl table|nil Row values keyed by column name.
---@return number 1-based row index of the new row.
...
---@param n integer|nil Number of rows to keep from the start.
...
---@param join_type string|nil Join mode such as inner, left, right, or outer.
...
---@param col string integer | Column name or index.
---@param threshold number|nil Threshold value.
---@return LDataFrame DataFrame result.
...
---@param agg string|nil Aggregation name.
---@return LDataFrame DataFrame result.
...
---@param result_col string|nil Result column name.
...
---@param seed integer|nil Optional random seed.
...
---@param col string integer | Column name or 1-based column index.
---@param ascending boolean|nil True for ascending order, false for descending.
...
---@param n integer|nil Number of rows to keep from the end.
...
---@param ascending boolean|nil True for ascending rank, false for descending.
...
---@param source string|nil Optional source name for the message.
---@param line integer|nil Optional source line number.
---@return nil No value is returned.
...
---@return number Number of currently connected clients.
...
---@return number Bound TCP port, or 0 when stopped.
lurek.debugbridge.getPort = function() end

--- Returns the print history.
---@param count integer|nil Optional maximum number of recent entries to return.
...
---@param scale integer|nil Optional screenshot scale factor clamped to 1 through 8.
---@return nil No value is returned.
...
---@param port integer|nil Optional TCP port to bind on localhost.
...
---@return number Number of history entries.
...
---@return number Identifier for the new watch.
...
---@param max_depth integer|nil Maximum recursion depth.
...
---@return number Frame-history buffer capacity.
...
---@param count integer|nil Maximum number of entries to return.
...
---@param frame integer|nil Frame value.
...
---@return number Number of retained profile frames.
...
---@param max_history integer|nil Maximum history length.
...
---@param value string|nil Value to store.
---@return nil No value is returned.
...
---@param module string|nil Optional module name filter.
...
---@return number Number of incomplete entries.
...
---@param catalog_ud LApiCatalog|nil Optional catalog to inspect.
---@return integer
---@return integer
...
---@param ns string|nil Optional namespace to reflect.
...
---@param name string|nil Optional prefix for qualified names.
...
---@param opts table|nil Optional scan options table.
...
---@param name string|nil Optional schema name.
...
---@param catalog_ud LApiCatalog|nil Optional catalog to validate.
...
---@param opts table|nil Optional table with a `priority` integer field.
---@return nil No value is returned.
...
---@return number Assigned bit index.
...
---@return number Bit index for the tag when it is defined.
...
---@return number Parent entity ID when one is set.
...
---@return number Number of registered systems.
...
---@param overrides table|nil Optional component overrides.
---@return number Spawned entity ID.
...
---@return number Number of effects in the chain.
...
---@param alpha number|nil Optional target alpha.
---@param duration number|nil Optional fade duration in seconds.
---@return nil No return value.
...
---@param g number Green channel.
---@param b number Blue channel.
---@param a number|nil Optional alpha channel.
---@param duration number|nil Optional flash duration in seconds.
---@return nil No return value.
...
---@return number Number of cloud shadow instances.
...
---@return number Effect height in pixels.
...
---@return number Effect width in pixels.
...
---@param name string|nil Shader name to assign, or nil to clear it.
---@return nil No return value.
...
---@param duration number|nil Optional shake duration in seconds.
---@return nil No return value.
...
---@param name string Parameter name.
---@param default number|nil Fallback value when the parameter is missing.
...
---@return number Number of effect slots removed.
...
---@return number Number of effect slots in the pipeline.
...
---@return number Render-target height in pixels.
function LPostFxStack:getHeight() end

--- Returns the width of the render target.
---@return number Render-target width in pixels.
...
---@param width integer|nil Optional overlay width in pixels.
---@param height integer|nil Optional overlay height in pixels.
...
---@param width integer|nil Optional stack width in pixels.
---@param height integer|nil Optional stack height in pixels.
...
---@param kind string|nil Optional transition kind name.
---@param duration number|nil Optional transition duration in seconds.
---@param color table|nil Optional fill color as `{r, g, b, a?}`.
...
---@return number Total processed frame count.
...
---@param count integer|nil Maximum bytes to read, or nil to read the rest of the file.
...
---@param prefix string|nil Name prefix, or nil to use `tmp`.
...
---@return number Async load handle.
...
---@param steps integer|nil Optional point count for the arc.
...
---@param name string Layer name.
---@param z_order integer|nil Optional layer draw order.
---@return nil No value is returned.
...
---@return number Picked province ID when one is found.
...
---@param viewer string|nil Viewer name, or nil to clear it.
---@return nil No value is returned.
...
---@param name string Globe name.
---@param spec table|nil Optional globe specification table.
...
---@param edge_type string|nil Type name for the new edge.
...
---@param node_type string|nil Type name for the new node.
---@param capacity integer|nil Capacity for the new node.
...
---@param item_type string|nil Type name for the new item.
---@param decay_time number|nil Initial decay time in seconds.
...
---@return number Number of edges in the graph.
...
---@return number Number of items in the graph.
...
---@param from_ud Node Start node userdata.
---@param max_dist number|nil Maximum distance.
...
---@return number Edge capacity, or -1 if unlimited.
...
---@return number Current item priority.
...
---@param priority integer|nil Priority value.
---@return nil No value is returned.
...
---@return number Node capacity, or -1 if unlimited.
function LGraphNode:getCapacity() end

--- Returns a table of Edge handles connected to this node.
---@param dir string|nil Edge direction filter: in, out, or both.
...
---@return number Number of items at this node.
...
---@return number Queue capacity, or -1 if unlimited.
...
---@param in_count integer|nil Number of input items required.
---@param out_count integer|nil Number of output items produced.
---@return nil No value is returned.
...
---@param f string|nil Item type filter for pulled items.
---@return nil No value is returned.
...
---@param f string|nil Item type filter for pushed items.
---@return nil No value is returned.
...
---@param fmt string|nil Optional format name such as `short`, `long`, or `iso`.
...
---@param opts table|nil Optional formatting options such as `decimals`.
...
---@return number Count of translation keys in the active locale.
...
---@param limit integer|nil Optional maximum number of results to return.
...
---@param vars table|nil Optional placeholder values for interpolation.
---@param count number|nil Optional count used for plural form selection.
...
---@param vars table|nil Optional placeholder substitutions passed to `t`.
...
---@return number Sum of absolute per-channel pixel differences.
...
---@return number Image height in pixels.
...
---@param name string|nil New image layer name.
---@return number 1-based index of the new layer.
...
---@return number Number of layers in the stack.
...
---@return number Number of colour mapping entries.
...
---@param x integer Zero-based pixel x coordinate.
---@param y integer Zero-based pixel y coordinate.
---@return number Province ID at the given pixel.
...
---@return number Number of unique non-zero province IDs.
...
---@return number Number of matched steps.
...
---@return number Number of stored sparse event frames.
...
---@return number Total recorded frame count.
...
---@param id integer Gamepad ID.
---@return number Total axis count.
...
---@param id integer Gamepad ID.
---@return number Total button count.
lurek.input.gamepad.getButtonCount = function(id) end

--- Returns the number of connected gamepads.
---@return number Connected gamepad count.
...
---@return number Tracked gamepad slot count.
...
---@return number Zero-based playback frame index.
...
---@return number Number of loaded mappings.
...
---@param opts table|nil Optional settings table with `total_gap`.
...
---@param hotx integer|nil Optional hot-spot X coordinate.
---@param hoty integer|nil Optional hot-spot Y coordinate.
...
---@return number Light interaction bitmask.
...
---@return number Shadow casting bitmask.
...
---@return number Maximum per-frame light count.
...
---@param opts table|nil Optional light settings table.
...
---@param vertices table Flat vertex coordinate table.
---@param opts table|nil Optional occluder settings table.
...
---@param index integer|nil Optional one-based insertion index.
---@return nil No value is returned.
...
---@param octaves integer|nil Optional octave count.
---@param lacunarity number|nil Optional lacunarity value.
---@param persistence number|nil Optional persistence value.
---@param kind string|nil Optional base noise kind.
...
---@param opts table|nil Optional generation settings.
...
---@param x number Sample x coordinate.
---@param y number Sample y coordinate.
---@param distType string|nil Optional distance metric name.
---@param f2 boolean|nil Optional second-feature toggle.
---@return number Noise value.
...
---@return number Random integer in the range.
function LRandomGenerator:randomInt(min, max) end

--- Returns a random number from a normal (Gaussian) distribution.
---@param stddev number|nil Standard deviation override.
---@param mean number|nil Mean override.
...
---@param sy number|nil Vertical scale factor.
---@return nil No value is returned.
...
---@param angle number|nil Rotation angle in radians.
---@param sx number|nil Horizontal scale factor.
---@param sy number|nil Vertical scale factor.
---@param ox number|nil Origin x value.
---@param oy number|nil Origin y value.
---@param kx number|nil Horizontal shear factor.
---@param ky number|nil Vertical shear factor.
---@return nil No value is returned.
...
---@return number One-based value index.
...
---@param index integer|nil Optional one-based value index.
...
---@return number Number of tweened values.
...
---@param x number|nil Optional x value for atan2.
---@return number Angle in radians.
...
---@param x number Sample x coordinate.
---@param y number Sample y coordinate.
---@param seed integer|nil Optional seed override.
---@param octaves integer|nil Optional octave count.
---@param lacunarity number|nil Optional lacunarity value.
---@param gain number|nil Optional gain value.
---@return number Noise value.
...
---@param x number Input value.
---@param b number|nil Optional logarithm base.
...
---@param seed integer|nil Optional seed value.
...
---@param x number|nil Translation x value.
---@param y number|nil Translation y value.
---@param angle number|nil Rotation angle in radians.
---@param sx number|nil Horizontal scale factor.
---@param sy number|nil Vertical scale factor.
---@param ox number|nil Origin x value.
...
---@param easingName string|nil Optional easing function name.
...
---@param min_or_max number|nil Optional upper bound, or lower bound when `max` is also set.
---@param max number|nil Optional upper bound.
...
---@param x number Sample x coordinate.
---@param y number Sample y coordinate.
---@param z number|nil Optional sample z coordinate.
---@return number Noise value.
...
---@param desc string|nil Marker description.
---@param r number|nil Red component.
---@param g number|nil Green component.
---@param b number|nil Blue component.
---@param a number|nil Alpha component.
---@return number Auto-assigned marker ID.
...
---@param a number|nil Alpha component.
---@return number 1-based index of the new object type.
...
---@param id integer|nil Object id.
---@return nil No value is returned.
...
---@param x integer X position.
---@param y integer Y position.
---@return number Fog level at the grid cell: 0 hidden, 1 explored, 2 visible.
...
---@return number Index of the currently active render layer.
...
---@return number Number of registered object types.
...
---@return number Number of active pings.
...
---@return number Terrain type ID at the cell.
...
---@param y number Y position.
---@param type_idx integer Type idx.
---@param owner integer|nil Owner id.
---@return nil No value is returned.
...
---@param a number|nil Alpha component in the range 0 to 1.
---@return nil No value is returned.
...
---@param display_w integer|nil Display width in pixels.
---@param display_h integer|nil Display height in pixels.
...
---@return number Returns the mod priority value.
...
---@return number Returns the registered mod count.
...
---@param reliable boolean|nil Whether to send reliably.
---@return nil No value is returned.
...
---@param channels integer|nil Number of channels to open.
---@param data integer|nil Optional connection data value.
---@return number Peer ID for the new connection.
...
---@param data integer|nil Optional disconnect data value.
---@return nil No value is returned.
...
---@return number Maximum number of channels per connection.
function LNetworkHost:getChannelLimit() end

--- Returns the number of currently connected peers.
---@return number Number of currently connected peers.
...
---@return number Maximum number of peer slots.
...
---@param incoming integer|nil Incoming bandwidth limit in bytes per second.
---@param outgoing integer|nil Outgoing bandwidth limit in bytes per second.
---@return nil No value is returned.
...
---@param headers table|nil Optional header table.
...
---@param player_count integer|nil Current player count.
---@param max_players integer|nil Maximum player count.
...
---@param timeout_ms integer|nil Listen timeout in milliseconds.
...
---@param channel integer|nil Channel index to use.
---@param reliable boolean|nil Whether to send reliably.
---@return nil No value is returned.
...
---@return number Returns the integer draw-order depth.
...
---@return number Returns the number of layers in the set.
...
---@param burst_count number|nil Burst particle count.
---@return nil No value is returned.
...
---@return number integer  1-based index of the new sub-system.
...
---@return number Number of living particles.
...
---@return number Number of attractors currently registered on this system.
function LParticleSystem:getAttractorCount() end

--- Returns the maximum particle count.
---@return number Maximum particle capacity.
...
---@param ox number|nil World X offset added to every particle (default 0).
---@param oy number|nil World Y offset added to every particle (default 0).
---@return nil No value is returned.
...
---@param w number Width value.
---@param h number Height value.
---@param angle number|nil Angle in radians.
---@param dir_relative boolean|nil Dir relative value.
---@return nil No value is returned.
...
---@return number Number of active trail points.
...
---@param end_width number|nil Ending width.
---@return nil No value is returned.
...
---@return number Flow field height in cells.
function LAIFlowField:getHeight() end

--- Returns the flow field grid width in cells.
---@return number Flow field width in cells.
...
---@param unitSize integer|nil Optional unit footprint size in cells.
---@return nil No value is returned.
...
---@return number Hex distance in cells.
...
---@param y2 integer 1-based goal cell Y coordinate.
---@param unitSize integer|nil Optional unit footprint size in cells.
---@param maxNodes integer|nil Optional node expansion limit.
---@return table
---@return boolean
...
---@return number Number of cached path results.
...
---@return number Current background thread count.
...
---@param width integer Grid width in cells.
---@param height integer Grid height in cells.
---@param layout string|nil Optional hex layout name: `flat` or `pointy`.
...
---@return number Current blackboard revision number.
...
---@param value any Fact value to store; nil clears the key.
---@return nil No return value.
...
---@return number Watcher subscription ID.
...
---@param undo_fn function|nil Optional function to run when the command is undone.
---@return nil No return value.
...
---@return number Total number of recorded commands.
...
---@return number Number of times the debounce has fired.
...
---@param ... any Additional values passed to listeners.
---@return nil No return value.
...
---@return number Number of listeners registered for the event.
...
---@param priority integer|nil Optional listener priority; higher values run first.
...
---@return number Number of flushes performed.
...
---@param value number|nil Optional numeric value for the entry.
---@return nil No return value.
...
---@param value any Value to append to the list.
---@return nil No return value.
...
---@param ... any Message values to deliver.
---@return nil No return value.
...
---@return number Number of handlers registered on the channel.
...
---@param value any Value to add to the idle pool.
---@return nil No return value.
...
---@param value any Property value to store.
---@return nil No return value.
...
---@param once boolean|nil Optional flag to remove the subscription after one call.
---@return number Subscription ID.
...
---@param value any Item value to enqueue.
---@param label string|nil Optional label for the item.
...
---@param default_level string|nil Optional default level name.
---@return nil No return value.
...
---@return number Number of stored relationship pairs.
...
---@return number Number of entries currently stored in the ring.
function LRing:len() end

--- Pushes a number or string value with an optional tag, overwriting the oldest entry on overflow.
---@param value any Number or string value to store.
---@param tag string|nil Optional tag to associate with the entry.
...
---@param value any Service value to store.
---@return nil No return value.
...
---@return number Number of distinct keys in the set.
...
---@param name string State name to register.
---@param callbacks table|nil Optional callbacks table with `enter`, `exit`, and `update` functions.
---@return nil No return value.
...
---@param value any Value to push onto the stack.
...
---@return number Number of times the throttle has fired.
...
---@param name string|nil Optional blackboard name.
...
---@param max_size integer|nil Optional maximum history size.
...
---@param name string|nil Optional EventBus name.
...
---@param max_entries integer|nil Optional maximum buffered entry count before flushing.
---@param name string|nil Optional funnel name.
...
---@param name string|nil Optional observer name.
...
---@param name string|nil Optional queue name.
...
---@param capacity integer|nil Optional queue capacity; `0` means unlimited.
...
---@param name string|nil Optional ring name.
...
---@param capacity integer|nil Optional stack capacity; `0` means unlimited.
...
---@return number Collision layer bitmask.
...
---@return number Collision mask bitmask.
...
---@return number Number of matching cells.
...
---@return number Material constant at the cell.
...
---@return number Fixture index on the body.
...
---@param r integer|nil Optional red channel override; defaults to 0.
---@param g integer|nil Optional green channel override; defaults to 255.
---@param b integer|nil Optional blue channel override; defaults to 0.
---@param a integer|nil Optional alpha channel override; defaults to 255.
---@return nil No return value.
...
---@return number Number of fixtures on the body.
...
---@return number Body ID at the point, or nil when none is found.
...
---@return number Solver iteration count.
...
---@return number Total number of joints.
...
---@param value number|nil Angular damping override, or nil to clear it.
---@return nil No return value.
...
---@param value number|nil Linear damping override, or nil to clear it.
---@return nil No return value.
...
---@param config table|nil Optional debug draw appearance overrides.
---@return nil No return value.
...
---@param outer_deps table|nil Array of outer step names that entry steps should depend on.
---@return nil No value is returned.
...
---@param context table|nil Context table passed to step callbacks.
...
---@param fn function|nil Callback called with the result table.
---@return nil No value is returned.
function LPipeline:setOnComplete(fn) end

--- Sets the callback invoked when a step completes successfully.
---@param fn function|nil Callback called with the step name and context table.
---@return nil No value is returned.
function LPipeline:setOnStepComplete(fn) end

--- Sets the callback invoked when a step fails.
---@param fn function|nil Callback called with the step name and error message.
---@return nil No value is returned.
...
---@param fn function|nil Callback that returns whether the step should run.
---@return nil No value is returned.
...
---@param opts table|nil Optional BSP dungeon settings.
...
---@param opts table|nil Optional cellular automata settings.
...
---@param threshold integer|nil Optional threshold value.
---@param above boolean|nil Whether to match values above the threshold.
...
---@param min_len integer|nil Optional minimum output length.
---@param max_len integer|nil Optional maximum output length.
---@param seed integer|nil Optional random seed.
...
---@param opts table|nil Optional heightmap settings.
...
---@param opts table L-system settings table.
---@param angle_deg number|nil Optional turn angle in degrees.
---@param step number|nil Optional step length.
...
---@param opts table|nil Optional noise generator settings.
...
---@param max_attempts integer|nil Optional maximum attempts per active point.
---@param seed integer|nil Optional random seed.
...
---@param opts table|nil Optional room dungeon settings.
---@return table Generated dungeon data.
...
---@param opts table|nil Optional Voronoi generation settings.
---@return table
---@return table
---@return table
...
---@return number Door index for open/close calls.
...
---@return number Number of doors tracked by this manager.
...
---@param angle number Angle in radians.
---@param max_dist number Maximum distance.
---@param max_hits integer|nil - layers to collect (default 4, max 8).
...
---@param x integer X position.
---@param y integer Y position.
---@return number Cell value at the grid position.
...
---@param scale number|nil (optional, default 1.0).
---@return number Unique sprite ID.
...
---@return number Sum of absolute per-channel differences.
function LImageData:diff(other) end

--- Returns the pixel height of this image buffer.
---@return number Pixel height of this image buffer.
function LImageData:getHeight() end
...
---@return number Pixel width of this image buffer.
function LImageData:getWidth() end
...
---@return number Number of vertices in this mesh.
...
---@param image LImage|nil Image to assign as the mesh texture, or nil to clear it.
---@return nil No return value.
...
---@param segments integer|nil Segment count, defaulting to 32.
---@return nil No return value.
...
---@param rotation number|nil Rotation in radians, defaulting to 0.
---@param sx number|nil Horizontal scale, defaulting to 1.
---@param sy number|nil Vertical scale, defaulting to 1.
---@param ox number|nil Origin x offset in object space, defaulting to 0.
---@param oy number|nil Origin y offset in object space, defaulting to 0.
---@return nil No return value.
...
---@return number Number of drawing commands stored in this shape.
...
---@param ry number|nil Vertical corner radius, defaulting to rx.
---@return nil No return value.
...
---@param a number|nil Alpha channel in the range 0 to 1, defaulting to 1.
---@return nil No return value.
...
---@param r number|nil Sprite rotation in radians.
---@param sx number|nil Horizontal scale.
---@param sy number|nil Vertical scale.
---@param ox number|nil Origin x offset.
---@param oy number|nil Origin y offset.
---@return number Index of the added sprite entry.
...
---@return number Maximum number of sprites the batch can hold.
function LSpriteBatch:getBufferSize() end

--- Returns the number of sprites in this batch.
---@return number Number of sprites in this batch.
...
---@param r number|nil Optional red channel.
---@param g number|nil Optional green channel.
---@param b number|nil Optional blue channel.
---@return nil No return value.
...
---@param w number Rectangle width.
---@param h number Rectangle height.
---@param bevelW number|nil Bevel width, defaulting to 2.
---@param style string|nil Bevel style name, defaulting to raised.
---@param opts table|nil Optional highlight, shadow, and fill colors.
---@return nil No return value.
...
---@param mode string|nil Draw mode, defaulting to fill.
---@return nil No return value.
...
---@param x2 number End x position.
---@param y2 number End y position.
---@param segments integer|nil Segment count, defaulting to 16.
---@return nil No return value.
...
---@param direction string|nil Gradient direction, defaulting to vertical.
---@return nil No return value.
...
---@param orientation string|nil Orientation name, defaulting to pointyTop.
---@param mode string|nil Draw mode, defaulting to line.
---@return nil No return value.
...
---@param opts table|nil Optional depth, color, and texture options.
---@return nil No return value.
...
---@param mode string|nil Draw mode, defaulting to line.
---@param close boolean|nil Whether to close the path, defaulting to false.
---@return nil No return value.
...
---@param x number|nil Draw x position, defaulting to 0.
---@param y number|nil Draw y position, defaulting to 0.
---@param r number|nil Rotation in radians, defaulting to 0.
---@param sx number|nil Horizontal scale, defaulting to 1.
---@param sy number|nil Vertical scale, defaulting to 1.
---@param ox number|nil Origin x offset, defaulting to 0.
---@param oy number|nil Origin y offset, defaulting to 0.
---@return nil No return value.
...
---@param pixel_height number|nil Requested built-in font height, defaulting to 14.
...
---@return number Window height in pixels.
lurek.render.getHeight = function() end

--- Returns the z order of the named layer.
---@param name string Layer name.
---@return number Layer z order, or 0 if the layer is not registered.
...
---@return number Window width in pixels.
...
---@param name string Layer name.
---@param z_order integer|nil Layer z order, defaulting to 0.
---@return nil No return value.
...
---@param mode string|nil Mesh draw mode, defaulting to triangles.
...
---@param max_sprites integer|nil Maximum sprite count, defaulting to 1000.
...
---@param x number|nil Draw x position, defaulting to 0.
---@param y number|nil Draw y position, defaulting to 0.
---@param scale number|nil Text scale, defaulting to 1.
---@return nil No return value.
...
---@param align string|nil Alignment name, defaulting to left.
---@return nil No return value.
...
---@param id integer Layer identifier.
---@param alpha number|nil Layer alpha, defaulting to 1.
---@param blendMode string|nil Blend mode name, defaulting to alpha.
---@return nil No return value.
...
---@param w number Rectangle width.
---@param h number Rectangle height.
---@param rx number|nil Horizontal corner radius.
---@param ry number|nil Vertical corner radius.
---@return nil No return value.
...
---@param sy number|nil Vertical scale, defaulting to sx.
---@return nil No return value.
...
---@param canvas LCanvas|nil Canvas to target, or nil to draw to the screen.
---@return nil No return value.
...
---@param anisotropy integer|nil Anisotropy level, defaulting to 1.
---@return nil No return value.
...
---@param write boolean|nil Whether depth writes are enabled, defaulting to false.
---@return nil No return value.
...
---@param shader LShader|nil Shader to activate, or nil to clear it.
---@return nil No return value.
lurek.render.setShader = function(shader) end

--- Sets the stencil buffer write/test mode.
---@param action string Stencil action name.
---@param compare string|nil Comparison mode name, defaulting to always.
---@param value integer|nil Reference value in the range 0 to 255.
---@return nil No return value.
...
---@param compare string|nil Comparison mode name, or nil to disable stencil testing.
---@param value integer|nil Stencil reference value, defaulting to 1.
---@return nil No return value.
...
---@param action string|nil Stencil action name, defaulting to replace.
---@param value integer|nil Stencil reference value, defaulting to 1.
---@return nil No return value.
...
---@return number Returns the current schema version.
...
---@param func function|nil Callback to run after loading, or `nil` to clear it.
---@return nil No value is returned.
function LSaveManager:onAfterLoad(func) end

--- Registers a callback that fires before every save operation.
---@param func function|nil Callback to run before saving, or `nil` to clear it.
---@return nil No value is returned.
...
---@return number Number of registered draw entries.
...
---@param def table|nil Scene method table.
...
---@return number Number of scenes on the stack.
...
---@param duration number|nil Duration in seconds. Defaults to 0.5.
...
---@param duration number|nil Duration in seconds. Defaults to 0.6.
---@return table Transition config table.
...
---@param transition string|nil Transition type name.
---@param duration number|nil Transition duration in seconds.
---@param easing string|nil Easing curve name.
---@return nil No value is returned.
...
---@param duration number|nil Transition duration in seconds.
---@param easing string|nil Easing curve name.
---@param params table|nil Optional `enter` parameters.
---@return nil No value is returned.
...
---@param direction string|nil Slide direction: "left", "right", "up", or "down". Defaults to "left".
---@param duration number|nil Duration in seconds. Defaults to 0.4.
---@return table Transition config table.
...
---@param delimiter string|nil Optional single-character field delimiter.
---@param has_headers boolean|nil Whether the first row should be treated as headers.
...
---@param delimiter string|nil Optional single-character field delimiter.
---@param has_headers boolean|nil Whether to emit a header row.
...
---@param value any Lua value to serialize.
---@param pretty boolean|nil Whether to format the output with indentation.
...
---@param opts table|nil Optional local transform settings.
---@return number Bone index.
...
---@param bend_positive boolean|nil Preferred bend direction.
---@return number Constraint index.
...
---@param attachment string|nil Optional attachment name.
...
---@param blend_weight number|nil Optional blend weight from `0.0` to `1.0`.
---@return nil No value is returned.
...
---@param looping boolean|nil Whether playback should loop.
...
---@param value number|nil Optional numeric payload.
---@return nil No value is returned.
...
---@param value number Keyframe value.
---@param easing string|nil Optional easing mode.
---@return nil No value is returned.
...
---@return number Total region count.
...
---@return number Returns the RAM size in megabytes.
...
---@return number Returns the total number of message entries.
...
---@return number Returns the number of logical CPU cores.
...
---@param args table|nil Optional argument table to parse instead of process arguments.
...
---@param opts table|nil Optional batch settings such as `stopOnError`.
...
---@return number Number of attached widgets.
...
---@param px number Screen X position.
---@param py number Screen Y position.
---@param button integer|nil Mouse button id.
---@return nil No value is returned.
...
---@param widget Widget|nil Widget userdata.
---@return nil No value is returned.
...
---@return number Number of child widgets in the panel.
...
---@return number Number of items in the list widget.
function LWidget:getItemCount() end

--- Returns the maximum character length of a text box widget.
---@return number Maximum character length for the text box.
...
---@return number Selected item index, or nil if nothing is selected.
...
---@param index integer|nil 1-based item index.
---@return nil No value is returned.
...
---@param terminal Terminal Terminal userdata.
---@return number Number of entries in the command history.
...
---@param cols integer|nil Column count.
---@param rows integer|nil Row count.
...
---@param terminal Terminal Terminal userdata.
---@return number Number of lines in the scrollback buffer.
...
---@param startGid integer|nil Optional starting global ID offset.
---@return nil No value is returned.
...
---@return number Bitmask value associated with the tile.
...
---@return number Number of tiles in this sheet.
...
---@return number Matching 1-based tile ID, or nil if no tile matches.
...
---@param x integer Tile column.
---@param y integer Tile row.
---@return number Tile global ID at the requested coordinate.
...
---@return number 1-based index of the new level.
...
---@return number Tile footprint height in pixels.
...
---@param part integer 0-based part slot index.
---@return number Tile global ID stored in the requested part slot.
function LIsoMap:getTilePart(z, x, y, part) end

--- Returns the tile footprint width in pixels.
---@return number Tile footprint width in pixels.
function LIsoMap:getTileWidth() end

--- Returns the map width in tiles.
---@return number Map width in tiles.
...
---@return number Current chunk size.
...
---@return number Side connection ID for the segment.
...
---@param x integer 1-based tile column.
---@param y integer 1-based tile row.
---@return number Tile global ID at the requested cell.
...
---@return number Block width in tiles.
function LMapBlock:getWidth() end

--- Returns the number of segments along the width.
---@return number Number of segments along the width.
...
---@param scriptIndex integer|nil Optional 1-based script index to run.
---@param seed integer|nil Optional random seed.
---@param layerName string|nil Optional name for the generated layer.
...
---@return number Number of blocks in this group.
...
---@return number Number of scripts in this group.
...
---@return number Number of steps in this script.
...
---@return number Chunk size used for spatial partitioning.
...
---@return number Number of layers in this map.
...
---@return number Number of tilesets attached to this map.
...
---@param ox number|nil Optional horizontal render offset in pixels.
---@param oy number|nil Optional vertical render offset in pixels.
---@return nil No value is returned.
...
---@return number Matching 1-based local tile ID, or nil if no rule matches.
...
---@return number Spacing in pixels between tiles in the atlas.
function LTileSet:getSpacing() end

--- Returns the total number of tiles in this tileset.
---@return number Total number of tiles in this tileset.
...
---@return number Height of a single tile in pixels.
function LTileSet:getTileHeight() end

--- Returns the width of a single tile in pixels.
---@return number Width of a single tile in pixels.
...
---@param level_name string|nil Optional level name to load.
...
---@return number Hex distance between the two coordinates.
...
---@param angle number Angle in radians.
---@return number Nearest isometric direction index.
...
---@return number Rotated isometric direction index.
...
---@param chunkSize integer|nil Optional chunk size in tiles.
...
---@param partCount integer|nil Optional number of part slots per tile.
...
---@param layers integer|nil Optional number of layers.
---@param segmentSize integer|nil Optional segment size in tiles.
...
---@param segmentSize integer|nil Optional segment size when using explicit width and height.
...
---@param tileWidth integer Tile width in pixels.
---@param tileHeight integer Tile height in pixels.
---@param spacing integer|nil Optional spacing in pixels between atlas tiles.
---@param margin integer|nil Optional margin in pixels around the atlas.
...
---@return number Scheduled event ID.
...
---@param interval number Interval in seconds.
---@param callback function Callback function.
---@param count integer|nil Optional repeat count; defaults to infinite.
---@return number Scheduled event ID.
...
---@param easing string|nil Optional easing name; defaults to `linear`.
---@return LTweenParallel The same parallel handle.
...
---@param fn function|nil Optional callback to run after the delay.
---@return LTweenSequence The same sequence handle.
...
---@return number Count of active tweens, sequences, parallels, and springs.
...
---@param opts table|nil Optional stiffness, damping, and precision settings.
...
---@param content_idx integer|nil Optional content widget index. Pass nil to leave the section without linked content.
---@return nil No value is returned.
LAccordion.addSection = function(title, content_idx) end

--- Returns the section count of this Accordion widget.
---@return number Number of sections in the accordion.
...
---@return number Raw count stored on this badge.
...
---@param b number Blue component.
---@param a number|nil Optional alpha component. Pass nil to keep the current alpha.
---@return nil No value is returned.
...
---@return number Number of items in this combo box.
LComboBox.getItemCount = function() end

--- Returns the selected index of this Combo_Box widget.
---@return number Selected 1-based item index, or 0 when nothing is selected.
...
---@param cb function|nil Optional callback argument accepted by the API.
---@return number 1-based footer button index, or 0 when unavailable.
...
---@return number Content widget index. Returns nil when no content is set.
...
---@param content_idx integer|nil Optional widget index to use as dialog content.
---@return nil No value is returned.
...
---@return number Number of docked child widgets.
...
---@param width number|nil Optional column width in pixels. Pass nil to use the default width.
---@return nil No value is returned.
...
---@return number Selected 1-based row index. Returns nil if no row is selected.
...
---@param row integer|nil 1-based row index. Pass nil to clear the selection.
---@return nil No value is returned.
...
---@param b number Blue tint component.
---@param a number|nil Optional alpha tint component. Pass nil to use full opacity.
---@return nil No value is returned.
...
---@return number Number of items in this list box.
...
---@return number Number of menus in this menu bar.
...
---@return number First child widget index. Returns nil when no first child is set.
...
---@return number Second child widget index. Returns nil when no second child is set.
...
---@param width number|nil Optional section width in UI pixels.
---@return nil No value is returned.
LStatusBar.addSection = function(text, width) end

--- Returns the section count of this Status_Bar widget.
---@return number Number of sections in this status bar.
...
---@param widget any Widget value accepted by this compatibility shim.
---@return nil No value is returned.
...
---@return number Active 1-based tab index, or 0 when unavailable.
...
---@return number Number of tabs in this tab bar.
...
---@return number Current cursor position in this text input.
...
---@param tooltip string|nil Optional tooltip text for the button.
---@return number 1-based index of the added button, or 0 when unavailable.
...
---@param size number|nil Optional spacer size in UI pixels.
---@return nil No value is returned.
...
---@return number Target widget index. Returns nil if no target is set.
...
---@param target integer|nil Target widget index. Pass nil to clear the target.
---@return nil No value is returned.
...
---@param parent_index integer|nil Optional 1-based parent node index.
---@return number 1-based index of the added node, or 0 when unavailable.
...
---@return number Number of nodes in this tree view.
LTreeView.getNodeCount = function() end

--- Returns the node depth of this Tree_View widget.
---@param index integer 1-based node index to inspect.
---@return number Node depth. Returns nil when the index is invalid.
...
---@param index integer 1-based node index to inspect.
---@return number 1-based parent node index. Returns nil when no parent exists.
LTreeView.getParentNode = function(index) end

--- Returns the selected node of this Tree_View widget.
---@return number Selected 1-based node index. Returns nil when no node is selected.
...
---@param child any Child widget table or widget index to attach.
---@return nil No value is returned.
...
---@return number Number of child widgets in this container.
...
---@return number Current widget z-order value.
...
---@param child any Child widget table or widget index to detach.
---@return nil No value is returned.
...
---@param left number|nil Left anchor value.
---@param top number|nil Top anchor value.
---@param right number|nil Right anchor value.
---@param bottom number|nil Bottom anchor value.
---@return nil No value is returned.
LUiWidget.setAnchor = function(left, top, right, bottom) end

--- Sets center anchor offsets.
---@param cx number|nil Horizontal center anchor offset.
---@param cy number|nil Vertical center anchor offset.
---@return nil No value is returned.
...
---@param right number|nil Right margin value, or nil to reuse top.
---@param bottom number|nil Bottom margin value, or nil to reuse top.
---@param left number|nil Left margin value, or nil to reuse the resolved right value.
---@return nil No value is returned.
...
---@param right number|nil Right padding value, or nil to reuse top.
---@param bottom number|nil Bottom padding value, or nil to reuse top.
---@param left number|nil Left padding value, or nil to reuse the resolved right value.
---@return nil No value is returned.
...
---@param x number Mouse x position.
---@param y number Mouse y position.
---@param button number|nil Mouse button number. Pass nil to use button `1`.
---@return boolean True if the GUI consumed the event.
...
---@param count integer|nil Optional badge count. Pass nil to use `0`.
...
---@param text string|nil Optional button text. Pass nil for an empty label.
---@return LButton New button widget.
lurek.ui.newButton = function(text) end

--- Creates a checkbox widget.
---@param text string|nil Optional checkbox label text. Pass nil for an empty label.
...
---@param config table|nil Optional widget config table with fields like `id`, `x`, `y`, `width`, `height`, `visible`, and `enabled`.
---@return LWidget New custom widget.
lurek.ui.newCustomWidget = function(config) end

--- Creates a modal dialog widget.
---@param title string|nil Optional dialog title. Pass nil for an empty title.
...
---@param text string|nil Optional label text. Pass nil for an empty label.
---@return LLabel New label widget.
lurek.ui.newLabel = function(text) end

--- Creates a flexbox layout container.
---@param direction string|nil Optional layout direction string. Pass nil to use `vertical`.
...
---@param text string|nil Optional menu item text. Pass nil for an empty label.
...
---@param min number|nil Optional minimum value. Pass nil to use `0.0`.
---@param max number|nil Optional maximum value. Pass nil to use `100.0`.
...
---@param text string|nil Optional radio button label text. Pass nil for an empty label.
---@param group string|nil Optional radio group name. Pass nil for an empty group.
...
---@param vertical boolean|nil True for a vertical scrollbar. Pass nil to use the default vertical mode.
...
---@param vertical boolean|nil True for a vertical separator. Pass nil for a horizontal separator.
...
---@param w number|nil Optional spacer width. Pass nil to use `0.0`.
---@param h number|nil Optional spacer height. Pass nil to use `0.0`.
...
---@param orientation string|nil Optional split orientation. Pass nil to use `horizontal`.
...
---@param on boolean|nil Optional initial state. Pass nil to start off.
...
---@param message string|nil Optional toast message. Pass nil for an empty message.
---@param duration number|nil Optional toast duration in seconds. Pass nil to use `3.0`.
---@return LToast New toast widget.
lurek.ui.newToast = function(message, duration) end

--- Creates a toolbar widget.
---@param orientation string|nil Optional toolbar orientation. Pass nil to use `horizontal`.
---@return LToolbar New toolbar widget.
lurek.ui.newToolbar = function(orientation) end

--- Creates a tooltip panel widget.
---@param text string|nil Optional tooltip text. Pass nil for an empty tooltip.
...
---@param title string|nil Optional window title. Pass nil for an empty title.
...
---@param widget table|nil Widget table to focus. Pass nil to clear focus.
---@return nil No value is returned.
...
---@param message string Message text.
---@param boxType string|nil Message box type.
---@param btnType string|nil Button layout type.
---@return string Returned string.
