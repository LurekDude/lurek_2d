...
*Coverage: 4818/4818 functions documented (100.0%)*

---

## Contents

- [`lurek.render`](#render) — 120 fn, 12 classes
...
*Coverage: 208/208 items documented (100%)*
...
lurek.render.resetCanvas( canvas : LCanvas ) -> nil  -- Marks a canvas as needing a full clear before its next render pass. Use before re-rendering to avoid content accumulation
