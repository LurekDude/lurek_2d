...
--- Get the effect name.
---@return string
function library.battle.getName() end

--- Get remaining duration (-1 = permanent).
---@return number
function library.battle.getDuration() end

--- Set remaining duration.
---@param v number
---@return nil
function library.battle.setDuration(v) end

--- Get current stack count.
---@return number
function library.battle.getStacks() end

--- Set stack count.
---@param v number
---@return nil
function library.battle.setStacks(v) end

--- Tick one turn. Returns true when the effect has just expired.
---@return boolean
function library.battle.tickTurn() end

--- Is the effect expired?
---@return boolean
function library.battle.isExpired() end
...
---@return number
function library.battle.getBaseDamage() end

--- Set base damage value.
---@param v number
---@return nil
function library.battle.setBaseDamage(v) end

--- Get damage type string.
---@return string
function library.battle.getDamageType() end

--- Set damage type string (defaults to "physical").
---@param v string
---@return nil
function library.battle.setDamageType(v) end

--- Get accuracy clamped to [0, 1].
---@return number
function library.battle.getAccuracy() end

--- Set accuracy, clamped to [0, 1].
---@param v number
---@return nil
function library.battle.setAccuracy(v) end

--- Get max cooldown turns.
---@return number
function library.battle.getCooldown() end

--- Set max cooldown turns.
---@param v number
---@return nil
function library.battle.setCooldown(v) end

--- Get current remaining cooldown turns.
---@return number
function library.battle.getCurrentCooldown() end

--- Get HP cost to use this action.
---@return number
function library.battle.getCostHp() end

--- Set HP cost.
---@param v number
---@return nil
function library.battle.setCostHp(v) end

--- Get MP cost to use this action.
---@return number
function library.battle.getCostMp() end

--- Set MP cost.
---@param v number
---@return nil
function library.battle.setCostMp(v) end

--- Is the action off cooldown?
---@return boolean
function library.battle.isReady() end

--- Put the action on cooldown.
---@return nil
function library.battle.useAction() end

--- Tick cooldown by one.
---@return nil
function library.battle.tickCooldown() end
...
---@return string
function library.battle.getTeam() end

--- Set team identifier (defaults to "player").
---@param v string
---@return nil
function library.battle.setTeam(v) end

--- Get current HP.
---@return number
function library.battle.getHp() end

--- Set current HP directly (use takeDamage/heal for safe HP changes).
---@param v number
---@return nil
function library.battle.setHp(v) end

--- Get maximum HP.
---@return number
function library.battle.getMaxHp() end

--- Set maximum HP.
---@param v number
---@return nil
function library.battle.setMaxHp(v) end

--- Get current MP.
---@return number
function library.battle.getMp() end

--- Set current MP.
---@param v number
---@return nil
function library.battle.setMp(v) end

--- Get maximum MP.
---@return number
function library.battle.getMaxMp() end

--- Set maximum MP.
---@param v number
---@return nil
function library.battle.setMaxMp(v) end

--- Get speed (used for initiative ordering; higher = sooner).
---@return number
function library.battle.getSpeed() end

--- Set speed.
---@param v number
---@return nil
function library.battle.setSpeed(v) end

--- Get combatant level.
---@return number
function library.battle.getLevel() end

--- Set combatant level.
---@param v number
---@return nil
function library.battle.setLevel(v) end

--- Is the combatant alive?
---@return boolean
function library.battle.isAlive() end

--- Apply damage, factoring in resistance. Resistance is a multiplier (default 1.0).
---@param amount number
---@param damage_type string
---@return number
function library.battle.takeDamage(amount, damage_type) end

--- Heal the combatant.
---@param amount number
---@return number
function library.battle.heal(amount) end

--- Add or stack a status effect.
---@param name string
---@param duration number
---@return nil
function library.battle.addStatus(name, duration) end

--- Remove a status effect by name.
---@param name string
---@return nil
function library.battle.removeStatus(name) end

--- Check if a status is active.
---@param name string
---@return boolean
function library.battle.hasStatus(name) end

--- Tick all status effects, removing expired ones.
---@return table
function library.battle.tickStatuses() end

--- Get array of {name, duration, stacks} tables.
---@return table
function library.battle.getStatuses() end

--- Get a named stat value (defaults to 0).
---@param name string
---@return number
function library.battle.getStat(name) end

--- Set a named stat.
---@param name string
---@param value number
---@return nil
function library.battle.setStat(name, value) end

--- Get damage resistance for a type (defaults to 1.0 = full damage).
---@param dtype string
---@return number
function library.battle.getResistance(dtype) end

--- Set damage resistance for a type.
---@param dtype string
---@param value number
---@return nil
function library.battle.setResistance(dtype, value) end

--- HP as a percentage (0-100).
---@return number
function library.battle.getHpPercent() end

--- MP as a percentage (0-100).
---@return number
function library.battle.getMpPercent() end

--- Add a combat action (deep clone of the action).
---@param action CombatAction
---@return nil
function library.battle.addAction(action) end

--- Get an action by name.
---@param name string
---@return CombatAction|nil
function library.battle.getAction(name) end

--- Check if the combatant has an action.
---@param name string
---@return boolean
function library.battle.hasAction(name) end

--- Tick all action cooldowns.
---@return nil
function library.battle.tickCooldowns() end

--- Get array of action names.
---@return table
function library.battle.getActionNames() end

--- Get array of status effect names.
---@return table
function library.battle.getStatusNames() end

--- Get metadata value.
---@param key string
---@return any|nil
function library.battle.getMeta(key) end

--- Set metadata value.
---@param key string
---@param value any
---@return nil
function library.battle.setMeta(key, value) end
...
---@return number
function library.battle.getCount() end

--- Get total completed turn count.
---@return number
function library.battle.getTurnCount() end

--- Returns true when the battle has ended.
---@return boolean
function library.battle.isOver() end
...
---@return string|nil
function library.battle.getWinner(auto_detect) end

--- Returns the battle log as an array of strings.
---@return table
function library.battle.getLog() end

--- Add a log entry.
---@param msg string
---@return nil
function library.battle.addToLog(msg) end

--- Add a combatant (deep clone).
---@param c Combatant
---@return nil
function library.battle.addCombatant(c) end

--- Get a combatant by name (returns reference inside battle).
---@param name string
---@return Combatant|nil
function library.battle.getCombatant(name) end

--- Sort combatants by speed (descending).
---@return nil
function library.battle.sortInitiative() end

--- Get the current alive combatant.
---@return Combatant|nil
function library.battle.getCurrentCombatant() end

--- Advance to next turn. Returns false if battle is over.
---@return boolean
function library.battle.nextTurn() end

--- Check if battle is over (one team or fewer alive).
---@return nil
function library.battle._checkBattleOver() end
...
---@return table|nil
function library.battle.attack(attacker_name, action_name, target_name) end

--- Get names of all alive combatants.
---@return table
function library.battle.getAliveNames() end

--- Get names of all combatants.
---@return table
function library.battle.getAllNames() end

--- Remove a combatant by name.
---@param name string
---@return boolean
function library.battle.removeCombatant(name) end

--- Force-end the battle with a specified winner.
---@param winner string
---@return nil
function library.battle.forceEnd(winner) end

--- Tick all combatant statuses.
---@return nil
function library.battle.tickAllStatuses() end

--- Tick all combatant action cooldowns.
---@return nil
function library.battle.tickAllActions() end

--- Resolve end-of-round bookkeeping: tick all statuses, tick all cooldowns, and check whether the battle has ended.
---@return boolean
function library.battle.resolve() end

--- Add a tag to this action (no-op if already present).
---@param tag string
---@return nil
function library.battle.addTag(tag) end

--- Remove a tag. Returns true if it existed.
---@param tag string
---@return boolean
function library.battle.removeTag(tag) end

--- Return true if the action has the given tag.
---@param tag string
---@return boolean
function library.battle.hasTag(tag) end

--- Return a sorted list of all tags on this action.
---@return table
function library.battle.getTags() end
...
---@param val any
---@return nil
function library.battle.setMeta(key, val) end
...
---@param key string
---@return any
function library.battle.getMetadata(key) end

--- Alias: setMetadata (matches Rust name).
---@param key string
---@param val any
---@return nil
function library.battle.setMetadata(key, val) end
...
---@param key string
---@return number
function library.cardgame.getStat(key) end

--- Set a numeric stat to an exact value.
---@param key string
---@param val number
---@return nil
function library.cardgame.setStat(key, val) end

--- Add delta to a stat and return the new value.
---@param key string
---@param delta number
---@return number
function library.cardgame.addStat(key, delta) end

--- Remove a stat entry entirely.
---@param key string
---@return nil
function library.cardgame.removeStat(key) end

--- Return true if the tag is present on this card.
---@param tag string
---@return boolean
function library.cardgame.hasTag(tag) end

--- Add a tag if not already present.
---@param tag string
---@return nil
function library.cardgame.addTag(tag) end

--- Remove the first occurrence of tag; returns true if it was present.
---@param tag string
---@return boolean
function library.cardgame.removeTag(tag) end

--- Return the named counter value, or 0 if not set.
---@param key string
---@return number
function library.cardgame.getCounter(key) end

--- Set a named counter to an exact value.
---@param key string
---@param v number
---@return nil
function library.cardgame.setCounter(key, v) end

--- Add delta to a counter and return the new value.
---@param key string
---@param delta number
---@return number
function library.cardgame.addCounter(key, delta) end

--- Remove a counter entry entirely.
---@param key string
---@return nil
function library.cardgame.removeCounter(key) end

--- Return a metadata string, or nil if not set.
---@param key string
---@return string|nil
function library.cardgame.getMeta(key) end

--- Store an arbitrary metadata string.
---@param key string
---@param val string
---@return nil
function library.cardgame.setMeta(key, val) end

--- Reset stats from the registered type definition, discarding per-instance overrides.
---@return nil
function library.cardgame.resetStats() end

--- Flip the card face (toggles face_up).
---@return nil
function library.cardgame.flip() end

--- Tap this card (mark as used/exhausted).
---@return nil
function library.cardgame.tap() end

--- Untap this card (reset exhausted state).
---@return nil
function library.cardgame.untap() end

--- Return true if the card is face-up.
---@return boolean
function library.cardgame.isFaceUp() end

--- Return true if the card is tapped.
---@return boolean
function library.cardgame.isTapped() end

--- Set the rarity tier string.
---@param r string
---@return nil
function library.cardgame.setRarity(r) end

--- Get the rarity tier string.
---@return string
function library.cardgame.getRarity() end

--- Set the tile grid position for board layout.
---@param x number
---@param y number
---@return nil
function library.cardgame.setTilePosition(x, y) end

--- Get the tile grid position.
---@return number,
function library.cardgame.getTilePosition() end
...
---@return nil
function library.cardgame.shuffle() end

--- Return the raw card array (by reference).
---@return table
function library.cardgame.items() end

--- Return the type names of the top n cards (topmost first).
---@param n number
---@return table
function library.cardgame.peekTopNTypes(n) end

--- Return a shallow copy of the card array for later restoration.
---@return table
function library.cardgame.snapshotCards() end

--- Replace the card array with a previously snapshotted copy.
---@param cards table
---@return nil
function library.cardgame.restoreCards(cards) end

--- Return true when the stack preserves insertion order.
---@return boolean
function library.cardgame.isOrdered() end

--- Set whether the stack preserves order.
---@param b boolean
---@return nil
function library.cardgame.setOrdered(b) end

--- Return true when the stack contents are publicly visible.
---@return boolean
function library.cardgame.isPublic() end

--- Set whether the stack is publicly visible.
---@param b boolean
---@return nil
function library.cardgame.setPublic(b) end

--- Rename the stack.
---@param n string
---@return nil
function library.cardgame.setName(n) end
...
---@param card Card
---@return boolean
function library.cardgame.push(card) end

--- Remove and return the last pushed card, or nil if empty.
---@return Card|nil
function library.cardgame.pop() end
...
---@return Card|nil
function library.cardgame.peek() end
...
---@return table
function library.cardgame.getItems() end

--- Return true if any item in the slot has the given tag.
---@param tag string
---@return boolean
function library.cardgame.hasItemWithTag(tag) end

--- Return true if any item in the slot has the given type name.
---@param t string
---@return boolean
function library.cardgame.hasItemOfType(t) end
...
---@param weight number
---@return nil
function library.cardgame.add(type_name, weight) end

--- Remove all entries for the given type name.
---@param type_name string
---@return nil
function library.cardgame.remove(type_name) end

--- Update the weight for an existing type entry (no-op if not found).
---@param type_name string
---@param weight number
---@return nil
function library.cardgame.setWeight(type_name, weight) end
...
---@param weight number
---@return nil
function library.cardgame.setRarityWeight(rarity, weight) end

--- Return the sum of all entry weights.
---@return number
function library.cardgame.totalWeight() end
...
---@param seed number
---@return table
function library.cardgame.drawItemsSeeded(n, seed) end

--- Draw cards matching a rarity distribution table {rarity=count,...}.
---@param distribution table
---@return table
function library.cardgame.drawByRarity(distribution) end
...
---@param stack Stack
---@return nil
function library.cardgame.addStack(name, stack) end

--- Create and register a new unbounded stack.
---@param name string
---@return nil
function library.cardgame.createStack(name) end

--- Create and register a new capacity-limited stack.
---@param name string
---@param cap number
---@return nil
function library.cardgame.createStackCapped(name, cap) end

--- Deregister and return a stack, or nil if not found.
---@param name string
---@return Stack|nil
function library.cardgame.removeStack(name) end

--- Return true if a stack with the given name is registered.
---@param name string
---@return boolean
function library.cardgame.hasStack(name) end

--- Return the registered Stack, or nil if not found.
---@param name string
---@return Stack|nil
function library.cardgame.getStack(name) end

--- Return a sorted list of all registered stack names.
---@return table
function library.cardgame.stackNames() end

--- Return the total number of cards across all registered stacks.
---@return number
function library.cardgame.totalItems() end
...
---@return Card|nil,
function library.cardgame.moveItem(from_name, idx, to_name) end
...
---@param to_name string
---@return Card|nil,
function library.cardgame.moveItemByType(from_name, card_type, to_name) end

--- Move the top card from one stack to another.
---@param from_name string
---@param to_name string
---@return Card|nil,
function library.cardgame.moveTop(from_name, to_name) end
...
---@param count number
---@return nil
function library.cardgame.add(type_name, count) end
...
---@return nil
function library.cardgame.addRequiredCategory(cat, min_count, max_count) end

--- Validate the builder's entries against all constraints.
---@return table
function library.cardgame.validateEntries() end

--- Validate an already-built Stack against size constraints.
---@param stack Stack
---@return table
function library.cardgame.validateStack(stack) end

--- Build and return a Stack using the builder's own name.
---@return Stack
function library.cardgame.build() end

--- Build and return a Stack with a custom name.
---@param stack_name string
---@return Stack
function library.cardgame.buildNamed(stack_name) end
...
---@return nil
function library.cardgame.record(stack_name, action, size_after) end
...
---@param size_after number
---@return nil
function library.cardgame.recordCustom(stack_name, label, size_after) end

--- Return the number of recorded entries.
---@return number
function library.cardgame.len() end
...
---@return table
function library.cardgame.entries() end

--- Return the most recent entry, or nil if empty.
---@return table|nil
function library.cardgame.last() end

--- Return all entries for the given stack name.
---@param stack_name string
---@return table
function library.cardgame.entriesFor(stack_name) end
...
---@param cards table
---@return table
function library.cardgame.itemsFrom(cards) end
...
---@param stat string
---@return number
function library.cardgame.maxStat(cards, stat) end

--- Return the sum of a stat across grouped cards.
---@param cards table
---@param stat string
---@return number
function library.cardgame.totalStat(cards, stat) end

--- Return true if every card in the group has the given tag.
---@param cards table
---@param tag string
---@return boolean
function library.cardgame.allHaveTag(cards, tag) end
...
---@param clip table
---@return nil
function library.cinematic.add(clip) end
...
---@return nil
function library.cinematic.tween(at, duration, target, props, easing) end

--- Camera move clip.
---@return nil
function library.cinematic.cameraTo(at, duration, x, y, zoom, easing) end

--- Camera shake clip.
---@return nil
function library.cinematic.shake(at, duration, intensity) end

--- Dialog clip — fires once forward only.
---@return nil
function library.cinematic.dialog(at, line) end

--- Audio clip — fires once forward only.
---@return nil
function library.cinematic.audio(at, source, opts) end

--- Signal clip — emits via `lurek.event.push` (or queues for later read).
---@return nil
function library.cinematic.signal(at, name, ...) end

--- Generic Lua callback. Mark `reversible = true` to allow backward seeks.
---@return nil
function library.cinematic.call(at, fn, opts) end

--- Wait clip — pauses the timeline until `predicate_fn()` returns true.
---@return nil
function library.cinematic.wait(at, predicate_fn) end

--- Remove a clip by reference.
---@return nil
function library.cinematic.remove(clip) end
...
---@return nil
function library.cinematic.label(at, name) end

--- Add a branch — `child_timeline` runs at `at` only when `predicate(tl)` is true.
---@return nil
function library.cinematic.branch(at, predicate, child) end
...
---@return number|nil
---@return string|nil
function library.combat.defineGroup(name) end

--- Returns the category bit for the named group, or nil.
---@param name string
---@return any
function library.combat.getGroupBit(name) end
...
---@return any
function library.combat.setCollides(group_a, group_b, collides) end

--- Returns whether two named groups collide (defaults to true).
---@param group_a string
---@param group_b string
---@return any
function library.combat.getCollides(group_a, group_b) end

--- Computes the collision filter mask bits for the named group.
---@param group string
---@return any
function library.combat.computeMask(group) end

--- Returns the number of defined groups.
---@return any
function library.combat.groupCount() end

--- Returns an array of all defined group names.
---@return any
function library.combat.groupNames() end

--- Clears all groups and collision rules.
---@return nil
function library.combat.reset() end
...
---@return number|nil
function library.combat.update(dt, current_angle) end

--- Sets the desired target angle for the turret.
---@param angle number
---@return nil
function library.combat.aimAtAngle(angle) end
...
---@return any
function library.combat.isAimed(tolerance) end

--- Clamps an angle to the turret arc limits [arc_min, arc_max].
---@param angle number
---@return any
function library.combat.clampToArc(angle) end
...
---@return any
function library.combat.canFire() end
...
---@return nil
function library.combat.update(dt, body_x, body_y, body_angle) end
...
---@return boolean
function library.crafting.isTag() end
...
---@param t string
---@return boolean
function library.crafting.hasTag(t) end
...
---@param item_type string
---@return boolean
function library.crafting.setGridSlot(x, y, item_type) end
...
---@param chance number
---@return nil
function library.crafting.addByproduct(item_type, quantity, chance) end

--- Add a crafting condition requirement.
---@param ctype string
---@param cvalue string
---@return nil
function library.crafting.addCondition(ctype, cvalue) end
...
---@param recipe Recipe
---@return nil
function library.crafting.add(recipe) end

--- Remove a recipe by ID. Returns true if it existed.
---@param id string
---@return boolean
function library.crafting.remove(id) end

--- Return all recipe IDs in registration order.
---@return table
function library.crafting.ids() end

--- Find recipes that produce a specific item type.
---@param item_type string
---@return table
function library.crafting.findByOutput(item_type) end

--- Find recipes that consume a specific item type.
---@param item_type string
---@return table
function library.crafting.findByIngredient(item_type) end

--- Find recipes carrying a specific tag.
---@param tag string
---@return table
function library.crafting.findByTag(tag) end

--- Find recipes that require a specific station type.
---@param station_type string
---@return table
function library.crafting.forStation(station_type) end

--- Find recipes in a UI category.
---@param cat string
---@return table
function library.crafting.findByCategory(cat) end

--- Find recipes gated by a skill, optionally capped to max_level.
---@param name string
---@param max_level number|nil
---@return table
function library.crafting.findBySkill(name, max_level) end

--- Find all hand-craftable recipes.
---@return table
function library.crafting.findHandCraftable() end
...
---@param amount number
---@return number
function library.crafting.addXP(amount) end

--- Grant one free perk point.
---@return nil
function library.crafting.grantPerkPoint() end

--- Spend a perk point to unlock a perk by name. Returns false if no points or perk not unlockable.
---@param perk_name string
---@return boolean
function library.crafting.spendPerkPoint(perk_name) end

--- Return true if the named perk is unlocked.
---@param name string
---@return boolean
function library.crafting.hasPerk(name) end

--- Register a PerkNode in the skill perk tree.
---@param node PerkNode
---@return nil
function library.crafting.addPerkToTree(node) end
...
---@return boolean
function library.crafting.canUnlock(skill_level, unlocked_perks) end
...
---@param dt number
---@return boolean
function library.crafting.advance(dt) end

--- Return completion fraction 0ÔÇô1.
---@return number
function library.crafting.percent() end

--- Pause the job (stops time advancing).
---@return nil
function library.crafting.pause() end

--- Resume the job.
---@return nil
function library.crafting.resume() end

--- Return true if the job is completed.
---@return boolean
function library.crafting.isCompleted() end

--- Return true if the job is paused.
---@return boolean
function library.crafting.isPaused() end

--- Return remaining seconds.
---@return number
function library.crafting.remaining() end
...
---@param n number
---@return nil
function library.crafting.setMaxConcurrent(n) end

--- Get the maximum concurrent job count.
---@return number
function library.crafting.maxJobs() end
...
---@param quantity number
---@return number|nil
function library.crafting.enqueue(recipe_id, total_time, quantity) end

--- Cancel a job by id. Returns true if the job was removed.
---@param id number
---@return boolean
function library.crafting.cancel(id) end
...
---@param dt number
---@return table
function library.crafting.update(dt) end

--- Remove and return all completed job ids since last collect.
---@return table
function library.crafting.collectCompleted() end

--- Get a job by id (active jobs only).
---@param id number
---@return CraftJob|nil
function library.crafting.getJob(id) end

--- Return total active job count (not including completed-but-uncollected).
---@return number
function library.crafting.count() end

--- Return true if the queue is full.
---@return boolean
function library.crafting.isFull() end

--- Return sorted list of active (not-completed) job IDs.
---@return table
function library.crafting.activeIds() end

--- Return all active jobs as summary tuples.
---@return table
function library.crafting.allJobs() end

--- Clear all jobs from the queue.
---@return nil
function library.crafting.clear() end
...
---@param cost number
---@return nil
function library.crafting.setCost(cost) end

--- Get the unlock cost.
---@return number
function library.crafting.getCost() end

--- Add an effect to this node.
---@param effect string
---@return nil
function library.crafting.addEffect(effect) end

--- Get all effects.
---@return table
function library.crafting.getEffects() end

--- Add a tag.
---@param tag string
---@return nil
function library.crafting.addTag(tag) end

--- Check if the node has a tag.
---@param tag string
---@return boolean
function library.crafting.hasTag(tag) end

--- Return true when unlocked.
---@return boolean
function library.crafting.isUnlocked() end
...
---@return nil
function library.crafting.addNode(node) end

--- Add a directed edge from_id Ôćĺ to_id.
---@param from_id string
---@param to_id string
---@return nil
function library.crafting.addEdge(from_id, to_id) end

--- Look up a node by ID.
---@param id string
---@return UpgradeNode|nil
function library.crafting.getNode(id) end

--- Get children of a node (sorted).
---@param id string
---@return table
function library.crafting.getChildren(id) end

--- Get root nodes (no parent).
---@return table
function library.crafting.getRootNodes() end

--- Get parent ID (or nil if root).
---@param id string
---@return string|nil
function library.crafting.getParent(id) end

--- Return true if a node can be unlocked. All rules: node exists, not already unlocked, parent (if any) is unlocked.
---@param id string
---@return boolean
function library.crafting.canUnlock(id) end

--- Unlock a node. Returns true on success.
---@param id string
---@return boolean
function library.crafting.unlock(id) end

--- Reset a node (re-lock it). Returns true if it was unlocked.
---@param id string
---@return boolean
function library.crafting.resetNode(id) end

--- Return sorted list of unlocked node IDs.
---@return table
function library.crafting.getUnlockedIds() end

--- Return all node IDs in insertion order.
---@return table
function library.crafting.nodeIds() end
...
---@param to string
---@return table|nil
function library.crafting.getPath(from, to) end
...
---@return table
function library.crafting.queuedIds() end

--- Effective level = base level + count of installed attachments.
---@return number
function library.crafting.effectiveLevel() end

--- Effective craft time after applying station efficiency.
---@param recipe table
---@return number
function library.crafting.effectiveTime(recipe) end

--- Return true if the station can process a recipe.
---@param recipe table
---@return boolean
function library.crafting.canProcess(recipe) end

--- Return true if world position is within proximity_radius.
---@param px number
---@param py number
---@return boolean
function library.crafting.isInRange(px, py) end

--- Return the current module slot capacity.
---@return number
function library.crafting.moduleSlotCount() end

--- Set the module slot capacity.
---@param n number
---@return nil
function library.crafting.setModuleSlotCount(n) end

--- Return the module name at a 1-based slot index.
---@param slot number
---@return string|nil
function library.crafting.getModuleAt(slot) end

--- Return all nodes in insertion order.
---@return table
function library.crafting.getAllNodes() end

--- Remove modifier by name. Returns true if found.
---@param name string
---@return boolean
function library.crafting.remove(name) end

--- Return sum of all entry weights.
---@return number
function library.crafting.getTotalWeight() end

--- Return a copy of the entries list.
---@return table
function library.crafting.getEntries() end

--- Alias for getEntries (matches Rust get_modifiers).
---@return table
function library.crafting.getModifiers() end
...
--- Get the pool name.
---@return string
function library.crafting.getName() end

--- Set the pool name.
---@param name string
---@return nil
function library.crafting.setName(name) end

--- Remove knowledge of a recipe. Returns true if it was known.
---@param recipe_id string
---@return boolean
function library.crafting.forget(recipe_id) end

--- Enable or disable auto-discover mode.
---@param enabled boolean
---@return nil
function library.crafting.setAutoDiscover(enabled) end

--- Return true if auto-discover is enabled.
---@return boolean
function library.crafting.isAutoDiscover() end
...
---@param recipe_id string
---@return nil
function library.crafting.addRecipe(recipe_id) end

--- Remove a recipe ID. Returns true if found.
---@param recipe_id string
---@return boolean
function library.crafting.removeRecipe(recipe_id) end

--- Return all recipe IDs.
---@return table
function library.crafting.getRecipes() end
...
---@param recipe_id string
---@return boolean
function library.crafting.contains(recipe_id) end

--- Set the icon identifier.
---@param icon string
---@return nil
function library.crafting.setIcon(icon) end

--- Get the icon identifier.
---@return string
function library.crafting.getIcon() end

--- Set the sort order.
---@param order number
---@return nil
function library.crafting.setOrder(order) end

--- Get the sort order.
---@return number
function library.crafting.getOrder() end
...
---@param nodes table
---@return nil
function library.dialog.load(nodes) end

--- Begin playback from the first node.
---@return nil
function library.dialog.start() end

--- Advance per-frame. Call every frame while isActive() is true.
---@param dt number
---@return nil
function library.dialog.update(dt) end
...
---@param fn function
---@return nil
function library.dialog.on(event, fn) end

--- Unregister all callbacks for a named event.
---@param event string
---@return nil
function library.dialog.off(event) end
...
---@return table|nil
function library.dialog.getEventBus() end
...
---@return number
---@return number
function library.doll.getAbsoluteScale() end

--- Get a shallow copy of all attributes.
---@return table
function library.doll.getAttributes() end
...
---@param part Part
---@return boolean
function library.doll.attach(socketName, part) end
...
---@return table
function library.doll.getDrawList() end
...
---@return nil
function library.doll.draw() end
...
---@return nil
function library.economy._clamp(v) end

---@return string
function library.economy.getName() end

---@return number
function library.economy.getValue() end

--- Set the resource value (clamped).
---@param v number
---@return nil
function library.economy.setValue(v) end

---@return number
function library.economy.getCapacity() end

--- Set maximum capacity. Re-clamps value.
---@param c number
---@return nil
function library.economy.setCapacity(c) end

---@return number
function library.economy.getMinimum() end

--- Set minimum value. Re-clamps value.
---@param m number
---@return nil
function library.economy.setMinimum(m) end

---@return string
function library.economy.getOverflow() end

--- Set overflow policy.
---@param p string
---@return nil
function library.economy.setOverflow(p) end

---@return number
function library.economy.getFlowRate() end

--- Set the per-second flow rate (income).
---@param r number
---@return nil
function library.economy.setFlowRate(r) end

---@return number
function library.economy.getDecayRate() end

--- Set the per-second flat decay rate.
---@param r number
---@return nil
function library.economy.setDecayRate(r) end

---@return number
function library.economy.getDecayPercent() end

--- Set the per-second proportional decay (0.1 = 10%/s).
---@param p number
---@return nil
function library.economy.setDecayPercent(p) end

---@return number
function library.economy.getInterestRate() end

--- Set the per-second proportional interest rate.
---@param r number
---@return nil
function library.economy.setInterestRate(r) end

---@return number
function library.economy.getUpkeep() end

--- Set the per-second upkeep cost.
---@param u number
---@return nil
function library.economy.setUpkeep(u) end

---@return string
function library.economy.getGroup() end

--- Set the group tag for this resource.
---@param g string
---@return nil
function library.economy.setGroup(g) end

---@return boolean
function library.economy.isEnabled() end

--- Enable or disable tick processing.
---@param e boolean
---@return nil
function library.economy.setEnabled(e) end

---@return boolean
function library.economy.isVisible() end

--- Set the UI visibility hint.
---@param v boolean
---@return nil
function library.economy.setVisible(v) end

---@return boolean
function library.economy.isLocked() end

--- Lock or unlock add/spend modifications.
---@param l boolean
---@return nil
function library.economy.setLocked(l) end

---@return number
function library.economy.getReserved() end

---@return number
function library.economy.getAvailable() end
...
---@return string
function library.economy.getType() end
...
---@return number
function library.economy.getDuration() end

--- Return remaining time before expiry.
---@return number
function library.economy.getRemaining() end

--- Return the source tag.
---@return string
function library.economy.getSource() end

--- Return the target identifier.
---@return string
function library.economy.getTarget() end

--- Set the target identifier.
---@param t string
---@return nil
function library.economy.setTarget(t) end

--- Return true if the modifier has expired.
---@return boolean
function library.economy.isExpired() end

--- Return true if the modifier is permanent (duration <= 0).
---@return boolean
function library.economy.isPermanent() end

--- Advance the expiry countdown.
---@param dt number
---@return nil
function library.economy.update(dt) end
...
---@return string
function library.economy.getFrom() end

--- Return the destination resource name.
---@return string
function library.economy.getTo() end

--- Return the base conversion rate.
---@return number
function library.economy.getRate() end

--- Set the base conversion rate.
---@param r number
---@return nil
function library.economy.setRate(r) end

--- Return the fee applied per conversion.
---@return number
function library.economy.getFee() end

--- Set the fee applied per conversion.
---@param f number
---@return nil
function library.economy.setFee(f) end

--- Return the cooldown duration in seconds.
---@return number
function library.economy.getCooldown() end

--- Set the cooldown duration in seconds.
---@param c number
---@return nil
function library.economy.setCooldown(c) end

--- Return the minimum allowed conversion amount.
---@return number
function library.economy.getMinAmount() end

--- Set the minimum allowed conversion amount.
---@param m number
---@return nil
function library.economy.setMinAmount(m) end

--- Return the maximum allowed conversion amount.
---@return number
function library.economy.getMaxAmount() end

--- Set the maximum allowed conversion amount.
---@param m number
---@return nil
function library.economy.setMaxAmount(m) end

--- Return true if the rule is currently on cooldown.
---@return boolean
function library.economy.isOnCooldown() end

--- Reset the cooldown timer to zero.
---@return nil
function library.economy.resetCooldown() end

--- Trigger the cooldown period.
---@return nil
function library.economy.startCooldown() end

--- Advance the cooldown timer.
---@param dt number
---@return nil
function library.economy.updateCooldown(dt) end

--- Add a modifier to this rule.
---@param m Modifier
---@return nil
function library.economy.addModifier(m) end

--- Remove a modifier by 1-based index. Returns true if removed.
---@param index number
---@return boolean
function library.economy.removeModifier(index) end

--- Return the modifier array.
---@return table
function library.economy.getModifiers() end

--- Clear all modifiers from this rule.
---@return nil
function library.economy.clearModifiers() end
...
---@return number
function library.economy.effectiveRate() end
...
---@return table|nil
function library.economy.getEventBus() end
...
---@param name string
---@return Resource|nil
function library.economy.getResource(name) end

---@param name string
---@return boolean
function library.economy.hasResource(name) end

---@return table
function library.economy.getResourceNames() end

--- Remove a resource by name.
---@param name string
---@return nil
function library.economy.removeResource(name) end
...
---@return nil
function library.economy.turn() end

--- Add a conversion rule.
---@param rule ConversionRule
---@return nil
function library.economy.addConversionRule(rule) end

---@return table
function library.economy.getConversionRules() end
...
---@param amount number
---@return boolean
function library.economy.convert(from, to, amount) end
...
---@return boolean
function library.economy.exchange(other, give_name, give_amount, get_name, get_amount) end

--- Sum of values for all resources in a group.
---@param group string
---@return number
function library.economy.totalByGroup(group) end

--- Percent full (0-100) for a resource, 0 if capacity <= 0.
---@param name string
---@return number
function library.economy.getPercent(name) end

--- Is the resource at capacity?
---@param name string
---@return boolean
function library.economy.isFull(name) end

--- Is the resource at minimum?
---@param name string
---@return boolean
function library.economy.isEmpty(name) end

--- Check if all resources in the table can be afforded.
---@param needs table
---@return boolean
function library.economy.canAffordAll(needs) end

--- Atomically spend all resources in the table.
---@param needs table
---@return boolean
function library.economy.spendAll(needs) end

--- Clear all resources and conversion rules.
---@return nil
function library.economy.reset() end

--- Return the current value of a named resource (0 if not found).
---@param name string
---@return number
function library.economy.getValue(name) end

--- Set the value of a named resource (clamped).
---@param name string
---@param v number
---@return nil
function library.economy.setValue(name, v) end

--- Return the capacity of a named resource.
---@param name string
---@return number
function library.economy.getCapacity(name) end

--- Set the capacity of a named resource.
---@param name string
---@param c number
---@return nil
function library.economy.setCapacity(name, c) end

--- Return the minimum value of a named resource.
---@param name string
---@return number
function library.economy.getMinimum(name) end

--- Set the minimum value of a named resource.
---@param name string
---@param m number
---@return nil
function library.economy.setMinimum(name, m) end

--- Return the flow rate of a named resource.
---@param name string
---@return number
function library.economy.getFlowRate(name) end

--- Set the flow rate of a named resource.
---@param name string
---@param rate number
---@return nil
function library.economy.setFlowRate(name, rate) end

--- Return the flat decay rate of a named resource.
---@param name string
---@return number
function library.economy.getDecayRate(name) end

--- Set the flat decay rate of a named resource.
---@param name string
---@param rate number
---@return nil
function library.economy.setDecayRate(name, rate) end

--- Return the proportional decay rate of a named resource.
---@param name string
---@return number
function library.economy.getDecayPercent(name) end

--- Set the proportional decay rate of a named resource.
---@param name string
---@param pct number
---@return nil
function library.economy.setDecayPercent(name, pct) end

--- Return the interest rate of a named resource.
---@param name string
---@return number
function library.economy.getInterestRate(name) end

--- Set the interest rate of a named resource.
---@param name string
---@param rate number
---@return nil
function library.economy.setInterestRate(name, rate) end

--- Return the upkeep cost of a named resource.
---@param name string
---@return number
function library.economy.getUpkeep(name) end

--- Set the upkeep cost of a named resource.
---@param name string
---@param u number
---@return nil
function library.economy.setUpkeep(name, u) end

--- Return the net rate (flow - decay - upkeep + interest - decay%) of a named resource.
---@param name string
---@return number
function library.economy.getNetRate(name) end

--- Return the overflow policy of a named resource.
---@param name string
---@return string
function library.economy.getOverflow(name) end

--- Set the overflow policy of a named resource.
---@param name string
---@param policy string
---@return nil
function library.economy.setOverflow(name, policy) end

--- Return the group tag of a named resource.
---@param name string
---@return string
function library.economy.getGroup(name) end

--- Set the group tag of a named resource.
---@param name string
---@param g string
---@return nil
function library.economy.setGroup(name, g) end

--- Return whether tick processing is enabled for a named resource.
---@param name string
---@return boolean
function library.economy.isEnabled(name) end

--- Enable or disable tick processing for a named resource.
---@param name string
---@param v boolean
---@return nil
function library.economy.setEnabled(name, v) end

--- Return the UI visibility hint of a named resource.
---@param name string
---@return boolean
function library.economy.isVisible(name) end

--- Set the UI visibility hint of a named resource.
---@param name string
---@param v boolean
---@return nil
function library.economy.setVisible(name, v) end

--- Return whether a named resource is locked against modifications.
---@param name string
---@return boolean
function library.economy.isLocked(name) end

--- Lock or unlock add/spend for a named resource.
---@param name string
---@param v boolean
---@return nil
function library.economy.setLocked(name, v) end

--- Add an amount to a named resource. Returns excess that did not fit.
---@param name string
---@param amount number
---@return number
function library.economy.add(name, amount) end

--- Spend an amount from a named resource. Returns true on success.
---@param name string
---@param amount number
---@return boolean
function library.economy.spend(name, amount) end

--- Return true if the named resource has enough available funds.
---@param name string
---@param amount number
---@return boolean
function library.economy.canAfford(name, amount) end

--- Return the available amount (value - reserved) of a named resource.
---@param name string
---@return number
function library.economy.getAvailable(name) end

--- Increase the reservation on a named resource.
---@param name string
---@param amount number
---@return nil
function library.economy.reserveAmount(name, amount) end

--- Decrease the reservation on a named resource (floored at 0).
---@param name string
---@param amount number
---@return nil
function library.economy.unreserveAmount(name, amount) end

--- Return the reserved amount of a named resource.
---@param name string
---@return number
function library.economy.getReserved(name) end
...
---@return string
function library.inventory.getType() end

--- Return item weight.
---@return number
function library.inventory.getWeight() end

--- Set physical weight (must be non-negative).
---@param w number
---@return nil
function library.inventory.setWeight(w) end

--- Return grid width.
---@return number
function library.inventory.getSizeW() end

--- Return grid height.
---@return number
function library.inventory.getSizeH() end

--- Set grid size (both dimensions clamped to >= 1).
---@param w number
---@param h number
---@return nil
function library.inventory.setSize(w, h) end

--- Return maximum items per stack.
---@return number
function library.inventory.getStackLimit() end

--- Set maximum stack size (clamped to >= 1).
---@param n number
---@return nil
function library.inventory.setStackLimit(n) end

--- Return true if the item has the given tag.
---@param tag string
---@return boolean
function library.inventory.hasTag(tag) end

--- Add a tag (no-op if already present).
---@param tag string
---@return nil
function library.inventory.addTag(tag) end

--- Remove a tag. Returns true if tag existed.
---@param tag string
---@return boolean
function library.inventory.removeTag(tag) end

--- Return all tag names as an array.
---@return table
function library.inventory.getTags() end

--- Set a generic property.
---@param key string
---@param val any
---@return nil
function library.inventory.setProperty(key, val) end

--- Get a generic property.
---@param key string
---@return any
function library.inventory.getProperty(key) end
...
---@return table
function library.inventory.clone() end
...
---@return table
function library.inventory.getItem() end

--- Return current quantity.
---@return number
function library.inventory.getQuantity() end

--- Directly set quantity (clamped 0..max).
---@param n number
---@return nil
function library.inventory.setQuantity(n) end
...
---@return string
function library.inventory.getSlotType() end

--- Return current state.
---@return string
function library.inventory.getState() end

--- Set state.
---@param s string
---@return nil
function library.inventory.setState(s) end
...
---@return table|nil
function library.inventory.getStack() end
...
---@param item table
---@return boolean
function library.inventory.canAccept(item) end

--- Place an ItemStack. Returns false if item not accepted.
---@param s table
---@return boolean
function library.inventory.setStack(s) end

--- Remove and return the held stack.
---@return table|nil
function library.inventory.takeStack() end

--- Clear the slot.
---@return nil
function library.inventory.clear() end
...
---@return string
function library.inventory.getName() end

--- Return the container mode string.
---@return string
function library.inventory.getMode() end

--- Return the number of slots.
---@return number
function library.inventory.slotCount() end

--- Return max slot count. 0 = unbounded.
---@return number
function library.inventory.getCapacity() end

--- Set weight limit (must be non-negative). 0 = unlimited.
---@param w number
---@return nil
function library.inventory.setWeightLimit(w) end

--- Return weight limit. 0 = unlimited.
---@return number
function library.inventory.getWeightLimit() end

--- Return current total weight.
---@return number
function library.inventory.getCurrentWeight() end

--- Alias for getCurrentWeight.
---@return number
function library.inventory.totalWeight() end
...
---@param idx number
---@return table|nil
function library.inventory.getSlot(idx) end

--- Return all slots array.
---@return table
function library.inventory.getSlots() end

--- Add slot (respects mode limits).
---@param sl table
---@return nil
function library.inventory.addSlot(sl) end

--- Set the upper slot capacity (expandable mode only). Clamped so it cannot be less than the current slot count.
---@param n number
---@return nil
function library.inventory.setCapacity(n) end
...
---@param n number
---@return boolean
function library.inventory.expand(n) end
...
---@param quantity number
---@return boolean
function library.inventory.addItem(inv_item, quantity) end

--- Count all items of a given type across all slots.
---@param type_name string
---@return number
function library.inventory.countItem(type_name) end

--- Return true if >= qty of type_name present.
---@param type_name string
---@param qty number
---@return boolean
function library.inventory.hasItem(type_name, qty) end

--- Remove up to qty items of type_name. Returns count removed.
---@param type_name string
---@param qty number
---@return number
function library.inventory.removeItem(type_name, qty) end

--- Return all items with the given tag.
---@param tag string
---@return table
function library.inventory.findByTag(tag) end

--- Return a summary list of {type_name, quantity} aggregated across slots.
---@return table
function library.inventory.toItemList() end

--- Remove the slot at a 1-based index. Shifts subsequent slots down.
---@param idx number
---@return boolean
function library.inventory.removeSlot(idx) end
...
---@return nil
function library.inventory.addRequirement(tag, slot_filter) end

--- Return all requirements as array of {tag, slot_filter}.
---@return table
function library.inventory.getRequirements() end

--- Check if all requirements are satisfied given an equip_slots table {name -> Slot}.
---@param equip_slots table
---@return boolean
function library.inventory.isSatisfied(equip_slots) end
...
---@return table|nil
function library.inventory.getEventBus() end

--- Register a container. Replaces any existing container with the same name.
---@param name string
---@param container table
---@return nil
function library.inventory.addContainer(name, container) end

--- Get a container by name.
---@param name string
---@return table|nil
function library.inventory.getContainer(name) end

--- Remove a container. Returns true if it existed.
---@param name string
---@return boolean
function library.inventory.removeContainer(name) end

--- Return container names in insertion order.
---@return table
function library.inventory.containerNames() end

--- Add or replace a named equip slot.
---@param name string
---@param slot table
---@return nil
function library.inventory.addEquipSlot(name, slot) end

--- Get an equip slot by name.
---@param name string
---@return table|nil
function library.inventory.getEquipSlot(name) end

--- Remove an equip slot. Returns true if it existed.
---@param name string
---@return boolean
function library.inventory.removeEquipSlot(name) end

--- Return equip slot names in insertion order.
---@return table
function library.inventory.equipSlotNames() end

--- Equip an ItemStack into the named slot. Returns false if slot missing or item rejected.
---@param slot_name string
---@param stack table
---@return boolean
function library.inventory.equip(slot_name, stack) end

--- Unequip a slot and return its InvItem (not the full stack). Returns nil if empty.
---@param slot_name string
---@return table|nil
function library.inventory.unequip(slot_name) end

--- Register an item set.
---@param iset table
---@return nil
function library.inventory.addItemSet(iset) end

--- Return all registered item sets.
---@return table
function library.inventory.getItemSets() end

--- Return only the currently active item sets (all requirements met).
---@return table
function library.inventory.getActiveSets() end

--- Enable a named subsystem ("weight", "size", "stacking", "sets").
---@param name string
---@return nil
function library.inventory.enableSubsystem(name) end

--- Disable a named subsystem.
---@param name string
---@return nil
function library.inventory.disableSubsystem(name) end

--- Return true if the named subsystem is active.
---@param name string
---@return boolean
function library.inventory.isSubsystemEnabled(name) end
...
---@param qty number
---@return boolean
function library.inventory.removeFromAny(type_name, qty) end
...
---@param to_idx number
---@return boolean
function library.inventory.transfer(from_name, from_idx, to_name, to_idx) end
...
---@param quantity number
---@return boolean
function library.inventory.splitStack(container_name, slot_idx, quantity) end
...
---@return boolean
function library.inventory.mergeStacks(container_name, from_slot, to_slot) end
...
---@param slot_b number
---@return boolean
function library.inventory.swap(container_a, slot_a, container_b, slot_b) end
...
--- Return the type name.
---@return string
function library.item.getType() end

--- Return the category from the type registry.
---@return string
function library.item.getCategory() end

--- Return the value of a stat, or nil if not set.
---@param key string
---@return number|nil
function library.item.getStat(key) end

--- Set or override a stat value.
---@param key string
---@param val number
---@return nil
function library.item.setStat(key, val) end

--- Add delta to an existing stat (creates stat at delta if absent).
---@param key string
---@param delta number
---@return nil
function library.item.addStat(key, delta) end

--- Remove a stat entirely.
---@param key string
---@return nil
function library.item.removeStat(key) end

--- Return all current stats as a shallow copy.
---@return table
function library.item.getStats() end

--- Return true if this item has the given tag.
---@param tag string
---@return boolean
function library.item.hasTag(tag) end

--- Add a tag (no-op if already present).
---@param tag string
---@return nil
function library.item.addTag(tag) end

--- Remove a tag. Returns true if tag existed.
---@param tag string
---@return boolean
function library.item.removeTag(tag) end

--- Return all tag names as a sorted array.
---@return table
function library.item.getTags() end

--- Set a metadata value.
---@param key string
---@param val any
---@return nil
function library.item.setMeta(key, val) end

--- Get a metadata value, or nil.
---@param key string
---@return any
function library.item.getMeta(key) end

--- Set the owner reference.
---@param owner any
---@return nil
function library.item.setOwner(owner) end

--- Return the owner reference.
---@return any
function library.item.getOwner() end

--- Return the display name (seeds from type def; may differ from type name).
---@return string
function library.item.getName() end

--- Set the display name.
---@param n string
---@return nil
function library.item.setName(n) end

--- Return the current slot/position name.
---@return string
function library.item.getSlot() end

--- Set the slot/position name.
---@param s string
---@return nil
function library.item.setSlot(s) end

--- Get a named integer counter (0 if not set).
---@param key string
---@return number
function library.item.getCounter(key) end

--- Set a named integer counter.
---@param key string
---@param val number
---@return nil
function library.item.setCounter(key, val) end

--- Add delta to a named counter and return the new value.
---@param key string
---@param delta number
---@return number
function library.item.addCounter(key, delta) end

--- Remove a named counter entry.
---@param key string
---@return nil
function library.item.removeCounter(key) end

--- Return all counters as a shallow copy.
---@return table
function library.item.getCounters() end
...
---@return table
function library.item.clone() end
...
---@return nil
function library.item.shuffle() end

--- Return the type names of the top n items (without removing).
---@param n number
---@return table
function library.item.peekTopNTypes(n) end
...
---@param n number
---@return table
function library.item.drawUniqueTypes(n) end
...
---@param count number
---@return nil
function library.item.add(type_name, count) end
...
---@param extra_tags table
---@return nil
function library.item.addWith(type_name, count, stat_overrides, extra_tags) end

--- Enable or disable Fisher-Yates shuffle after build.
---@param enabled boolean
---@return nil
function library.item.setShuffleOnBuild(enabled) end

--- Require that a specific type appears at least once.
---@param type_name string
---@return nil
function library.item.requireType(type_name) end

--- Ban a specific type from appearing.
---@param type_name string
---@return nil
function library.item.banType(type_name) end

--- Remove a ban on a type.
---@param type_name string
---@return nil
function library.item.removeBannedType(type_name) end

--- Build the stack from recipe entries plus addWith items. Applies shuffleOnBuild if enabled.
---@param name string
---@return table
function library.item.build(name) end
...
---@param size_after number
---@return nil
function library.item.recordPush(source, item_type, size_after) end
...
---@param size_after number
---@return nil
function library.item.recordPop(source, item_type, size_after) end

--- Record a clear action.
---@param source string
---@return nil
function library.item.recordClear(source) end
...
--- Return number of entries.
---@return number
function library.item.count() end
...
--- Return the most recent entry, or nil if empty.
---@return table|nil
function library.item.last() end

--- Return all entries matching a specific source name.
---@param source string
---@return table
function library.item.entriesFor(source) end
...
---@param stack table
---@return nil
function library.item.addStack(name, stack) end

--- Retrieve a stack by name.
---@param name string
---@return table|nil
function library.item.getStack(name) end

--- Remove a stack. Returns true if existed.
---@param name string
---@return boolean
function library.item.removeStack(name) end

--- Return all registered stack names.
---@return table
function library.item.keys() end

--- Return true if a stack with this name exists.
---@param name string
---@return boolean
function library.item.hasStack(name) end

--- Create and register a new empty unlimited stack.
---@param name string
---@return nil
function library.item.createStack(name) end

--- Create and register a new empty stack with a capacity limit.
---@param name string
---@param capacity number
---@return nil
function library.item.createStackCapped(name, capacity) end

--- Return total number of items across all stacks.
---@return number
function library.item.totalItems() end
...
---@return table|nil
---@return string|nil
function library.item.moveItem(from, index, to) end
...
---@return table|nil
---@return string|nil
function library.item.moveItemByType(from, item_type, to) end
...
---@return table|nil
---@return string|nil
function library.item.moveTop(from, to) end
...
---@param index number
---@return table|nil
function library.item.removeAt(index) end
...
---@param index number
---@return table|nil
function library.item.peekAt(index) end
...
---@return table
function library.item.items() end

--- Return true if any item has the given tag.
---@param tag string
---@return boolean
function library.item.hasItemWithTag(tag) end

--- Return true if any item is of the given type.
---@param item_type string
---@return boolean
function library.item.hasItemOfType(item_type) end
...
---@return userdata|nil
function library.lobby.getEventBus() end

--- Set the local player name used when joining rooms.
---@param name string
---@return nil
function library.lobby.setPlayerName(name) end
...
---@param fn function
---@return nil
function library.lobby.onEvent(fn) end
...
---@return boolean
---@return string|nil
function library.lobby.createRoom(name, opts) end

--- Remove a room (server-side).  All players in the room are evicted.
---@param name string
---@return nil
function library.lobby.removeRoom(name) end
...
---@return boolean
---@return string|nil
function library.lobby.joinRoom(name, peer_id, player_name, password) end
...
---@return boolean
---@return string|nil
function library.lobby.leaveRoom(peer_id) end

--- List all available rooms.
---@return table
function library.lobby.listRooms() end

--- Get players in a specific room (or current room if name is nil).
---@param name string
---@return table
function library.lobby.getPlayers(name) end
...
---@param peer_id number
---@return nil
function library.lobby.setReady(ready, peer_id) end
...
---@return string|nil
function library.lobby.getCurrentRoom() end

--- Get the host peer_id for a room (or the local player's room).
---@param name string
---@return number|nil
function library.lobby.getHost(name) end

--- Get the number of rooms.
---@return number
function library.lobby.getRoomCount() end

--- Process incoming lobby network messages.  Call once per frame.
---@return table
function library.lobby.poll() end
...
---@param events table
---@return nil
function library.lobby._handle(peer_id, data, events) end
...
---@param meta table?
---@return LootTable
function library.loot.add(id, weight, meta) end

--- Remove an entry by id.
---@param id string
---@return boolean
function library.loot.remove(id) end

--- Adjust an entry's weight (rebuilds alias on next sample).
---@param id string
---@param w number
---@return LootTable
function library.loot.setWeight(id, w) end

--- O(1) sample one entry from the alias table.
---@param rng userdata|table?
---@return string
---@return table?
function library.loot.sample(rng) end
...
---@param opts table?
---@return table
function library.loot.sampleN(n, rng, opts) end

--- Current weight of an entry.
---@param id string
---@return number
function library.loot.weightOf(id) end

--- Total weight of all entries.
---@return number
function library.loot.totalWeight() end

--- Normalised probability of an entry (0..1).
---@param id string
---@return number
function library.loot.probability(id) end

--- Snapshot of all entry ids.
---@return table
function library.loot.ids() end

--- Deep-copy this table.
---@return LootTable
function library.loot.clone() end
...
---@param opts table?
---@return DropSet
function library.loot.roll(tbl, opts) end

--- Always emit `id × count`.
---@param id string
---@param count integer?
---@return DropSet
function library.loot.guarantee(id, count) end
...
---@return boolean
function library.loot.notice(result_id) end

--- Reset the pity counter to 0.
---@return nil
function library.loot.reset() end

--- Current miss counter.
---@return integer
function library.loot.getCounter() end

--- True when pity will fire on the next draw.
---@return boolean
function library.loot.isPrimed() end

--- Serialise to a save blob.
---@return table
function library.loot.save() end

--- Restore from a save blob.
---@param blob table
---@return Pity
function library.loot.restore(blob) end
...
---@param fn function
---@return Modifier
function library.loot.add(name, fn) end

--- Produce a temporary LootTable with adjusted weights. Original is untouched.
---@param tbl LootTable
---@param context table
---@return LootTable
function library.loot.apply(tbl, context) end
...
---@param knot string?
---@return Story
function library.narrative.start(knot) end

--- True while there is more prose to emit before the next choice or end.
---@return boolean
function library.narrative.canContinue() end

--- True when the playhead is at a choice point.
---@return nil
function library.narrative.isAtChoice() end

--- True when the story has reached `-> END`.
---@return nil
function library.narrative.isEnded() end

--- Emit the next prose line; returns nil at choice points or end. Also returns the tag list attached to the line.
---@return string?,
function library.narrative.continue() end

--- Drain prose until a choice or end, returning the joined string.
---@param sep string?
---@return string
function library.narrative.continueAll(sep) end

--- Get the current pending choice list.
---@return table
function library.narrative.getChoices() end

--- Select a choice by 1-based index. Raises if not available.
---@param index integer
---@return Story
function library.narrative.choose(index) end

--- Set a variable.
---@return nil
function library.narrative.setVar(name, value) end

--- Get a variable.
---@return nil
function library.narrative.getVar(name) end

--- Snapshot of all variables (shallow copy).
---@return nil
function library.narrative.listVars() end

--- Bind a Lua function callable from inside `{name(arg)}` markers.
---@return nil
function library.narrative.bindFunction(name, fn) end

--- Register a tag handler. Returns an opaque handle for `offTag`.
---@return nil
function library.narrative.onTag(tag, fn) end

--- Remove a previously registered tag handler.
---@return nil
function library.narrative.offTag(handle) end

--- Register a variable-change handler.
---@return nil
function library.narrative.onVarChange(name, fn) end

--- Jump to a knot. Records the visit and turn counter.
---@return nil
function library.narrative.gotoKnot(name) end

--- Visit count of a knot.
---@return nil
function library.narrative.visit(knot) end

--- Turns since a knot was last visited (math.huge if never).
---@return nil
function library.narrative.turnsSince(knot) end

--- Toggle trace logging via `lurek.log.debug` (requires it to be available).
---@return nil
function library.narrative.trace(enable) end

--- Profile the current story state (visits + var counts).
---@return nil
function library.narrative.dumpProfile() end

--- Serialise full state (vars, visits, knot, pc) for `lurek.save`.
---@return nil
function library.narrative.save() end

--- Restore from a save blob.
---@return nil
function library.narrative.resume(state) end
...
---@param auth boolean
---@return nil
function library.netstate.setAuthority(auth) end

--- Check if this instance is the authority.
---@return boolean
function library.netstate.isAuthority() end

--- Set a global change callback fired for any key change.
---@param fn function
---@return nil
function library.netstate.onChange(fn) end
...
---@param fn function
---@return nil
function library.netstate.onFullStateTimeout(fn) end
...
---@return boolean
---@return string|nil
function library.netstate.set(key, value) end

--- Get the current value of a synced key.
---@param key string
---@return any|nil
function library.netstate.get(key) end

--- Get the per-key version number.
---@param key string
---@return number
function library.netstate.getKeyVersion(key) end

--- Get all synced state as a flat table.
---@return table
function library.netstate.getAll() end

--- Register a callback for changes to a specific key.
---@param key string
---@param fn function
---@return nil
function library.netstate.onChanged(key, fn) end

--- Remove all callbacks for a key.
---@param key string
---@return nil
function library.netstate.clearCallbacks(key) end

--- Get the highest version number across all keys.
---@return number
function library.netstate.getVersion() end

--- Get the number of synced keys.
---@return number
function library.netstate.getKeyCount() end

--- Get the number of dirty (unsent) keys.
---@return number
function library.netstate.getDirtyCount() end

--- Check if a key exists in the state.
---@param key string
---@return boolean
function library.netstate.hasKey(key) end

--- Remove a key from the synced state. Authority only.
---@param key string
---@return boolean
---@return string|nil
function library.netstate.remove(key) end
...
---@param order table
---@return nil
function library.netstate.setTurnOrder(order) end
...
---@return number
---@return number|nil
function library.netstate.beginTurn() end

--- End the current turn. Alias for `beginTurn()` — advances to next.
---@return number
---@return number|nil
function library.netstate.endTurn() end

--- Get the current turn number.
---@return number
function library.netstate.getCurrentTurn() end

--- Get the peer ID whose turn it currently is.
---@return number|nil
function library.netstate.getTurnPeer() end

--- Register a callback for turn changes.
---@param fn function
---@return nil
function library.netstate.onTurn(fn) end

--- Check if it is a specific peer's turn.
---@param peer_id number
---@return boolean
function library.netstate.isTurn(peer_id) end
...
---@return nil
function library.netstate.sync() end
...
---@return table
function library.netstate.poll() end

--- Mark a key as dirty, respecting the maxDirtyKeys limit.
---@param key string
---@return nil
function library.netstate._markDirty(key) end
...
---@return number
function library.netstate.hashState() end
...
---@return string|nil
function library.netstate.toJson() end
...
---@param f string|nil
---@return nil
function library.province_map.setFaction(f) end

--- Get the controlling faction.
---@return string|nil
function library.province_map.getFaction() end

--- Set the defense rating (0–100).
---@param v number
---@return nil
function library.province_map.setDefenseRating(v) end

--- Get the defense rating.
---@return number
function library.province_map.getDefenseRating() end

--- Add a building to this province.
---@param building string
---@return nil
function library.province_map.addBuilding(b) end

--- Get all buildings.
---@return table
function library.province_map.getBuildings() end

--- Return true if the province has the given building.
---@param b string
---@return boolean
function library.province_map.hasBuilding(b) end

--- Remove a building by name. Returns true if removed.
---@param b string
---@return boolean
function library.province_map.removeBuilding(b) end

--- Set a produced resource amount.
---@param res string
---@param amount number
---@return nil
function library.province_map.setResource(res, amount) end

--- Get a produced resource amount (0 if not set).
---@param res string
---@return number
function library.province_map.getResource(res) end

--- Get the full resource table.
---@return table
function library.province_map.getResources() end
...
---@return number
function library.province_map.width() end

--- Return the map height in pixels.
---@return number
function library.province_map.height() end

--- Insert or replace a province.
---@param province Province
---@return nil
function library.province_map.insertProvince(province) end

--- Remove a province by ID. Returns true if it existed.
---@param id number
---@return boolean
function library.province_map.removeProvince(id) end

--- Look up a province by ID.
---@param id number
---@return Province|nil
function library.province_map.getProvince(id) end

--- Return the total number of provinces.
---@return number
function library.province_map.provinceCount() end

--- Return a sorted list of all province IDs.
---@return table
function library.province_map.provinceIds() end
...
---@return nil
function library.province_map.setPixel(x, y, province_id) end

--- Return the province ID at pixel (x, y). Coordinates are 0-based.  Returns nil for out-of-bounds queries.
---@param x number
---@param y number
---@return number|nil
function library.province_map.getProvinceAt(x, y) end
...
---@param edge table
---@return nil
function library.province_map.insertAdjacency(edge) end

--- Remove an adjacency edge. Returns true if removed.
---@param a number
---@param b number
---@return boolean
function library.province_map.removeAdjacency(a, b) end

--- Get the adjacency edge between two provinces.
---@param a number
---@param b number
---@return table|nil
function library.province_map.getAdjacency(a, b) end

--- Return the total number of adjacency edges.
---@return number
function library.province_map.adjacencyCount() end

--- Return a sorted list of neighbour province IDs for the given province.
---@param id number
---@return table
function library.province_map.getNeighbors(id) end
...
---@param tags table
---@return table
function library.province_map.setAdjacent(a, b, tags) end

--- Euclidean centroid distance between two provinces.
---@param a number
---@param b number
---@return number
function library.province_map.distance(a, b) end

--- Return the raw pixel-lookup table.
---@return table
function library.province_map.pixelLookup() end
...
---@return table|nil
function library.province_map.findRoute(from_id, to_id, passable_fn) end

--- Return all province IDs controlled by the given faction.
---@param faction string
---@return table
function library.province_map.getProvincesByFaction(faction) end

--- Sum a resource across all provinces belonging to a faction.
---@param faction string
---@param resource string
---@return number
function library.province_map.totalResourceForFaction(faction, resource) end

--- Get all provinces whose faction field is nil (uncontrolled).
---@return table
function library.province_map.getUncontrolledProvinces() end

--- Get all provinces with no adjacency edges (isolated islands).
---@return table
function library.province_map.findIsolatedProvinces() end

--- Get connected components (list of lists of province IDs).
---@return table
function library.province_map.getConnectedComponents() end
...
---@param count number
---@return nil
function library.province_map.emitMapLoaded(count) end

--- Emit a province-added event.
---@param id number
---@return nil
function library.province_map.emitProvinceAdded(id) end

--- Emit a province-removed event.
---@param id number
---@return nil
function library.province_map.emitProvinceRemoved(id) end

--- Emit adjacency-detected with edge count.
---@param edge_count number
---@return nil
function library.province_map.emitAdjacencyDetected(edge_count) end

--- Emit adjacency-changed for two provinces.
---@param a number
---@param b number
---@return nil
function library.province_map.emitAdjacencyChanged(a, b) end

--- Emit adjacency-removed for two provinces.
---@param a number
---@param b number
---@return nil
function library.province_map.emitAdjacencyRemoved(a, b) end

--- Emit borders-extracted with segment count.
---@param count number
---@return nil
function library.province_map.emitBordersExtracted(count) end

--- Emit map-mode-applied with mode name.
---@param name string
---@return nil
function library.province_map.emitMapModeApplied(name) end

--- Emit positions-calculated with province count.
---@param count number
---@return nil
function library.province_map.emitPositionsCalculated(count) end
...
---@param y number
---@return nil
function library.province_map.emitProvinceSelected(id, x, y) end

--- Emit province-deselected.
---@param id number
---@return nil
function library.province_map.emitProvinceDeselected(id) end
...
---@param y number
---@return nil
function library.province_map.emitProvinceHovered(id, x, y) end
...
---@return nil
function library.province_map.emitFactionChanged(id, old_faction, new_faction) end

--- Poll one event from the queue. Returns nil when empty.
---@return table|nil
function library.province_map.poll() end

--- Return true if no events are queued.
---@return boolean
function library.province_map.isEmpty() end

--- Drain and return all queued events.
---@return table
function library.province_map.drain() end

--- Return the number of queued events.
---@return number
function library.province_map.size() end
...
---@param amount number
---@return number
function library.quest.advance(amount) end

--- Set progress directly. Clamps to [0, required].
---@param value number
---@return nil
function library.quest.setProgress(value) end

--- Returns true if this objective is considered complete (done or skipped).
---@return boolean
function library.quest.isComplete() end

--- Add a tag. Has no effect if already present.
---@param tag string
---@return nil
function library.quest.addTag(tag) end

--- Returns true if the given tag is present.
---@param tag string
---@return boolean
function library.quest.hasTag(tag) end
...
---@param obj Objective
---@return nil
function library.quest.addObjective(obj) end

--- Get an objective by id.
---@param id string
---@return Objective|nil
function library.quest.getObjective(id) end

--- Get all objectives in this stage.
---@return table
function library.quest.getObjectives() end

--- Return the number of objectives in this stage.
---@return number
function library.quest.objectiveCount() end

--- Remove all objectives from this stage.
---@return nil
function library.quest.clearObjectives() end

--- Returns true if this stage contains an objective with the given id.
---@param id string
---@return boolean
function library.quest.hasObjective(id) end
...
---@param tag string
---@return number
function library.quest.addJournalEntry(text, tag) end

--- Set a metadata key-value pair.
---@param key string
---@param value string
---@return nil
function library.quest.setMeta(key, value) end

--- Get a metadata value by key.
---@param key string
---@return string|nil
function library.quest.getMeta(key) end
...
---@param bus table|nil
---@return nil
function library.quest.setEventBus(bus) end

--- Get the currently attached event bus (nil when none).
---@return table|nil
function library.quest.getEventBus() end

--- Register a quest. If a quest with the same id already exists, it is replaced.
---@param quest Quest
---@return nil
function library.quest.addQuest(quest) end

--- Get a quest by id.
---@param id string
---@return Quest|nil
function library.quest.getQuest(id) end

--- Remove a quest by id. Returns true if removed, false if not found.
---@param id string
---@return boolean
function library.quest.removeQuest(id) end

--- List ids of all quests in insertion order.
---@return table
function library.quest.questIds() end

--- List ids of all quests with the given status.
---@param status string
---@return table
function library.quest.questsWithStatus(status) end

--- Total number of registered quests.
---@return number
function library.quest.questCount() end
...
---@param id string
---@return boolean
function library.quest.startQuest(id) end
...
---@param id string
---@return boolean
function library.quest.completeQuest(id) end
...
---@param id string
---@return boolean
function library.quest.failQuest(id) end

--- IDs of all active quests.
---@return table
function library.quest.activeIds() end

--- IDs of all completed quests.
---@return table
function library.quest.completedIds() end

--- IDs of all failed quests.
---@return table
function library.quest.failedIds() end
...
---@param stage_id string
---@return boolean
function library.quest.advanceObjective(quest_id, obj_id, amount, stage_id) end

--- Reset a quest back to "available" with the first stage active and all objective progress cleared to zero.
---@param id string
---@return boolean
function library.quest.resetQuest(id) end

--- Set the reward description string on a quest.
---@param id string
---@param reward string
---@return nil
function library.quest.setQuestReward(id, reward) end

--- Get the reward description of a quest.
---@param id string
---@return string
function library.quest.getQuestReward(id) end

--- Count active quests (status == "in_progress").
---@return number
function library.quest.activeCount() end

--- Count completed quests.
---@return number
function library.quest.completedCount() end

--- Remove a tag from this objective. Returns true if the tag was present.
---@param tag string
---@return boolean
function library.quest.removeTag(tag) end
...
---@return nil
function library.roguelike.next() end

--- Peek at the next actor without consuming a turn.
---@return nil
function library.roguelike.peek() end
...
---@return nil
function library.roguelike.gradientAt(x, y) end

--- Unit step away from goals, scaled by `fear` (default 1.2).
---@return nil
function library.roguelike.flee(x, y, fear) end
...
---@param enabled boolean
---@return nil
function library.rpc.setLogging(enabled) end

--- Register a function callable from remote peers.
---@param name string
---@param fn function
---@return nil
function library.rpc.register(name, fn) end

--- Unregister a previously registered function.
---@param name string
---@return nil
function library.rpc.unregister(name) end
...
---@param fn function
---@return nil
function library.rpc.onError(fn) end
...
---@param ... Arguments
---@return number
function library.rpc.call(peer_id, name, callback, ...) end
...
---@param ... Arguments
---@return nil
function library.rpc.notify(peer_id, name, ...) end
...
---@param ... Arguments
---@return nil
function library.rpc.broadcast(name, ...) end
...
---@return nil
function library.rpc.resetIdCounter() end

--- Get the current request ID counter value.
---@return number
function library.rpc.getNextId() end

--- Get the number of pending (unresolved) RPC calls.
---@return number
function library.rpc.getPendingCount() end

--- Set the timeout for future pending calls (seconds). 0 = no timeout.
---@param seconds number
---@return nil
function library.rpc.setTimeout(seconds) end
...
---@return table
function library.rpc.poll() end

--- Internal: expire pending calls that have exceeded their timeout.
---@return nil
function library.rpc._expireTimeouts() end
...
---@return nil
function library.rpc._dispatch(peer_id, data, responses) end

--- Get the number of registered RPC handlers.
---@return number
function library.rpc.getHandlerCount() end
...
---@param opts table
---@param opts.max_iterations number
---@return Scheduler
...
---@param name string
---@return number
function library.scheduler.add(fn, name) end

--- Remove a task by id.
---@param id number
---@return boolean
function library.scheduler.remove(id) end

--- Pause a task by id.  Paused tasks keep their remaining wait time but are not ticked until resumed.
---@param id number
---@return nil
function library.scheduler.pause(id) end

--- Resume a paused task by id.
---@param id number
---@return nil
function library.scheduler.resume(id) end

--- Return the status of a task.
---@param id number
---@return string|nil
---@return string|nil
function library.scheduler.getStatus(id) end
...
---@return boolean
function library.stats.isExpired() end
...
---@param level number
---@return number
function library.stats.thresholdFor(level) end
...
---@param opts table|nil
---@return nil
function library.stats.define(name, base, opts) end

--- Get effective value (base * multipliers + additive, clamped).
---@param name string
---@return number|nil
function library.stats.get(name) end

--- Get raw base value.
---@return nil
function library.stats.getBase(name) end

--- Set base value (clamped to min/max).
---@return nil
function library.stats.setBase(name, value) end

--- Set the minimum clamp value for an attribute.
---@param name string
---@param val number
---@return nil
function library.stats.setMin(name, val) end

--- Set the maximum clamp value for an attribute.
---@param name string
---@param val number
---@return nil
function library.stats.setMax(name, val) end

--- Get the current minimum clamp for an attribute.
---@param name string
---@return number|nil
function library.stats.getMin(name) end

--- Get the current maximum clamp for an attribute.
---@param name string
---@return number|nil
function library.stats.getMax(name) end

--- Set the regeneration rate for an attribute.
---@param name string
---@param val number
---@return nil
function library.stats.setRegen(name, val) end

--- Get the regeneration rate for an attribute.
---@param name string
---@return number|nil
function library.stats.getRegen(name) end

--- Get all defined attribute names.
---@return nil
function library.stats.getStatNames() end
...
---@return number|nil
function library.stats.addBuff(stat, add, mul, duration, source, stack_mode) end

--- Remove a buff by its numeric handle.
---@param handle number
---@return boolean
function library.stats.removeBuff(handle) end

--- Remove all active buffs, or only those affecting a specific attribute.
---@param stat string|nil
---@return nil
function library.stats.clearBuffs(stat) end
