...
> **Status**: 🔴 FAIL  |  **Date**: 2026-04-12  |  **Score**: 37 ✅ / 3 ⚠️ / 1 ❌ / 19 🔵
...
- [ ] **B-04** — No business logic in closures: '<closure@803>' (26 LOC, line 803) — extract body to src/docs/ | '<closure@837>' (38 LOC, line 837) — extract body to src/docs/ | '<closure@884>' (27 LOC, line 884) — extract body to src/docs/ | '<closure@920>' (21 LOC, line 920) — extract body to src/docs/ | '<closure@1129>' has if/match/for — extract to src/docs/ | '<closure@1146>' has if/match/for — extract to src/docs/
...
|-------|---------|---------|
| **S-01** lib.rs registration | ✅ PASS | Registered in lib.rs + lua_api (docs_api) |
...
| **B-04** No business logic in closures | ⚠️ WARNING | '<closure@803>' (26 LOC, line 803) — extract body to src/docs/ \| '<closure@837>' (38 LOC, line 837) — extract body to src/docs/ \| '<closure@884>' (27 LOC, line 884) — extract body to src/docs/ \| '<closure@920>' (21 LOC, line 920) — extract body to src/docs/ \| '<closure@1129>' has if/match/for — extract to src/docs/ \| '<closure@1146>' has if/match/for — extract to src/docs/ |
...
```powershell
python tools/audit/audit_module.py docs --docs-quality
```
