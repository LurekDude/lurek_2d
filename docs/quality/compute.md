...
- [ ] **R-02** — Dependency direction: array: Foundations imports runtime(Core Runtime)

### 🟡 Warnings — Should Fix

- [ ] **B-04** — No business logic in closures: '<closure@734>' has if/match/for — extract to src/compute/
...
| **B-04** No business logic in closures | ⚠️ WARNING | '<closure@734>' has if/match/for — extract to src/compute/ |
...
| **R-02** Dependency direction | ❌ ERROR | array: Foundations imports runtime(Core Runtime) |
