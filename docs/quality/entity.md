...
|-------|---------|---------|
| **S-01** lib.rs registration | ✅ PASS | Registered in lib.rs + lua_api (entity_api) |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **T-01** Rust test file | ✅ PASS | Found: tests\rust\unit\entity_tests.rs |
...
```powershell
python tools/audit/audit_module.py entity --docs-quality
```
