...
| Check | Verdict | Details |
|-------|---------|---------|
| **W-01** Example file exists | ✅ PASS | examples/automation.lua present |
| **W-02** API surface coverage | ✅ PASS | All 17 bound functions in example |
| **W-03** Example comments | 🔵 MANUAL | Verify examples/automation.lua has realistic one-line comments per call |
