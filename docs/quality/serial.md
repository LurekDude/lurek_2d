...
| Check | Verdict | Details |
|-------|---------|---------|
| **W-01** Example file exists | ✅ PASS | examples/serial.lua present |
| **W-02** API surface coverage | ✅ PASS | All 6 bound functions in example |
| **W-03** Example comments | 🔵 MANUAL | Verify examples/serial.lua has realistic one-line comments per call |
