...
- [ ] **T-01** — Rust test file: No test file found for module 'save'
- [ ] **T-02** — Lua test file: Module has Lua API but no tests/lua/unit/test_save.lua
- [ ] **W-01** — Example file exists: content/examples/save.lua not found — create it
- [ ] **W-02** — API surface coverage: Skipped — no example file

### 🟡 Warnings — Should Fix

- [ ] **R-01** — Tier placement: Module not in tier registry — verify placement
- [ ] **T-05** — Test adequacy: 35 pub methods, 0 Rust tests — create test file
- [ ] **W-05** — Wiki page: No wiki page found (expected docs/wiki/Save-API.md)
...
|-------|---------|---------|
| **S-01** lib.rs registration | ✅ PASS | Registered in lib.rs + lua_api (save_api) |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **SP-01** Spec file exists | ✅ PASS | docs/specs/save.md exists |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **B-01** Dedicated API file | ✅ PASS | lua_api/save_api.rs present |
...
| Check | Verdict | Details |
|-------|---------|---------|
| **T-01** Rust test file | ❌ ERROR | No test file found for module 'save' |
| **T-02** Lua test file | ❌ ERROR | Module has Lua API but no tests/lua/unit/test_save.lua |
| **T-03** Test naming | ✅ PASS | No Rust test file — skip |
| **T-04** Float comparisons | ✅ PASS | No Rust test file — skip |
| **T-05** Test adequacy | ⚠️ WARNING | 35 pub methods, 0 Rust tests — create test file |
| **T-06** Golden tests | 🔵 MANUAL | Check if module qualifies for golden/snapshot tests |
| **T-07** Tests pass | 🔵 MANUAL | Run: cargo test --test save_tests -- --nocapture |

### Phase 8 — Documentation & Wiki

| Check | Verdict | Details |
|-------|---------|---------|
| **W-01** Example file exists | ❌ ERROR | content/examples/save.lua not found — create it |
| **W-02** API surface coverage | ❌ ERROR | Skipped — no example file |
| **W-03** Example comments | 🔵 MANUAL | Verify content/examples/save.lua has realistic one-line comments per call |
| **W-04** Example–spec sync | ✅ PASS | Missing spec or example — other checks cover this |
| **W-05** Wiki page | ⚠️ WARNING | No wiki page found (expected docs/wiki/Save-API.md) |
...
```powershell
python tools/audit/audit_module.py save --docs-quality
```
