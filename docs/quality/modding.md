...
| Check | Verdict | Details |
|-------|---------|---------|
| **W-01** Example file exists | ✅ PASS | content/examples/modding.lua present |
| **W-02** API surface coverage | ✅ PASS | All 2 bound functions in example |
| **W-03** Example comments | 🔵 MANUAL | Verify content/examples/modding.lua has realistic one-line comments per call |
| **W-04** Example–spec sync | ✅ PASS | Missing spec or example — other checks cover this |
| **W-05** Wiki page | ✅ PASS | docs\wiki\Modding-API.md |
