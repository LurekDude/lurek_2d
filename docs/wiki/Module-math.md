...
- [Types and Methods](#types-and-methods)
  ...
  - [LVec2:fromAngle(radians: number) -> LVec2](#lvec2fromangleradians-number-lvec2)
  ...
  - [LVec3:splat(v: number) -> LVec3](#lvec3splatv-number-lvec3)
...
### `LVec2:fromAngle(radians: number) -> LVec2`
