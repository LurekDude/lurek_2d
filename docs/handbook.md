...
> [docs/API/](API/) (auto-generated `lurek.*` and Rust references).
...
Or build once and drag the `my_game/` folder onto the splash window. Browse the full `lurek.*` surface in [docs/API/lua-api.md](API/lua-api.md). For Lua patterns and idioms, see the [lua-scripting](../.github/skills/lua-scripting/SKILL.md) skill.
...
4. **Regenerate auto-spec sections**:
   ...
   ```
   This rewrites the *Files / Types / Functions / Lua API Reference / References* sections of every affected spec and refreshes [docs/API/lua-api.md](API/lua-api.md), [docs/API/rust-api.md](API/rust-api.md), and [docs/API/lurek.lua](API/lurek.lua).
