...
- Pure CPU data model in `src/overlay/mod.rs` — GPU application is handled by `src/lua_api/overlay_api.rs`
...
- **Rust**: `src/overlay/mod.rs` — fully implemented
- **Lua bindings**: `src/lua_api/overlay_api.rs` — fully implemented
- **Tests**: `tests/unit/overlay_tests.rs` (78 tests), `tests/lua/unit/test_overlay.lua` (59 BDD tests)
