...
- `bezier(p1x, p1y, p2x, p2y)` � custom cubic B�zier easing curves
...
- `smooth_step(t)` � Hermite S-curve (3t2 - 2t3)
- `smoother_step(t)` � improved S-curve (6t5 - 15t4 + 10t3)
- `bezier(p1x, p1y, p2x, p2y, t)` � cubic B�zier easing
