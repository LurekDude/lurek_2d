...
```lua
local img = lurek.render.newImage("player.png")  -- Image
local w = img:getWidth()                          -- number
local pos = lurek.math.vec2(w, 0)                 -- Vec2
...
**Scenarios**:
- User is mid-typing: `lurek.render.` → show completions despite syntax error
