...
describe("luna.particle size settings", function()
    it("setSizes with multiple keyframes / getSizes round-trip", function()
        ...
        local s1, s2, s3, s4 = luna.particle.getSizes(ps)
        expect_true(math.abs(s1 - 8.0) < 0.001, "size[1]")
        expect_true(math.abs(s2 - 4.0) < 0.001, "size[2]")
        expect_true(math.abs(s3 - 2.0) < 0.001, "size[3]")
        expect_true(math.abs(s4 - 1.0) < 0.001, "size[4]")
    end)
...
describe("luna.particle color settings", function()
    it("setColors / getColors round-trip", function()
        ...
        -- getColors returns flat sequence: r1,g1,b1,a1, r2,g2,b2,a2, ...
        local r1, g1, b1, a1, r2, g2, b2, a2 = luna.particle.getColors(ps)
