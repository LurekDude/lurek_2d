...
describe("luna.gfx module exists", function()
    it("luna.gfx is a table", function()
        expect_type("table", luna.gfx)
    end)
end)

describe("luna.gfx color functions", function()
    it("setColor is a function", function()
        expect_type("function", luna.gfx.setColor)
    end)
    ...
    it("setColor accepts 4 args", function()
        expect_no_error(function()
            luna.gfx.setColor(1, 0, 0, 0.5)
        end)
    end)

    it("setBackgroundColor is a function", function()
        expect_type("function", luna.gfx.setBackgroundColor)
    end)

    it("setBackgroundColor accepts 3 args", function()
        expect_no_error(function()
            luna.gfx.setBackgroundColor(0.1, 0.1, 0.1)
        end)
    end)
end)

describe("luna.gfx shape functions", function()
    it("rectangle is a function", function()
        expect_type("function", luna.gfx.rectangle)
    end)

    it("rectangle fill mode", function()
        expect_no_error(function()
            luna.gfx.rectangle("fill", 10, 10, 100, 50)
        end)
    end)

    it("rectangle line mode", function()
        expect_no_error(function()
            luna.gfx.rectangle("line", 10, 10, 100, 50)
        end)
    end)

    it("circle is a function", function()
        expect_type("function", luna.gfx.circle)
    end)

    it("circle fill mode", function()
        expect_no_error(function()
            luna.gfx.circle("fill", 50, 50, 25)
        end)
    end)

    it("line is a function", function()
        expect_type("function", luna.gfx.line)
    end)
...
describe("luna.gfx text functions", function()
    it("print is a function", function()
        expect_type("function", luna.gfx.print)
    end)

    it("print accepts text and position", function()
        expect_no_error(function()
            luna.gfx.print("Hello", 10, 10)
        end)
    end)
end)

describe("luna.gfx image functions", function()
    it("newImage is a function", function()
        expect_type("function", luna.gfx.newImage)
    end)

    it("draw is a function", function()
        expect_type("function", luna.gfx.draw)
    end)
end)

describe("luna.gfx advanced shapes", function()
    it("ellipse is a function", function()
        expect_type("function", luna.gfx.ellipse)
    end)

    it("ellipse fill mode", function()
        expect_no_error(function()
            luna.gfx.ellipse("fill", 100, 100, 50, 30)
        end)
    end)

    it("polygon is a function", function()
        expect_type("function", luna.gfx.polygon)
    end)

    it("polygon fill mode with vertices", function()
        expect_no_error(function()
            luna.gfx.polygon("fill", 0, 0, 100, 0, 50, 100)
        end)
    end)

    it("triangle is a function", function()
        expect_type("function", luna.gfx.triangle)
    end)

    it("triangle fill mode", function()
        expect_no_error(function()
            luna.gfx.triangle("fill", 0, 0, 100, 0, 50, 80)
        end)
    end)

    it("setLineWidth is a function", function()
        expect_type("function", luna.gfx.setLineWidth)
    end)

    it("getLineWidth is a function", function()
        expect_type("function", luna.gfx.getLineWidth)
    end)

    it("setLineWidth and getLineWidth roundtrip", function()
        luna.gfx.setLineWidth(3.0)
        expect_near(3.0, luna.gfx.getLineWidth())
        luna.gfx.setLineWidth(1.0) -- reset
    end)
...
describe("font metrics", function()
    it("getFontLineHeight is a function", function()
        expect_type("function", luna.gfx.getFontLineHeight)
    end)

    it("setFontLineHeight is a function", function()
        expect_type("function", luna.gfx.setFontLineHeight)
    end)

    it("getFontAscent is a function", function()
        expect_type("function", luna.gfx.getFontAscent)
    end)

    it("getFontDescent is a function", function()
        expect_type("function", luna.gfx.getFontDescent)
    end)
end)

-- ── Nine-Slice Tests ────────────────────────────────────────────────────

describe("luna.gfx nine-slice", function()
    it("newNineSlice is a function", function()
        expect_type("function", luna.gfx.newNineSlice)
    end)

    it("drawNineSlice is a function", function()
        expect_type("function", luna.gfx.drawNineSlice)
    end)
    ...
    it("rejects negative border insets", function()
        ...
        local ok = pcall(function()
            luna.gfx.newNineSlice(img, -5, 10, 10, 10)
        end)
...
describe("luna.gfx.captureScreenshot", function()
...
describe("luna.gfx.saveScreenshot", function()
    it("accepts a save-relative path without error", function()
        local ok = pcall(luna.gfx.saveScreenshot, "save/test_graphics.png")
        expect_equal(ok, true)
    end)

    it("rejects paths outside save", function()
        expect_error(function()
            luna.gfx.saveScreenshot("test_graphics.png")
        end, "save/")
    end)
end)

describe("luna.gfx stencil mode", function()
  it("setStencilMode and getStencilMode round-trip correctly", function()
    luna.gfx.setStencilMode("replace", "always", 1)
    local action, compare, value = luna.gfx.getStencilMode()
  ...
  it("clearStencil resets to keep/always/0", function()
    luna.gfx.setStencilMode("invert", "equal", 5)
  ...
  it("setStencilMode errors on unknown action", function()
    expect_error(function()
      luna.gfx.setStencilMode("explode")
    end)
  end)

  it("setStencilMode is a function", function()
    expect_type("function", luna.gfx.setStencilMode)
  end)

  it("getStencilMode is a function", function()
    expect_type("function", luna.gfx.getStencilMode)
  end)

  it("clearStencil is a function", function()
    expect_type("function", luna.gfx.clearStencil)
  end)
end)

describe("luna.gfx depth mode", function()
  it("setDepthMode and getDepthMode round-trip correctly", function()
    luna.gfx.setDepthMode("less", true)
    local mode, write = luna.gfx.getDepthMode()
    expect_equal(mode, "less")
    expect_equal(write, true)
  end)

  it("setDepthMode write defaults to false", function()
    luna.gfx.setDepthMode("always")
    local mode, write = luna.gfx.getDepthMode()
  ...
  it("setDepthMode errors on unknown mode", function()
    expect_error(function()
      luna.gfx.setDepthMode("turbo")
    end)
  end)

  it("setDepthMode is a function", function()
    expect_type("function", luna.gfx.setDepthMode)
  end)

  it("getDepthMode is a function", function()
    expect_type("function", luna.gfx.getDepthMode)
  end)
end)
