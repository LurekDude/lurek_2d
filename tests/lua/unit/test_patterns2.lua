...
-- BDD-style integration tests for luna.patterns module

-- ===================================================================
-- EventBus
-- ===================================================================
describe("luna.patterns.newEventBus", function()
...
-- ObjectPool
-- ===================================================================
describe("luna.patterns.newObjectPool", function()
...
-- CommandStack
-- ===================================================================
describe("luna.patterns.newCommandStack", function()
...
-- ServiceLocator
-- ===================================================================
describe("luna.patterns.newServiceLocator", function()
    it("creates a ServiceLocator with correct type", function()
        local sl = luna.patterns.newServiceLocator()
...
-- Factory
-- ===================================================================
describe("luna.patterns.newFactory", function()
    it("creates a Factory with correct type", function()
        local f = luna.patterns.newFactory()
...
-- SimpleState (FSM)
-- ===================================================================
describe("luna.patterns.newSimpleState", function()
