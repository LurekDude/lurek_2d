...
describe("luna.ai module exists", function()
    ...
    it("has newPathGrid factory", function()
        expect_type("function", luna.ai.newPathGrid)
    end)

    it("has newFlowField factory", function()
        expect_type("function", luna.ai.newFlowField)
    end)
...
describe("luna.ai PathGrid", function()
    it("type returns PathGrid", function()
        local g = luna.ai.newPathGrid(10, 10, 32)
        expect_equal("PathGrid", g:type())
    end)

    it("getWidth / getHeight / getCellSize", function()
        local g = luna.ai.newPathGrid(8, 6, 16)
    ...
    it("all cells walkable by default", function()
        local g = luna.ai.newPathGrid(5, 5, 10)
    ...
    it("findPath returns nil for blocked path", function()
        local g = luna.ai.newPathGrid(3, 1, 10)
...
describe("luna.ai FlowField", function()
    it("type returns FlowField", function()
        local g = luna.ai.newPathGrid(5, 5, 10)
        local ff = luna.ai.newFlowField(g)
        expect_equal("FlowField", ff:type())
    end)

    it("getWidth / getHeight", function()
        local g = luna.ai.newPathGrid(8, 6, 10)
        local ff = luna.ai.newFlowField(g)
...
describe("luna.ai type system", function()
    ...
    it("PathGrid:type() returns PathGrid", function()
        expect_equal("PathGrid", luna.ai.newPathGrid(5, 5, 10):type())
    end)

    it("FlowField:type() returns FlowField", function()
        local g = luna.ai.newPathGrid(5, 5, 10)
        expect_equal("FlowField", luna.ai.newFlowField(g):type())
    end)
