-- Lua BDD tests for luna.crafting.*

describe("luna.crafting.Recipe", function()
    it("creates a recipe with id and type", function()
        local r = luna.crafting.newRecipe("sword", "shaped")
    ...
    it("can add and clear ingredients", function()
        local r = luna.crafting.newRecipe("test")
...
describe("luna.crafting.RecipeRegistry", function()
...
describe("luna.crafting.Station", function()
    it("creates with type and level", function()
        local s = luna.crafting.newStation("forge", 2)
    ...
    it("supports quality bonus and output multiplier", function()
        local s = luna.crafting.newStation("bench", 1)
...
describe("luna.crafting.RecipeKnowledge", function()
...
describe("luna.crafting.RecipeGroup", function()
...
describe("luna.crafting.CraftQueue", function()
...
describe("luna.crafting.CraftSkill", function()
    it("tracks xp and levels up", function()
        local s = luna.crafting.newCraftSkill("smithing")
    ...
    it("supports specializations perks bonuses and recipe helpers", function()
        ...
        local recipe = luna.crafting.newRecipe("blade")
        expect_equal("grey", s:getRecipeColor(recipe))
        expect_near(0.0, s:skillUpChance(recipe), 0.0001)
    end)
end)

describe("luna.crafting.UpgradeTree", function()
    it("manages nodes and prerequisites", function()
        local tree = luna.crafting.newUpgradeTree("weapons")
...
describe("luna.crafting.ModifierPool", function()
