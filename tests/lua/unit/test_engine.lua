-- @testCategory unit
-- @description Unit tests for the lurek.engine.* namespace (engine metadata API).
...
-- @description Tests for all lurek.engine.* functions.
describe("lurek.engine metadata", function()
