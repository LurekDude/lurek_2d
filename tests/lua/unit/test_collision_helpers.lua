...
describe("lurek.collision helpers", function()
  ...
  it("testCircleAABB overlapping corner", function()
    ...
    expect_equal(lurek.collision.testCircleAABB(12, 12, 3, 0, 0, 10, 10), true)
  end)
  ...
  it("testCircleAABB just outside corner", function()
    ...
    expect_equal(lurek.collision.testCircleAABB(13, 13, 1, 0, 0, 10, 10), false)
  end)
