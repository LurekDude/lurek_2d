...
-- Luna2D BDD tests for luna.graphics.newShape() / CompoundShape
...
local function run_tests()
    ...
    describe("newShape constructor", function()
        it("returns a non-nil userdata", function()
            local shape = luna.graphics.newShape()
        ...
        it("can create multiple independent shapes", function()
            local s1 = luna.graphics.newShape()
            local s2 = luna.graphics.newShape()
