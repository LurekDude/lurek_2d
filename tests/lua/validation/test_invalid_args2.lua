...
describe("validation: physics invalid args", function()
    ...
    it("handles negative dt without crash", function()
        ...
        expect_no_error(function()
            luna.physics.step(world_id, -1.0)
    ...
    it("handles invalid body type string", function()
        ...
        expect_no_error(function()
            luna.physics.newBody(world_id, 0, 0, "invalid_type")
    ...
    it("handles NaN position gracefully", function()
        local world_id = luna.physics.newWorld(0, 100)
        expect_no_error(function()
            luna.physics.newBody(world_id, 0/0, 0/0, "dynamic")
        end)
    end)

    it("handles huge velocity without crash", function()
        local world_id = luna.physics.newWorld(0, 100)
        local body = luna.physics.newBody(world_id, 0, 0, "dynamic")
        expect_no_error(function()
            luna.physics.setBodyVelocity(world_id, body, 1e10, 1e10)
