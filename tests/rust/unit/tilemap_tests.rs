...
#[test]
fn tileset_get_quad_no_spacing() {
    let ts = make_tileset();
...
#[test]
fn tileset_get_quad_with_spacing_and_margin() {
...
#[test]
fn tileset_solid_default_false() {
    let ts = make_tileset();
...
#[test]
fn tileset_set_solid_expands_vector() {
    let mut ts = make_tileset();
...
#[test]
fn tileset_animation_none_by_default() {
    let ts = make_tileset();
...
#[test]
fn tileset_autotile_multiple_types() {
    let mut ts = make_tileset();
...
#[test]
fn tilemap_add_layer_returns_index() {
    let mut map = TileMap::new(32, 32, 8);
...
#[test]
fn tilemap_layer_visible_default_true() {
    let map = make_map();
...
#[test]
fn tilemap_get_tile_out_of_bounds_returns_zero() {
    let map = make_map();
...
#[test]
fn tilemap_world_to_tile_negative_clamps_to_zero() {
    let map = make_map();
...
#[test]
fn tilemap_world_tile_roundtrip() {
    let map = make_map();
    for tx in 0..10 {
        for ty in 0..10 {
...
#[test]
fn tilemap_viewport_none_by_default() {
    let map = make_map();
    assert!(map.get_viewport().is_none());
}

#[test]
fn tilemap_set_get_viewport() {
    let mut map = make_map();
...
#[test]
fn tilemap_is_solid_empty_tile() {
    let map = make_map();
...
#[test]
fn tilemap_is_solid_with_solid_gid() {
    let mut map = make_map();
...
#[test]
fn tilemap_is_solid_with_non_solid_gid() {
    let mut map = make_map();
...
#[test]
fn tilemap_rect_overlaps_solid_hit() {
    let mut map = make_map();
...
#[test]
fn tilemap_rect_overlaps_solid_miss() {
    let mut map = make_map();
    map.set_tile(0, 3, 3, 1);
...
#[test]
fn tilemap_rect_overlaps_solid_no_solid_tiles() {
    let map = make_map();
...
#[test]
fn tilemap_sweep_rect_hits_solid() {
    let mut map = make_map();
...
#[test]
fn tilemap_sweep_rect_no_collision() {
...
#[test]
fn tilemap_sweep_rect_zero_velocity_returns_none() {
    let mut map = make_map();
...
#[test]
fn tilemap_sweep_rect_vertical_collision() {
    let mut map = make_map();
...
#[test]
fn autotilesheet_blob47_creation() {
...
#[test]
fn autotilesheet_composite48_creation() {
...
#[test]
fn autotilesheet_minimal16_creation() {
...
#[test]
fn autotilesheet_minimal16_bitmask_roundtrip() {
...
#[test]
fn autotilesheet_blob47_bitmask_roundtrip() {
...
#[test]
fn autotilesheet_bitmask_out_of_bounds_returns_zero() {
    let sheet = AutoTileSheet::new(16, 16, AutoTileLayout::Blob47);
...
#[test]
fn autotilesheet_apply_to_tileset_minimal16() {
    let sheet = AutoTileSheet::new(16, 16, AutoTileLayout::Minimal16);
...
#[test]
fn autotilesheet_apply_to_tileset_with_offset() {
    let sheet = AutoTileSheet::new(16, 16, AutoTileLayout::Minimal16);
...
#[test]
fn autotilesheet_apply_to_tileset_blob47_uses_8bit_rules() {
    let sheet = AutoTileSheet::new(16, 16, AutoTileLayout::Blob47);
...
#[test]
fn autotilesheet_layout_equality() {
...
#[test]
fn autotilesheet_get_quad_first_tile() {
    let sheet = AutoTileSheet::new(32, 32, AutoTileLayout::Blob47);
...
#[test]
fn autotilesheet_get_quad_sequential_tiles() {
    let sheet = AutoTileSheet::new(32, 32, AutoTileLayout::Blob47);
...
#[test]
fn autotilesheet_get_quad_out_of_bounds_zero_size() {
...
#[test]
fn tilemap_apply_autotile_4bit_column() {
...
#[test]
fn tilemap_apply_autotile_8bit_center() {
    let mut tm = TileMap::new(32, 32, 16);
    tm.add_layer("main", 3, 3);
...
#[test]
fn tilemap_update_no_crash_no_animations() {
    let mut tm = TileMap::new(32, 32, 16);
...
#[test]
fn tilemap_update_advances_animation_timer() {
    let mut tm = TileMap::new(32, 32, 16);
    tm.add_layer("main", 10, 10);
    let mut ts = TileSet::new(1, 16, 4, 32, 32, 0, 0);
    ts.set_animation(
...
#[test]
fn tilemap_multiple_layers_independent_tiles() {
    let mut tm = TileMap::new(32, 32, 16);
    tm.add_layer("bg", 5, 5);
    tm.add_layer("fg", 5, 5);
...
#[test]
fn tilemap_fill_then_clear_individual_tile() {
    let mut map = make_map();
    map.fill(0, 5);
...
#[test]
fn mapblock_set_get_tile_roundtrip() {
...
#[test]
fn mapblock_set_get_tile_multiple_layers() {
...
#[test]
fn mapblock_get_tile_out_of_bounds_returns_zero() {
...
#[test]
fn mapblock_set_get_side_all_edges() {
...
#[test]
fn mapblock_get_side_unset_returns_zero() {
    let block = MapBlock::new(4, 4, 1, 2);
...
#[test]
fn mapblock_segment_counts_per_edge() {
...
#[test]
fn mapblock_set_side_multiple_segments() {
...
#[test]
fn mapblock_initial_tiles_all_zero() {
...
#[test]
fn mapgroup_remove_block_out_of_bounds_no_panic() {
...
#[test]
fn mapgroup_multiple_blocks_and_scripts() {
...
#[test]
fn mapscript_get_step_out_of_bounds() {
    let script = MapScript::new("empty");
    assert!(script.get_step(0).is_none());
}

#[test]
fn mapscript_remove_step_shifts_remaining() {
    let mut script = MapScript::new("test");
    script.add_step(ScriptStep {
        step_type: StepType::FillRandom,
        ..Default::default()
...
#[test]
fn mapscript_remove_step_out_of_bounds_no_panic() {
    let mut script = MapScript::new("safe");
    script.remove_step(99);
}

#[test]
fn mapscript_clear_steps() {
    let mut script = MapScript::new("test");
...
#[test]
fn steptype_from_str_all_valid() {
    assert_eq!(
...
#[test]
fn mapgen_get_zone_out_of_bounds() {
    let gen = MapGen::new(MapSize::Small, 4);
    assert!(gen.get_zone(0).is_none());
}

#[test]
fn mapgen_set_get_layer_mode() {
    let mut gen = MapGen::new(MapSize::Small, 4);
...
#[test]
fn mapgen_generate_with_fill_random_script() {
    let mut gen = MapGen::new(MapSize::Small, 4);
    let mut group = MapGroup::new("test");
...
#[test]
fn mapsize_grid_dimensions_all_variants() {
...
#[test]
fn mapgen_generate_with_fill_rect_script() {
    let mut gen = MapGen::new(MapSize::Small, 4);
...
#[test]
fn coords_to_screen_iso_origin() {
...
#[test]
fn coords_to_from_screen_iso_roundtrip() {
    let tile_w = 64.0;
    let tile_h = 32.0;
...
#[test]
fn coords_to_from_screen_iso_negative_coords() {
    let tile_w = 64.0;
    let tile_h = 32.0;
...
#[test]
fn coords_iso_rotate_clockwise_all() {
...
#[test]
fn coords_iso_rotate_counter_clockwise() {
...
#[test]
fn coords_iso_rotate_full_circle() {
    assert_eq!(iso_rotate(1, 4), 1);
    assert_eq!(iso_rotate(3, 8), 3);
}

#[test]
fn coords_iso_direction_name_valid() {
...
#[test]
fn coords_iso_direction_name_invalid_returns_unknown() {
...
#[test]
fn coords_iso_direction_from_angle_cardinals() {
...
#[test]
fn coords_to_screen_hex_origin() {
...
#[test]
fn coords_to_from_screen_hex_roundtrip() {
    let size = 20.0;
...
#[test]
fn coords_to_from_screen_hex_roundtrip_negative() {
    let size = 15.0;
...
#[test]
fn coords_hex_neighbors_six_at_distance_one() {
...
#[test]
fn coords_hex_neighbors_offset_center() {
...
#[test]
fn coords_hex_distance_zero_same_cell() {
    assert_eq!(hex_distance(0, 0, 0, 0), 0);
    assert_eq!(hex_distance(3, -2, 3, -2), 0);
}

#[test]
fn coords_hex_distance_adjacent() {
...
#[test]
fn coords_hex_ring_radius_zero_center_only() {
    let ring = hex_ring(2, 3, 0);
    assert_eq!(ring, vec![(2, 3)]);
}

#[test]
fn coords_hex_ring_radius_one_six_cells() {
...
#[test]
fn coords_hex_ring_radius_two_twelve_cells() {
...
#[test]
fn coords_hex_area_superset_of_ring() {
...
#[test]
fn coords_hex_rotate_one_step() {
    let (rq, rr) = hex_rotate(1, 0, 0, 0, 1);
    assert_eq!((rq, rr), (0, 1));
}

#[test]
fn coords_hex_rotate_full_circle_identity() {
    let (rq, rr) = hex_rotate(2, -1, 0, 0, 6);
    assert_eq!((rq, rr), (2, -1));
}

#[test]
fn coords_hex_rotate_negative_steps_equals_positive() {
...
#[test]
fn coords_hex_reflect_q_axis() {
    let (rq, rr) = hex_reflect(1, 2, 0, 0, "q");
    assert_eq!((rq, rr), (1, -3));
}

#[test]
fn coords_hex_reflect_r_axis() {
    let (rq, rr) = hex_reflect(1, 2, 0, 0, "r");
    assert_eq!((rq, rr), (-3, 2));
}

#[test]
fn coords_hex_reflect_s_axis() {
    let (rq, rr) = hex_reflect(1, 2, 0, 0, "s");
    assert_eq!((rq, rr), (2, 1));
}

#[test]
fn coords_hex_reflect_unknown_axis_identity() {
    let (rq, rr) = hex_reflect(3, -1, 0, 0, "invalid");
    assert_eq!((rq, rr), (3, -1));
}

#[test]
fn coords_hex_reflect_double_is_identity() {
...
#[test]
fn isomap_draw_iter_skips_empty() {
